...
function SortableItem({ itemIdx, pos, text, disabled }) {
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        'flex items-center gap-2 min-h-[52px] px-3 py-2 border-2 border-ink rounded-retro shadow-hard-sm bg-white transition-shadow',
    ...
    >
      ...
      <MathText className="flex-1 text-sm font-semibold text-ink font-mono">{text}</MathText>
