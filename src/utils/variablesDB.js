...
export const VARIABLES = {
  ...
  g: [e({ name: 'Erdbeschleunigung', unit: 'm/s²', desc: 'g ≈ 9,81 m/s² auf der Erdoberfläche' })],
  ...
  A: [e({ name: 'Querschnittsfläche', unit: 'mm²', desc: 'Fläche des Querschnitts senkrecht zur Kraft' })],
  ...
  h: [e({ name: 'Höhe', unit: 'mm / m', desc: 'Höhe (Querschnittshöhe, Fallhöhe, etc.)' })],
