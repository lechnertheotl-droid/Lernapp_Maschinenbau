      ...
      lessons: [
        {
          ...
          blueprint: {
            prerequisites: [],
            concepts: [
              { id: 'sigma-fa',     title: 'Normalspannung $\\sigma=F/A$ — Einheit MPa = N/mm²',                                  dependsOn: [] },
              { id: 'mpa-pa-fest', title: '1 MPa = 1 N/mm² = $10^6$ Pa',                                                            dependsOn: [] },
              { id: 'zug-druck',    title: 'Vorzeichenkonvention: + Zug, − Druck',                                                 dependsOn: ['sigma-fa'] },
              { id: 'a-kreis',      title: 'Kreisquerschnitt $A=\\pi d^2/4$',                                                       dependsOn: [] },
            ],
            subGoalConcepts: { 0: ['sigma-fa'], 1: ['mpa-pa-fest'], 2: ['zug-druck'], 3: ['a-kreis'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['sigma-fa'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-fa'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-fa'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-fa'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['sigma-fa'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['mpa-pa-fest'],       qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mpa-pa-fest'],       qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['mpa-pa-fest'],       qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mpa-pa-fest'],       qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['mpa-pa-fest'],       qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['zug-druck'],         qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['zug-druck'],         qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['zug-druck'],         qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['zug-druck'],         qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['zug-druck'],         qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['a-kreis'],           qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['a-kreis'],           qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['a-kreis'],           qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['a-kreis'],           qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['a-kreis', 'sigma-fa'], qty: 1 },
            ],
          },
...
1 MPa entspricht 1 N/mm². Diese Einheit ist in der Konstruktion sehr praktisch.`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-1', concepts: ['sigma-fa'] },
            ],
            concepts: [
              { id: 'hooke',        title: '$\\sigma=E\\varepsilon$ im linear-elastischen Bereich',                              dependsOn: [] },
              { id: 'dehnung',      title: 'Dehnung $\\varepsilon=\\Delta l/l_0$, dimensionslos',                                  dependsOn: [] },
              { id: 'e-modul-mat',  title: 'E-Modul Materialkonstante (Stahl $\\approx 210$ GPa)',                                 dependsOn: ['hooke'] },
              { id: 'querkontr',    title: 'Querkontraktion $\\varepsilon_q=-\\nu\\varepsilon$ mit $\\nu\\approx 0{,}3$ (Stahl)',  dependsOn: ['dehnung'] },
            ],
            subGoalConcepts: { 0: ['hooke'], 1: ['dehnung'], 2: ['e-modul-mat'], 3: ['querkontr'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['hooke'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['hooke'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['hooke'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['hooke'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['hooke'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['dehnung'],        qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['dehnung'],        qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['dehnung'],        qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['dehnung'],        qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['dehnung'],        qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['e-modul-mat'],    qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['e-modul-mat'],    qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['e-modul-mat'],    qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['e-modul-mat'],    qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['e-modul-mat'],    qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['querkontr'],      qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['querkontr'],      qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['querkontr'],      qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['querkontr'],      qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['querkontr'],      qty: 1 },
            ],
          },
...
Der E-Modul beschreibt die Steifigkeit des Materials. Stahl hat ungefähr $E = 210000$ MPa.`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-1', concepts: ['sigma-fa', 'a-kreis'] },
              { lessonId: 'fest-1-2', concepts: ['hooke', 'querkontr'] },
            ],
            concepts: [
              { id: 'tau-mt-wp',    title: 'Torsion $\\tau_{\\max}=M_T/W_p$',                                                    dependsOn: [] },
              { id: 'wp-d3-16',     title: '$W_p=\\pi d^3/16$ Kreisquerschnitt',                                                    dependsOn: ['tau-mt-wp'] },
              { id: 'verdrehwinkel', title: 'Verdrehwinkel $\\varphi=M_T L/(G I_p)$, $I_p=\\pi d^4/32$',                            dependsOn: ['tau-mt-wp'] },
              { id: 'g-modul',      title: 'Schubmodul Stahl $G\\approx 80\\,000$ MPa',                                              dependsOn: [] },
              { id: 'rein-schub',   title: 'Reiner Schub (Niet, Bolzen) $\\tau=F/A$',                                                dependsOn: [] },
            ],
            subGoalConcepts: { 0: ['tau-mt-wp'], 1: ['wp-d3-16'], 2: ['verdrehwinkel'], 3: ['g-modul'], 4: ['rein-schub'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['tau-mt-wp'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['tau-mt-wp'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['tau-mt-wp'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['tau-mt-wp'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['tau-mt-wp'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['wp-d3-16'],           qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wp-d3-16'],           qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['wp-d3-16'],           qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wp-d3-16'],           qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['wp-d3-16', 'tau-mt-wp'], qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['verdrehwinkel'],      qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['verdrehwinkel'],      qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['verdrehwinkel'],      qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['verdrehwinkel'],      qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['verdrehwinkel'],      qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['g-modul'],            qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['g-modul'],            qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['g-modul'],            qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['g-modul'],            qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['g-modul'],            qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['rein-schub'],         qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rein-schub'],         qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['rein-schub'],         qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rein-schub'],         qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['rein-schub'],         qty: 1 },
            ],
          },
...
$$\tau = \frac{F}{A}$$`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-2', concepts: ['e-modul-mat'] },
            ],
            concepts: [
              { id: 'euler-fki',     title: 'Euler-Knicklast $F_{ki}=\\pi^2 EI/(\\beta L)^2$',                                  dependsOn: [] },
              { id: 'einspannbeiw',  title: 'Beiwerte $\\beta$: 1 (g/g), 2 (e/frei), 0,5 (beidseitig eingespannt)',                dependsOn: ['euler-fki'] },
              { id: 'i-min',         title: 'Schwächste Achse: kleinstes $I$ zählt',                                              dependsOn: ['euler-fki'] },
              { id: 'schlankheit',   title: 'Schlankheit $\\lambda=\\beta L/i$, $i=\\sqrt{I/A}$',                                  dependsOn: ['euler-fki'] },
              { id: 'euler-grenze',  title: 'Euler nur elastisch ($\\sigma_{ki}<R_p$); sonst Tetmajer/Johnson',                    dependsOn: ['euler-fki', 'schlankheit'] },
            ],
            subGoalConcepts: { 0: ['euler-fki'], 1: ['einspannbeiw'], 2: ['i-min'], 3: ['schlankheit'], 4: ['euler-grenze'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['euler-fki'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['euler-fki'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['euler-fki'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['euler-fki'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['euler-fki'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['einspannbeiw'],       qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['einspannbeiw'],       qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['einspannbeiw'],       qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['einspannbeiw'],       qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['einspannbeiw'],       qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['i-min'],              qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['i-min'],              qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['i-min'],              qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['i-min'],              qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['i-min'],              qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['schlankheit'],        qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['schlankheit'],        qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['schlankheit'],        qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['schlankheit'],        qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['schlankheit'],        qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['euler-grenze'],       qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['euler-grenze'],       qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['euler-grenze'],       qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['euler-grenze'],       qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['euler-grenze'],       qty: 1 },
            ],
          },
      ...
      lessons: [
        {
          ...
          blueprint: {
            ...
            concepts: [
              { id: 'sigma-b',      title: 'Biegespannung $\\sigma_b=M_b/W_b$',                                                  dependsOn: [] },
              { id: 'wb-rechteck',  title: 'Rechteck $W_b=bh^2/6$',                                                                dependsOn: ['sigma-b'] },
              { id: 'wb-kreis',     title: 'Kreis $W_b=\\pi d^3/32$',                                                              dependsOn: ['sigma-b'] },
              { id: 'sigma-linear', title: 'Lineare Verteilung: 0 in neutraler Faser, max. am Rand',                              dependsOn: ['sigma-b'] },
              { id: 'sigma-y',      title: '$\\sigma_b=M_b y/I$ für beliebige Faserstelle $y$',                                   dependsOn: ['sigma-linear'] },
            ],
            subGoalConcepts: { 0: ['sigma-b'], 1: ['wb-rechteck'], 2: ['wb-kreis'], 3: ['sigma-linear'], 4: ['sigma-y'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['sigma-b'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-b'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-b'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-b'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['sigma-b'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['wb-rechteck'],      qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wb-rechteck'],      qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['wb-rechteck'],      qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wb-rechteck'],      qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['wb-rechteck', 'sigma-b'], qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['wb-kreis'],         qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wb-kreis'],         qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['wb-kreis'],         qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wb-kreis'],         qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['wb-kreis', 'sigma-b'], qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['sigma-linear'],     qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-linear'],     qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['sigma-linear'],     qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-linear'],     qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['sigma-linear'],     qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['sigma-y'],          qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-y'],          qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-y'],          qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-y'],          qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['sigma-y'],          qty: 1 },
            ],
          },
...
Das Widerstandsmoment $W_b$ hängt stark von der Querschnittsform ab.`,
        ...
        },
        {
          ...
          blueprint: {
            ...
            concepts: [
              { id: 'sigma-zul-fest', title: '$\\sigma_{\\text{zul}}=R/S$',                                                       dependsOn: [] },
              { id: 'fest-nachweis',  title: 'Nachweis $\\sigma_{\\text{vorh}}\\le\\sigma_{\\text{zul}}$',                          dependsOn: ['sigma-zul-fest'] },
              { id: 's-werte',        title: '$S=1{,}5$ statisch zäh bis $S=4$ dynamisch spröde',                                  dependsOn: ['sigma-zul-fest'] },
              { id: 're-rm-wahl',     title: '$R_e$ (zäh) bzw. $R_m$ (spröde) als Referenz wählen',                                dependsOn: ['sigma-zul-fest'] },
              { id: 's-monoton',      title: 'Größeres $S$ → kleineres $\\sigma_{\\text{zul}}$',                                    dependsOn: ['sigma-zul-fest'] },
            ],
            subGoalConcepts: { 0: ['sigma-zul-fest'], 1: ['fest-nachweis'], 2: ['s-werte'], 3: ['re-rm-wahl'], 4: ['s-monoton'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['sigma-zul-fest'],     qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-zul-fest'],     qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-zul-fest'],     qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-zul-fest'],     qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['sigma-zul-fest'],     qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['fest-nachweis'],      qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fest-nachweis'],      qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['fest-nachweis'],      qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fest-nachweis'],      qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['fest-nachweis'],      qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['s-werte'],            qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['s-werte'],            qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['s-werte'],            qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['s-werte'],            qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['s-werte'],            qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['re-rm-wahl'],         qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['re-rm-wahl'],         qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['re-rm-wahl'],         qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['re-rm-wahl'],         qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['re-rm-wahl'],         qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['s-monoton'],          qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['s-monoton'],          qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['s-monoton'],          qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['s-monoton'],          qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['s-monoton'],          qty: 1 },
            ],
          },
...
$R$ ist eine Materialkennzahl, $S$ die Sicherheitszahl.`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-1', concepts: ['sigma-fa'] },
              { lessonId: 'fest-1-3', concepts: ['tau-mt-wp'] },
            ],
            concepts: [
              { id: 'mohr-mitte',    title: 'Mittelpunkt $\\sigma_M=(\\sigma_x+\\sigma_y)/2$',                                    dependsOn: [] },
              { id: 'mohr-radius',   title: 'Radius $R=\\sqrt{((\\sigma_x-\\sigma_y)/2)^2+\\tau_{xy}^2}$',                          dependsOn: ['mohr-mitte'] },
              { id: 'haupt-spann',   title: 'Hauptspannungen $\\sigma_{1,2}=\\sigma_M\\pm R$',                                      dependsOn: ['mohr-mitte', 'mohr-radius'] },
              { id: 'tau-max',       title: 'Max. Schub $\\tau_{\\max}=R$',                                                          dependsOn: ['mohr-radius'] },
              { id: 'haupt-winkel',  title: 'Hauptachsenwinkel $\\tan(2\\varphi)=2\\tau_{xy}/(\\sigma_x-\\sigma_y)$',                dependsOn: ['mohr-radius'] },
              { id: 'mohr-anwend',   title: 'Hauptspannungshypothese (spröde) vs. GEH (zähe)',                                       dependsOn: ['haupt-spann'] },
            ],
            subGoalConcepts: { 0: ['mohr-mitte'], 1: ['mohr-radius'], 2: ['haupt-spann'], 3: ['tau-max'], 4: ['haupt-winkel'], 5: ['mohr-anwend'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['mohr-mitte'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mohr-mitte'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['mohr-mitte'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mohr-mitte'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['mohr-mitte'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['mohr-radius'],         qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mohr-radius'],         qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['mohr-radius'],         qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mohr-radius'],         qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['mohr-radius'],         qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['haupt-spann'],         qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['haupt-spann'],         qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['haupt-spann'],         qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['haupt-spann'],         qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['haupt-spann'],         qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['tau-max'],             qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['tau-max'],             qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['tau-max'],             qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['tau-max'],             qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['tau-max'],             qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['haupt-winkel'],        qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['haupt-winkel'],        qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['haupt-winkel'],        qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['haupt-winkel'],        qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['haupt-winkel'],        qty: 1 },
              { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['mohr-anwend'],         qty: 1 },
              { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mohr-anwend'],         qty: 1 },
              { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['mohr-anwend'],         qty: 1 },
              { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mohr-anwend'],         qty: 1 },
              { subGoal: 5, stage: 'transfer',          type: 'matching',        uses: ['mohr-anwend'],         qty: 1 },
            ],
          },
...
**Typischer Fehler:** Den Mittelpunkt $\\sigma_M = 50$ als Hauptspannung interpretieren (Option 50 MPa). $\\sigma_M$ ist die Lage des Kreismittelpunkts, nicht ein Wert **auf** dem Kreis.`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-1', concepts: ['sigma-fa'] },
              { lessonId: 'fest-2-2', concepts: ['re-rm-wahl'] },
            ],
            concepts: [
              { id: 'sigma-m',     title: 'Mittelspannung $\\sigma_m=(\\sigma_{\\max}+\\sigma_{\\min})/2$',                       dependsOn: [] },
              { id: 'sigma-a',     title: 'Ausschlagspannung $\\sigma_a=(\\sigma_{\\max}-\\sigma_{\\min})/2$',                     dependsOn: [] },
              { id: 'goodman',     title: 'Goodman $\\sigma_a/\\sigma_W+\\sigma_m/R_m\\le 1$',                                       dependsOn: ['sigma-m', 'sigma-a'] },
              { id: 'sigma-w',     title: 'Wechselfestigkeit $\\sigma_W$: Amplitudengrenze bei $\\sigma_m=0$',                     dependsOn: [] },
              { id: 'wohlerlinie', title: 'Schwingfestigkeit: Dauerfestigkeit/Zeitfestigkeit/Wöhlerlinie ($N>10^6$)',              dependsOn: ['sigma-w'] },
            ],
            subGoalConcepts: { 0: ['sigma-m'], 1: ['sigma-a'], 2: ['goodman'], 3: ['sigma-w'], 4: ['wohlerlinie'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['sigma-m'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-m'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-m'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-m'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['sigma-m'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['sigma-a'],          qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-a'],          qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-a'],          qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-a'],          qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['sigma-a'],          qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['goodman'],          qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['goodman'],          qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['goodman'],          qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['goodman'],          qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['goodman'],          qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['sigma-w'],          qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-w'],          qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['sigma-w'],          qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-w'],          qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['sigma-w'],          qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['wohlerlinie'],      qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wohlerlinie'],      qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['wohlerlinie'],      qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wohlerlinie'],      qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['wohlerlinie'],      qty: 1 },
            ],
          },
...
$\sigma_W$ = Wechselfestigkeit, $R_m$ = Zugfestigkeit. Sicherheit $S > 1$ erforderlich.`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-1', concepts: ['sigma-fa'] },
              { lessonId: 'fest-2-4', concepts: ['sigma-w'] },
            ],
            concepts: [
              { id: 'formzahl',     title: 'Formzahl $\\alpha_K=\\sigma_{\\max}/\\sigma_{\\text{nenn}}$ (rein geometrisch)',     dependsOn: [] },
              { id: 'kerbwirk',     title: 'Kerbwirkungszahl $\\beta_K\\le\\alpha_K$ (werkstoffabhängig)',                          dependsOn: ['formzahl'] },
              { id: 'kerb-werte',   title: 'Welleabsatz scharf $\\alpha_K=2$–3, Gewindegrund $3$–5',                                dependsOn: ['formzahl'] },
              { id: 'kerb-massnahmen', title: 'Verrundung, Oberflächengüte, Druckeigenspannungen',                                  dependsOn: ['formzahl'] },
              { id: 'sigma-wk',     title: 'Dauerfestigkeit mit Kerbe $\\sigma_{W,K}=\\sigma_W/\\beta_K$',                          dependsOn: ['kerbwirk'] },
            ],
            subGoalConcepts: { 0: ['formzahl'], 1: ['kerbwirk'], 2: ['kerb-werte'], 3: ['kerb-massnahmen'], 4: ['sigma-wk'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['formzahl'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['formzahl'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['formzahl'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['formzahl'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['formzahl'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['kerbwirk'],          qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kerbwirk'],          qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['kerbwirk'],          qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kerbwirk'],          qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['kerbwirk'],          qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['kerb-werte'],        qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kerb-werte'],        qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['kerb-werte'],        qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kerb-werte'],        qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['kerb-werte'],        qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['kerb-massnahmen'],   qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kerb-massnahmen'],   qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['kerb-massnahmen'],   qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kerb-massnahmen'],   qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['kerb-massnahmen'],   qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['sigma-wk'],          qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-wk'],          qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-wk'],          qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-wk'],          qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['sigma-wk'],          qty: 1 },
            ],
          },
      ...
      lessons: [
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-1', concepts: ['sigma-fa'] },
              { lessonId: 'fest-1-3', concepts: ['tau-mt-wp'] },
              { lessonId: 'fest-2-1', concepts: ['sigma-b'] },
              { lessonId: 'fest-2-2', concepts: ['sigma-zul-fest', 're-rm-wahl'] },
            ],
            concepts: [
              { id: 'kombi-bean',  title: 'Kombinierte Beanspruchung: Vergleichsspannung GEH (Mises) oder NH',                   dependsOn: [] },
              { id: 'mises',       title: 'Mises $\\sigma_v=\\sqrt{\\sigma^2+3\\tau^2}$ für Zug+Torsion',                          dependsOn: ['kombi-bean'] },
              { id: 'nachweis-sv', title: '$\\sigma_v\\le R_e/S$ bzw. $R_m/S$',                                                    dependsOn: ['mises'] },
              { id: 'welle-design', title: 'Welle dimensionieren aus $M_b, M_T$',                                                  dependsOn: ['mises'] },
              { id: 's-ergebnis',  title: 'Sicherheit $S=R/\\sigma_v\\ge S_{\\text{soll}}$ angeben',                                dependsOn: ['nachweis-sv'] },
            ],
            subGoalConcepts: { 0: ['kombi-bean'], 1: ['mises'], 2: ['nachweis-sv'], 3: ['welle-design'], 4: ['s-ergebnis'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['kombi-bean'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kombi-bean'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['kombi-bean'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kombi-bean'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['kombi-bean'],          qty: 1, note: '[PRÜFUNG]' },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['mises'],               qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mises'],               qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['mises'],               qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mises'],               qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['mises'],               qty: 1, note: '[PRÜFUNG]' },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['nachweis-sv'],         qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['nachweis-sv'],         qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['nachweis-sv'],         qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['nachweis-sv'],         qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['nachweis-sv'],         qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['welle-design'],        qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['welle-design'],        qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['welle-design'],        qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['welle-design'],        qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['welle-design'],        qty: 1, note: '[PRÜFUNG]' },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['s-ergebnis'],          qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['s-ergebnis'],          qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['s-ergebnis'],          qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['s-ergebnis'],          qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['s-ergebnis'],          qty: 1 },
            ],
          },
...
| Rohr (D, d) | $\pi(D^4-d^4)/64$ | $\pi(D^4-d^4)/(32D)$ |`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'fest-1-3', concepts: ['tau-mt-wp', 'wp-d3-16'] },
              { lessonId: 'fest-1-4', concepts: ['euler-fki', 'einspannbeiw', 'schlankheit', 'euler-grenze'] },
              { lessonId: 'fest-2-4', concepts: ['goodman'] },
            ],
            concepts: [
              { id: 'tau-welle-pr', title: 'Torsionsspannung Welle $\\tau=M_T/W_p$, $W_p=\\pi d^3/16$',                            dependsOn: [] },
              { id: 'euler-pr',     title: 'Euler $F_{ki}=\\pi^2 EI/(\\beta L)^2$, $\\beta$ aus Lagerung',                          dependsOn: [] },
              { id: 'goodman-s',    title: 'Goodman mit Sicherheit: $\\sigma_a/\\sigma_W+\\sigma_m/R_m\\le 1/S$',                   dependsOn: [] },
              { id: 's235',         title: 'S235: Mindeststreckgrenze $R_e=235$ MPa',                                                dependsOn: [] },
              { id: 'lambda-grenze', title: 'Schlankheit prüfen: $\\lambda>\\lambda_0$ Euler, sonst Tetmajer/Johnson',               dependsOn: ['euler-pr'] },
            ],
            subGoalConcepts: { 0: ['tau-welle-pr'], 1: ['euler-pr'], 2: ['goodman-s'], 3: ['s235'], 4: ['lambda-grenze'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['tau-welle-pr'],         qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['tau-welle-pr'],         qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['tau-welle-pr'],         qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['tau-welle-pr'],         qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['tau-welle-pr'],         qty: 1, note: '[PRÜFUNG]' },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['euler-pr'],             qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['euler-pr'],             qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['euler-pr'],             qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['euler-pr'],             qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['euler-pr'],             qty: 1, note: '[PRÜFUNG]' },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['goodman-s'],            qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['goodman-s'],            qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['goodman-s'],            qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['goodman-s'],            qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['goodman-s'],            qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['s235'],                 qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['s235'],                 qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['s235'],                 qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['s235'],                 qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['s235'],                 qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['lambda-grenze'],        qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lambda-grenze'],        qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['lambda-grenze'],        qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lambda-grenze'],        qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['lambda-grenze'],        qty: 1 },
            ],
          },
