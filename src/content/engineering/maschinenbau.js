        ...
        lessons: [
          {
            ...
            content: `Ein **Freikörperbild** isoliert ein Bauteil und ersetzt alle Kontakte durch Kräfte und Momente.
...
4. Gleichgewichtsbedingungen aufstellen: $\sum F_x = 0$, $\sum F_y = 0$, $\sum M = 0$`,
          ...
          },
          {
            ...
            content: `Das **Moment** beschreibt die Drehwirkung einer Kraft.
...
Dabei ist $l_\perp$ der senkrechte Abstand zwischen Drehpunkt und Wirkungslinie der Kraft. Vorzeichen werden über den Drehsinn festgelegt.`,
            exercises: [
              { type: 'number-input', question: 'Eine Kraft F = 20 N greift mit Hebelarm l = 0,5 m an. Moment?', correctAnswer: 10, tolerance: 0.01, unit: 'Nm', explanation: 'M = F·l = 20·0,5 = 10 Nm.', hints: ['Einheit: Newtonmeter.'] },
        ...
        lessons: [
          {
            ...
            content: `Die Grundgleichung der Dynamik lautet:
...
Masse ist eine Eigenschaft des Körpers. Gewichtskraft ist die Kraft im Schwerefeld: $F_G = m \cdot g$.`,
          ...
          },
          {
            ...
            content: `Mechanische Arbeit bei konstanter Kraft:
        ...
        lessons: [
          {
            ...
            content: `Die **Normalspannung** ist Kraft pro Querschnittsfläche:
...
1 MPa entspricht 1 N/mm². Diese Einheit ist in der Konstruktion sehr praktisch.`,
          ...
          },
          {
            ...
            content: `Im linear-elastischen Bereich gilt:
...
Der E-Modul beschreibt die Steifigkeit des Materials. Stahl hat ungefähr $E = 210000$ MPa.`,
            ...
            exercises: [
              { type: 'number-input', question: 'E = 200000 MPa, ε = 0,001. Spannung?', correctAnswer: 200, tolerance: 0.01, unit: 'MPa', explanation: 'σ = E·ε = 200000·0,001 = 200 MPa.', hints: ['Dehnung ist dimensionslos.'] },
        ...
        lessons: [
          {
            ...
            content: `Bei reiner Biegung wird die maximale Normalspannung abgeschätzt mit:

$$\sigma_b = \frac{M_b}{W_b}$$

Das Widerstandsmoment $W_b$ hängt stark von der Querschnittsform ab.`,
            exercises: [
              { type: 'number-input', question: 'M_b = 200 Nm, W_b = 20 cm³. Mit 1 Nm = 1000 Nmm und 1 cm³ = 1000 mm³: σ_b?', correctAnswer: 10, tolerance: 0.01, unit: 'N/mm²', explanation: '200 Nm = 200000 Nmm, 20 cm³ = 20000 mm³, σ = 10 N/mm².', hints: ['Einheiten zuerst auf Nmm und mm³ bringen.'] },
          ...
          },
          {
            ...
            content: `Ein einfacher Festigkeitsnachweis lautet:

$$\sigma_\text{vorh} \le \sigma_\text{zul} = \frac{R}{S}$$

$R$ ist eine Materialkennzahl, $S$ die Sicherheitszahl.`,
            exercises: [
              { type: 'number-input', question: 'R = 300 MPa, S = 2. Zulässige Spannung?', correctAnswer: 150, tolerance: 0.01, unit: 'MPa', explanation: 'σ_zul = R/S = 300/2 = 150 MPa.', hints: ['Sicherheitszahl steht im Nenner.'] },
...
Wichtig: Temperatur immer in Kelvin einsetzen. $T_K = T_{°C} + 273{,}15$.`,
          ...
          },
          {
            ...
            content: `Volumenänderungsarbeit ist die Fläche im p-V-Diagramm:

$$W = \int p\,dV$$

Bei konstantem Druck vereinfacht sich das zu $W = p \cdot \Delta V$.`,
            exercises: [
              { type: 'number-input', question: 'p = 200 kPa, ΔV = 0,01 m³. Arbeit?', correctAnswer: 2000, tolerance: 1, unit: 'J', explanation: '200 kPa = 200000 Pa. W = p·ΔV = 200000·0,01 = 2000 J.', hints: ['Pa·m³ = J.'] },
        ...
        lessons: [
          {
            ...
            content: `Der erste Hauptsatz ist Energieerhaltung für thermodynamische Systeme:

$$\Delta U = Q - W$$

$Q$ ist zugeführte Wärme, $W$ ist vom System abgegebene Arbeit.`,
            exercises: [
              { type: 'number-input', question: 'Q = 500 J, W = 200 J. ΔU?', correctAnswer: 300, tolerance: 0.01, unit: 'J', explanation: 'ΔU = Q − W = 500 − 200 = 300 J.', hints: ['Vorzeichenkonvention beachten.'] },
          ...
          },
          {
            ...
            content: `Der Wirkungsgrad misst den nutzbaren Anteil der zugeführten Energie:

$$\eta = \frac{E_\text{nutz}}{E_\text{zu}}$$

Er liegt bei realen Maschinen kleiner als 1.`,
            exercises: [
              { type: 'number-input', question: 'Nutzenergie 80 J, zugeführte Energie 100 J. Wirkungsgrad?', correctAnswer: 0.8, tolerance: 0.01, unit: '', explanation: 'η = 80/100 = 0,8 = 80%.', hints: ['Quotient aus Nutzen und Aufwand.'] },
        ...
        lessons: [
          {
            ...
            content: `In einem ruhenden Fluid steigt der Druck mit der Tiefe:
...
Dazu kommt je nach Bezug noch der Umgebungsdruck.`,
          ...
          },
          {
            ...
            content: `Die Auftriebskraft entspricht dem Gewicht der verdrängten Flüssigkeit:

$$F_A = \rho_\text{Fluid} \cdot g \cdot V_\text{verdrängt}$$`,
            exercises: [
              { type: 'number-input', question: 'Ein Körper verdrängt 0,01 m³ Wasser. Auftrieb gerundet?', correctAnswer: 98.1, tolerance: 0.5, unit: 'N', explanation: 'F_A = 1000·9,81·0,01 = 98,1 N.', hints: ['Nutze Archimedes.'] },
        ...
        lessons: [
          {
            ...
            content: `Für inkompressible stationäre Strömung gilt:

$$A_1 v_1 = A_2 v_2 = \dot V$$

Wird der Querschnitt kleiner, steigt die Strömungsgeschwindigkeit.`,
            exercises: [
              { type: 'number-input', question: 'A1 = 4 cm², v1 = 2 m/s, A2 = 2 cm². v2?', correctAnswer: 4, tolerance: 0.01, unit: 'm/s', explanation: 'A1 v1 = A2 v2 → v2 = 4·2/2 = 4 m/s.', hints: ['Querschnitt halbiert → Geschwindigkeit verdoppelt.'] },
          ...
          },
          {
            ...
            content: `Für reibungsarme stationäre Strömung entlang einer Stromlinie:
        ...
        lessons: [
          {
            ...
            content: `Schraubenverbindungen nutzen **Vorspannung**, um Bauteile zu klemmen.
...
Bei Betriebslast darf die Klemmkraft nicht vollständig abgebaut werden, sonst können Fugen öffnen und Schrauben zyklisch überlastet werden.`,
            exercises: [
              ...
              { type: 'number-input', question: 'Eine Schraube trägt 12 kN von insgesamt 48 kN. Anteil?', correctAnswer: 0.25, tolerance: 0.01, unit: '', explanation: '12/48 = 0,25 = 25%.', hints: ['Teil durch Gesamt.'] },
            ],
          },
          {
            id: 'melem-1-2',
            ...
            content: `Eine Passfeder überträgt Drehmoment über **Formschluss** zwischen Welle und Nabe.
        ...
        lessons: [
          {
            ...
            content: `Eine **Welle** überträgt Drehmoment und Rotation. Ein **Lager** stützt die Welle und erlaubt definierte Bewegung.
...
Radiallast wirkt quer zur Wellenachse, Axiallast entlang der Wellenachse.`,
          ...
          },
          {
            ...
            content: `Für ein einfaches Zahnradpaar gilt näherungsweise:

$$i = \frac{z_2}{z_1} = \frac{n_1}{n_2}$$

Mehr Zähne am Abtriebsrad bedeuten geringere Abtriebsdrehzahl und höheres Drehmoment.`,
            exercises: [
              { type: 'number-input', question: 'z1 = 20, z2 = 60. Übersetzung i?', correctAnswer: 3, tolerance: 0.01, unit: '', explanation: 'i = z2/z1 = 60/20 = 3.', hints: ['Abtriebszähne durch Antriebszähne.'] },
