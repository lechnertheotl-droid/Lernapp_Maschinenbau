      ...
      lessons: [
        {
          ...
          blueprint: {
            prerequisites: [],
            concepts: [
              { id: 'dyn-typing',  title: 'Dynamische Typisierung — Typ wechselt mit Wert',                                       dependsOn: [] },
              { id: 'type-funkt',  title: 'Typprüfung mit `type(x)`',                                                              dependsOn: ['dyn-typing'] },
              { id: 'konvertier',  title: 'Konvertierung `int()/float()/str()` — `int("3.14")` wirft Fehler',                     dependsOn: ['dyn-typing'] },
              { id: 'naming-conv', title: 'snake_case (Python) vs. camelCase (Matlab)',                                            dependsOn: [] },
            ],
            subGoalConcepts: { 0: ['dyn-typing'], 1: ['type-funkt'], 2: ['konvertier'], 3: ['naming-conv'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['dyn-typing'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['dyn-typing'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['dyn-typing'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['dyn-typing'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['dyn-typing'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['type-funkt'],          qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['type-funkt'],          qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['type-funkt'],          qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['type-funkt'],          qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['type-funkt'],          qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['konvertier'],          qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['konvertier'],          qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['konvertier'],          qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['konvertier'],          qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['konvertier'],          qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['naming-conv'],         qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['naming-conv'],         qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['naming-conv'],         qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['naming-conv'],         qty: 1 },
...
**Typischer Fehler:** Java/C/C++-Syntax übernehmen und \`int x = 5\` schreiben — das ist in Python kein gültiges Statement.`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-1-1', concepts: ['dyn-typing'] },
            ],
            concepts: [
              { id: 'div-op',      title: '`/` Float, `//` Integer, `%` Modulo',                                                  dependsOn: [] },
              { id: 'pot-op',      title: 'Python `**`, Matlab `^` bzw. `.^` elementweise',                                        dependsOn: [] },
              { id: 'log-op',      title: 'Logik Python `and/or/not`, Matlab `&&/||/~`',                                            dependsOn: [] },
              { id: 'float-cmp',   title: 'Float-Vergleich `abs(a-b)<1e-9` statt `==`',                                              dependsOn: [] },
              { id: 'bool-int',    title: '`bool` ist Subtyp von `int`: `0==False`, `1==True`',                                     dependsOn: [] },
            ],
            subGoalConcepts: { 0: ['div-op'], 1: ['pot-op'], 2: ['log-op'], 3: ['float-cmp'], 4: ['bool-int'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['div-op'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['div-op'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['div-op'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['div-op'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['div-op'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['pot-op'],          qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pot-op'],          qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['pot-op'],          qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pot-op'],          qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['pot-op'],          qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['log-op'],          qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['log-op'],          qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['log-op'],          qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['log-op'],          qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['log-op'],          qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['float-cmp'],       qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['float-cmp'],       qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['float-cmp'],       qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['float-cmp'],       qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['float-cmp'],       qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['bool-int'],        qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['bool-int'],        qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['bool-int'],        qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['bool-int'],        qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['bool-int'],        qty: 1 },
            ],
          },
...
**Operatorreihenfolge:** Wie in Mathe: Klammern → Potenz → Punkt → Strich. Im Zweifel: Klammern setzen!`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [],
            concepts: [
              { id: 'index-base', title: 'Python 0-basiert, Matlab 1-basiert',                                                    dependsOn: [] },
              { id: 'slicing',    title: 'Slicing `liste[a:b]` — rechte Grenze exklusiv',                                          dependsOn: ['index-base'] },
              { id: 'numpy-vec',  title: 'NumPy-Arrays vektorisiert (elementweise + − * /)',                                       dependsOn: [] },
              { id: 'dtype-mix',  title: 'Liste: gemischte Typen; NumPy: ein dtype',                                                dependsOn: ['numpy-vec'] },
            ],
            subGoalConcepts: { 0: ['index-base'], 1: ['slicing'], 2: ['numpy-vec'], 3: ['dtype-mix'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['index-base'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['index-base'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['index-base'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['index-base'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['index-base'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['slicing'],             qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['slicing'],             qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['slicing'],             qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['slicing'],             qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['slicing'],             qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['numpy-vec'],           qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['numpy-vec'],           qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['numpy-vec'],           qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['numpy-vec'],           qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['numpy-vec'],           qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['dtype-mix'],           qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['dtype-mix'],           qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['dtype-mix'],           qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['dtype-mix'],           qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['dtype-mix'],           qty: 1 },
            ],
          },
...
**Typischer Fehler:** Vergessen, dass die rechte Grenze exklusiv ist, und z.B. \`np.arange(1, 5)\` schreiben — das liefert nur \`[1, 2, 3, 4]\` (vier Werte statt fünf).`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-1-3', concepts: ['index-base'] },
            ],
            concepts: [
              { id: 'einrueckung',  title: 'Python: Einrückung statt `end`; Matlab: immer `end`',                                  dependsOn: [] },
              { id: 'eq-vs-assign', title: '`==` Vergleich, `=` Zuweisung',                                                          dependsOn: [] },
              { id: 'for-range',    title: '`for i in range(n)` 0..n−1 / Matlab `for i=1:n` 1..n',                                  dependsOn: [] },
              { id: 'while-abbruch', title: 'While: Abbruchbedingung Pflicht (Endlos-Loop verhindern)',                              dependsOn: [] },
            ],
            subGoalConcepts: { 0: ['einrueckung'], 1: ['eq-vs-assign'], 2: ['for-range'], 3: ['while-abbruch'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['einrueckung'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['einrueckung'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['einrueckung'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['einrueckung'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['einrueckung'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['eq-vs-assign'],         qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['eq-vs-assign'],         qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['eq-vs-assign'],         qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['eq-vs-assign'],         qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['eq-vs-assign'],         qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['for-range'],            qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['for-range'],            qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['for-range'],            qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['for-range'],            qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['for-range'],            qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['while-abbruch'],        qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['while-abbruch'],        qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['while-abbruch'],        qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['while-abbruch'],        qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['while-abbruch'],        qty: 1 },
            ],
          },
...
**Häufigster Fehler:** Vergessener Doppelpunkt \`:\` am Ende der if/for/while-Zeile in Python!`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [],
            concepts: [
              { id: 'def-syntax',  title: 'Python `def name(param):`, Matlab `function y = name(x)`',                            dependsOn: [] },
              { id: 'rueckgabe',   title: 'Python `return`, Matlab Zuweisung an Output-Variable',                                  dependsOn: ['def-syntax'] },
              { id: 'default-par', title: 'Default-Parameter `def f(x, y=0):`',                                                   dependsOn: ['def-syntax'] },
              { id: 'lambda',      title: 'Lambda `sqr = lambda x: x**2`',                                                          dependsOn: [] },
              { id: 'doc-str',     title: 'Docstring (Python) / Header-Kommentar (Matlab)',                                         dependsOn: [] },
            ],
            subGoalConcepts: { 0: ['def-syntax'], 1: ['rueckgabe'], 2: ['default-par'], 3: ['lambda'], 4: ['doc-str'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['def-syntax'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['def-syntax'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['def-syntax'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['def-syntax'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['def-syntax'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['rueckgabe'],           qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rueckgabe'],           qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['rueckgabe'],           qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rueckgabe'],           qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['rueckgabe'],           qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['default-par'],         qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['default-par'],         qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['default-par'],         qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['default-par'],         qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['default-par'],         qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['lambda'],              qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lambda'],              qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['lambda'],              qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lambda'],              qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['lambda'],              qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['doc-str'],             qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['doc-str'],             qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['doc-str'],             qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['doc-str'],             qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'matching',        uses: ['doc-str'],             qty: 1 },
            ],
          },
      ...
      lessons: [
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-1-3', concepts: ['numpy-vec', 'dtype-mix'] },
            ],
            concepts: [
              { id: 'np-create',   title: 'Erzeugen: `np.array, zeros, ones, eye, linspace`',                                    dependsOn: [] },
              { id: 'np-element',  title: 'Elementweise `*` (NumPy) vs. `.*` (Matlab); Matrix `@` / `*`',                          dependsOn: [] },
              { id: 'shape',       title: '`a.shape` (NumPy) / `size(a)` (Matlab)',                                                 dependsOn: ['np-create'] },
              { id: 'vektorisier', title: 'Vektorisierung statt Schleifen: 10–100× schneller',                                     dependsOn: ['np-element'] },
              { id: 'broadcast',   title: 'Broadcasting $(n,1)+(1,m)\\to(n,m)$',                                                    dependsOn: ['np-element'] },
            ],
            subGoalConcepts: { 0: ['np-create'], 1: ['np-element'], 2: ['shape'], 3: ['vektorisier'], 4: ['broadcast'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['np-create'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['np-create'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['np-create'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['np-create'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['np-create'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['np-element'],         qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['np-element'],         qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['np-element'],         qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['np-element'],         qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['np-element'],         qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['shape'],              qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['shape'],              qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['shape'],              qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['shape'],              qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['shape'],              qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['vektorisier'],        qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['vektorisier'],        qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['vektorisier'],        qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['vektorisier'],        qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['vektorisier'],        qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['broadcast'],          qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['broadcast'],          qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['broadcast'],          qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['broadcast'],          qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['broadcast'],          qty: 1 },
            ],
          },
...
**Achtung:** In Python ist \`*\` elementweise und \`@\` die Matrixmultiplikation. In Matlab ist es genau umgekehrt!`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-2-1', concepts: ['np-create'] },
            ],
            concepts: [
              { id: 'plt-basis',  title: 'Basis-Plot `plt.plot(x,y)`, Titel, xlabel/ylabel, legend, grid',                       dependsOn: [] },
              { id: 'farbstil',   title: 'Linienstil `\'b-\'`, `\'r--\'`, `\'g:\'`',                                                dependsOn: ['plt-basis'] },
              { id: 'mehr-kurven', title: 'Mehrere Kurven: mehrere `plt.plot()`-Aufrufe',                                          dependsOn: ['plt-basis'] },
              { id: 'savefig',    title: '`plt.savefig` VOR `plt.show()`',                                                          dependsOn: ['plt-basis'] },
              { id: 'plot-label', title: 'Achsen/Einheiten beschriften — Punkte in Berichten',                                      dependsOn: ['plt-basis'] },
            ],
            subGoalConcepts: { 0: ['plt-basis'], 1: ['farbstil'], 2: ['mehr-kurven'], 3: ['savefig'], 4: ['plot-label'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['plt-basis'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['plt-basis'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['plt-basis'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['plt-basis'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['plt-basis'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['farbstil'],           qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['farbstil'],           qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'matching',        uses: ['farbstil'],           qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['farbstil'],           qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['farbstil'],           qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['mehr-kurven'],        qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mehr-kurven'],        qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['mehr-kurven'],        qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mehr-kurven'],        qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['mehr-kurven'],        qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['savefig'],            qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['savefig'],            qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['savefig'],            qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['savefig'],            qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['savefig'],            qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['plot-label'],         qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['plot-label'],         qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['plot-label'],         qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['plot-label'],         qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['plot-label'],         qty: 1 },
            ],
          },
...
| 3D-Fläche | \`ax.plot_surface\` | \`surf(X, Y, Z)\` |`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-2-1', concepts: ['np-create', 'shape'] },
            ],
            concepts: [
              { id: 'fsolve',      title: 'fsolve $(f, x_0)$ — Startwert nah an Lösung',                                          dependsOn: [] },
              { id: 'linalg-solve', title: '`np.linalg.solve(A, b)` statt Inverse',                                                dependsOn: [] },
              { id: 'backslash',    title: 'Matlab `A \\ b`',                                                                       dependsOn: ['linalg-solve'] },
              { id: 'minimize',     title: 'minimize für Min, $-f$ für Max',                                                       dependsOn: [] },
              { id: 'dim-check',    title: 'Vor solve Dimensionen prüfen $A: (n,n)$, $b: (n,)$',                                    dependsOn: ['linalg-solve'] },
            ],
            subGoalConcepts: { 0: ['fsolve'], 1: ['linalg-solve'], 2: ['backslash'], 3: ['minimize'], 4: ['dim-check'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['fsolve'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fsolve'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['fsolve'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fsolve'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['fsolve'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['linalg-solve'],    qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['linalg-solve'],    qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['linalg-solve'],    qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['linalg-solve'],    qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['linalg-solve'],    qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['backslash'],       qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['backslash'],       qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['backslash'],       qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['backslash'],       qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['backslash'],       qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['minimize'],        qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['minimize'],        qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['minimize'],        qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['minimize'],        qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['minimize'],        qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['dim-check'],       qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['dim-check'],       qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['dim-check'],       qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['dim-check'],       qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['dim-check'],       qty: 1 },
            ],
          },
...
**Anwendung im MB:** Festigkeitsnachweise, Auslegungsoptimierung, Strömungsberechnung — überall braucht man Solver!`,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-1-5', concepts: ['def-syntax'] },
              { lessonId: 'py-2-3', concepts: ['fsolve'] },
            ],
            concepts: [
              { id: 'quad',         title: 'Bestimmtes Integral `scipy.integrate.quad(f, a, b)`',                                  dependsOn: [] },
              { id: 'matlab-int',   title: 'Matlab `integral(@(x) f(x), a, b)`',                                                    dependsOn: ['quad'] },
              { id: 'dgl-system',   title: 'DGL n. Ord. → System 1. Ordnung umschreiben',                                           dependsOn: [] },
              { id: 'solve-ivp',    title: '`solve_ivp(f, [t0,t1], y0)`, `t_eval=...`',                                              dependsOn: ['dgl-system'] },
              { id: 'rk45',         title: 'RK45 / ode45 — adaptive Schrittweite $O(h^5)$',                                          dependsOn: ['solve-ivp'] },
            ],
            subGoalConcepts: { 0: ['quad'], 1: ['matlab-int'], 2: ['dgl-system'], 3: ['solve-ivp'], 4: ['rk45'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['quad'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['quad'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['quad'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['quad'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['quad'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['matlab-int'],    qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['matlab-int'],    qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['matlab-int'],    qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['matlab-int'],    qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['matlab-int'],    qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['dgl-system'],    qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['dgl-system'],    qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['dgl-system'],    qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['dgl-system'],    qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['dgl-system'],    qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['solve-ivp'],     qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['solve-ivp'],     qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['solve-ivp'],     qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['solve-ivp'],     qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['solve-ivp'],     qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['rk45'],          qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rk45'],          qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['rk45'],          qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rk45'],          qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['rk45'],          qty: 1 },
            ],
          },
      ...
      lessons: [
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-1-5', concepts: ['def-syntax'] },
              { lessonId: 'py-2-1', concepts: ['vektorisier'] },
              { lessonId: 'py-2-2', concepts: ['plt-basis'] },
            ],
            concepts: [
              { id: 'i-w-funkt',   title: 'Rechteck $I=bh^3/12$, $W=bh^2/6$ als Funktion',                                       dependsOn: [] },
              { id: 'sigma-vec',   title: 'Biegespannung $\\sigma_b=M_b/W$ entlang Balken (Vektor-Op)',                          dependsOn: [] },
              { id: 'm-max-np',    title: '$M_{\\max}$ via `np.max(np.abs(M))`',                                                  dependsOn: ['sigma-vec'] },
              { id: 'qs-funktion', title: 'Querschnitte als Funktionen kapseln (DRY)',                                              dependsOn: [] },
              { id: 'plot-sigma',  title: 'Spannungsverlauf $\\sigma(x)$ plotten mit Einheit',                                     dependsOn: ['sigma-vec'] },
            ],
            subGoalConcepts: { 0: ['i-w-funkt'], 1: ['sigma-vec'], 2: ['m-max-np'], 3: ['qs-funktion'], 4: ['plot-sigma'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['i-w-funkt'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['i-w-funkt'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['i-w-funkt'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['i-w-funkt'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['i-w-funkt'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['sigma-vec'],          qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-vec'],          qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-vec'],          qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-vec'],          qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['sigma-vec'],          qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['m-max-np'],           qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['m-max-np'],           qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['m-max-np'],           qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['m-max-np'],           qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['m-max-np'],           qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['qs-funktion'],        qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['qs-funktion'],        qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['qs-funktion'],        qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['qs-funktion'],        qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['qs-funktion'],        qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['plot-sigma'],         qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['plot-sigma'],         qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['plot-sigma'],         qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['plot-sigma'],         qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['plot-sigma'],         qty: 1 },
            ],
          },
...
\`\`\``,
        ...
        },
        {
          ...
          blueprint: {
            ...
            concepts: [
              { id: 'csv-read',    title: '`np.loadtxt` einfach, `pd.read_csv` mit Headern',                                     dependsOn: [] },
              { id: 'np-stat',     title: 'Statistik `np.mean/std/median/max/min`',                                                dependsOn: [] },
              { id: 'polyfit',     title: 'Polynom-Fit `np.polyfit(x, y, n)`',                                                     dependsOn: [] },
              { id: 'pandas-df',   title: 'Pandas `df[\'Spalte\']`, `df.describe()`',                                                dependsOn: ['csv-read'] },
              { id: 'scatter-fit', title: 'Scatter (Messung) + Fit-Kurve (Modell) zusammen',                                       dependsOn: ['polyfit'] },
            ],
            subGoalConcepts: { 0: ['csv-read'], 1: ['np-stat'], 2: ['polyfit'], 3: ['pandas-df'], 4: ['scatter-fit'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['csv-read'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['csv-read'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['csv-read'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['csv-read'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['csv-read'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['np-stat'],           qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['np-stat'],           qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['np-stat'],           qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['np-stat'],           qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['np-stat'],           qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['polyfit'],           qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['polyfit'],           qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['polyfit'],           qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['polyfit'],           qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['polyfit'],           qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['pandas-df'],         qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pandas-df'],         qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['pandas-df'],         qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pandas-df'],         qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['pandas-df'],         qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['scatter-fit'],       qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['scatter-fit'],       qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['scatter-fit'],       qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['scatter-fit'],       qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['scatter-fit'],       qty: 1 },
            ],
          },
...
Matlab: \`p = polyfit(zeit, kraft, 2); plot(zeit, polyval(p, zeit))\``,
        ...
        },
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-2-2', concepts: ['plt-basis'] },
              { lessonId: 'py-2-4', concepts: ['dgl-system', 'solve-ivp'] },
            ],
            concepts: [
              { id: 'fmd-py',      title: 'Bewegungsgleichung $m\\ddot x+d\\dot x+kx=F(t)$ als System 1. Ord.',                  dependsOn: [] },
              { id: 'omega0-d-py', title: 'Eigen $\\omega_0=\\sqrt{k/m}$, Dämpfung $D=d/(2\\sqrt{km})$',                          dependsOn: [] },
              { id: 'freq-gang',   title: 'Frequenzgang: Amplitude über $\\Omega$ plotten',                                        dependsOn: [] },
              { id: 'param-loop',  title: 'Schleife über $\\Omega$, pro Wert ODE lösen',                                            dependsOn: ['freq-gang'] },
              { id: 'einschwing',  title: 'Einschwingvorgang ignorieren: zweite Hälfte auswerten',                                  dependsOn: ['param-loop'] },
            ],
            subGoalConcepts: { 0: ['fmd-py'], 1: ['omega0-d-py'], 2: ['freq-gang'], 3: ['param-loop'], 4: ['einschwing'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['fmd-py'],          qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fmd-py'],          qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['fmd-py'],          qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fmd-py'],          qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['fmd-py'],          qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['omega0-d-py'],     qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['omega0-d-py'],     qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['omega0-d-py'],     qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['omega0-d-py'],     qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['omega0-d-py'],     qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['freq-gang'],       qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['freq-gang'],       qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['freq-gang'],       qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['freq-gang'],       qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['freq-gang'],       qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['param-loop'],      qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['param-loop'],      qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['param-loop'],      qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['param-loop'],      qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['param-loop'],      qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['einschwing'],      qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['einschwing'],      qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['einschwing'],      qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['einschwing'],      qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['einschwing'],      qty: 1 },
            ],
          },
      ...
      lessons: [
        {
          ...
          blueprint: {
            prerequisites: [
              { lessonId: 'py-1-3', concepts: ['index-base'] },
              { lessonId: 'py-1-2', concepts: ['pot-op'] },
              { lessonId: 'py-2-1', concepts: ['np-element'] },
              { lessonId: 'py-1-4', concepts: ['for-range', 'eq-vs-assign'] },
            ],
            concepts: [
              { id: 'idx-offset',  title: 'Indizierung: Python 0-basiert vs Matlab 1-basiert (Off-by-one)',          dependsOn: [] },
              { id: 'op-mat-vs-el', title: 'Operatoren: `*`/`@`, `^`/`.^` — elementweise vs Matrix',                 dependsOn: [] },
              { id: 'range-vs-colon', title: '`range(a,b)`: $a..b-1$ vs `a:b`: $a..b$',                              dependsOn: [] },
              { id: 'trace-code',  title: 'Code Zeile-für-Zeile verfolgen (Variablentabelle daneben)',                dependsOn: ['idx-offset', 'range-vs-colon'] },
              { id: 'common-bugs', title: 'Typische Fehler: `=` vs `==`, `:` vergessen, `;` in Matlab',               dependsOn: ['trace-code'] },
            ],
            subGoalConcepts: { 0: ['idx-offset'], 1: ['op-mat-vs-el'], 2: ['range-vs-colon'], 3: ['trace-code'], 4: ['common-bugs'] },
            taskPlan: [
              { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['idx-offset'],     qty: 1 },
              { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['idx-offset'],     qty: 1 },
              { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['idx-offset'],     qty: 1 },
              { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['idx-offset'],     qty: 1 },
              { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['idx-offset'],     qty: 1 },
              { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['op-mat-vs-el'],   qty: 1 },
              { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['op-mat-vs-el'],   qty: 1 },
              { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['op-mat-vs-el'],   qty: 1 },
              { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['op-mat-vs-el'],   qty: 1 },
              { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['op-mat-vs-el'],   qty: 1 },
              { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['range-vs-colon'], qty: 1 },
              { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['range-vs-colon'], qty: 1 },
              { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['range-vs-colon'], qty: 1 },
              { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['range-vs-colon'], qty: 1 },
              { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['range-vs-colon'], qty: 1 },
              { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['trace-code'],     qty: 1 },
              { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['trace-code'],     qty: 1 },
              { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['trace-code'],     qty: 1 },
              { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['trace-code'],     qty: 1 },
              { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['trace-code'],     qty: 1 },
              { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['common-bugs'],    qty: 1 },
              { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['common-bugs'],    qty: 1 },
              { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['common-bugs'],    qty: 1 },
              { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['common-bugs'],    qty: 1 },
              { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['common-bugs'],    qty: 1 },
            ],
          },
