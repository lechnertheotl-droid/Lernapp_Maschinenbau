...
**Typischer Fehler:** Denken, $\\frac{\\infty}{\\infty}$ wäre „unbestimmt = existiert nicht". Tatsächlich ist genau das die Klasse, wo L'Hôpital die Sache auflöst.`,
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'abl-1-3', concepts: ['abl-sin', 'abl-exp', 'abl-ln'] },
          { lessonId: 'abl-1-1', concepts: ['grenzuebergang'] },
        ],
        concepts: [
          { id: 'lim-std-sin',     title: 'Standard $\\lim_{x\\to 0}\\sin x/x=1$',                                                 dependsOn: [] },
          { id: 'lim-std-exp',     title: 'Standard $\\lim_{x\\to 0}(e^x-1)/x=1$',                                                  dependsOn: [] },
          { id: 'euler-grenzwert', title: '$\\lim_{x\\to\\infty}(1+1/x)^x=e$',                                                       dependsOn: [] },
          { id: 'lhopital',        title: 'L\'Hôpital nur bei $0/0$ oder $\\infty/\\infty$',                                          dependsOn: [] },
          { id: 'lhopital-mehr',   title: 'L\'Hôpital ggf. mehrfach anwenden',                                                       dependsOn: ['lhopital'] },
          { id: 'unbest-formen',   title: 'Andere unbestimmte Formen umformen: $0\\cdot\\infty\\to 0/0$, $\\infty-\\infty\\to$ Hauptnenner, $0^0/\\infty^0/1^\\infty\\to\\ln$', dependsOn: ['lhopital'] },
          { id: 'wachstum',        title: 'Wachstumshierarchie: $\\ln x\\ll x^n\\ll e^x$ für $x\\to\\infty$',                       dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['lim-std-sin', 'lim-std-exp'],
          1: ['euler-grenzwert'],
          2: ['lhopital'],
          3: ['lhopital-mehr'],
          4: ['unbest-formen'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['lim-std-sin', 'lim-std-exp'],         qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lim-std-sin'],                        qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['lim-std-sin'],                        qty: 1, note: '$\\sin(3x)/x$' },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lim-std-sin'],                        qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['lim-std-exp'],                        qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['euler-grenzwert'],                    qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['euler-grenzwert'],                    qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['euler-grenzwert'],                    qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['euler-grenzwert'],                    qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['euler-grenzwert'],                    qty: 1, note: 'Zinseszins' },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['lhopital'],                           qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lhopital'],                           qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['lhopital'],                           qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lhopital'],                           qty: 1, note: 'Anwendung ohne $0/0$' },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['lhopital'],                           qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['lhopital-mehr'],                      qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lhopital-mehr'],                      qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['lhopital-mehr'],                      qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lhopital-mehr'],                      qty: 1, note: 'Zwischenwert nicht überprüft' },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['lhopital-mehr'],                      qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['unbest-formen'],                      qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['unbest-formen'],                      qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['unbest-formen', 'lhopital'],          qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['unbest-formen'],                      qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'matching',        uses: ['unbest-formen'],                      qty: 1, note: 'Form ↔ Umformung' },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['wachstum'],                           qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wachstum'],                           qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['wachstum'],                           qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wachstum'],                           qty: 1 },
          { subGoal: 5, stage: 'transfer',          type: 'sorting',         uses: ['wachstum'],                           qty: 1, note: 'Funktionen wachsend ordnen' },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'abl-5-1', concepts: ['lim-std-sin', 'lim-std-exp'] },
          { lessonId: 'abl-1-1', concepts: ['grenzuebergang', 'diff-quotient'] },
        ],
        concepts: [
          { id: 'stetigkeit',     title: 'Stetigkeit in $a$: $\\lim_{x\\to a}f(x)=f(a)$ (beidseitig + Funktionswert)',          dependsOn: [] },
          { id: 'hebbare-unst',   title: 'Hebbar: Grenzwert existiert, aber $f(a)$ fehlt oder weicht ab',                       dependsOn: ['stetigkeit'] },
          { id: 'sprungstelle',   title: 'Sprung: linksseitig $\\neq$ rechtsseitiger Grenzwert',                                 dependsOn: ['stetigkeit'] },
          { id: 'polstelle-stet', title: 'Polstelle: $|f(x)|\\to\\infty$ für $x\\to a$',                                          dependsOn: ['stetigkeit'] },
          { id: 'zwischenwert',   title: 'Zwischenwertsatz: $f$ stetig auf $[a,b]$ nimmt jeden Wert $\\in[f(a),f(b)]$ an',       dependsOn: ['stetigkeit'] },
          { id: 'diff-impl-stet', title: 'Differenzierbar $\\Rightarrow$ stetig (Umkehrung falsch: $|x|$ bei 0)',                dependsOn: ['stetigkeit'] },
        ],
        subGoalConcepts: {
          0: ['stetigkeit'],
          1: ['hebbare-unst'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['stetigkeit'],                  qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['stetigkeit'],                  qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['stetigkeit'],                  qty: 1, note: 'Parameter so wählen, dass stetig' },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['stetigkeit'],                  qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['stetigkeit'],                  qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['hebbare-unst'],                qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['hebbare-unst'],                qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['hebbare-unst'],                qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['hebbare-unst'],                qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['hebbare-unst', 'stetigkeit'],  qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['sprungstelle'],                qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sprungstelle'],                qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['sprungstelle'],                qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sprungstelle'],                qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['sprungstelle', 'hebbare-unst'], qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['polstelle-stet'],              qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['polstelle-stet'],              qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['polstelle-stet'],              qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['polstelle-stet'],              qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['polstelle-stet', 'sprungstelle', 'hebbare-unst'], qty: 1, note: 'Klassifikation Unstetigkeiten' },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['zwischenwert'],                qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['zwischenwert'],                qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['zwischenwert'],                qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['zwischenwert'],                qty: 1, note: 'Stetigkeitsvoraussetzung vergessen' },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['zwischenwert'],                qty: 1, note: 'Nullstelle existiert' },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['diff-impl-stet'],              qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['diff-impl-stet'],              qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['diff-impl-stet'],              qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['diff-impl-stet'],              qty: 1, note: 'Umkehrung als wahr angenommen' },
          { subGoal: 5, stage: 'transfer',          type: 'matching',        uses: ['diff-impl-stet', 'stetigkeit'], qty: 1 },
        ],
      },
    }),
  ],
