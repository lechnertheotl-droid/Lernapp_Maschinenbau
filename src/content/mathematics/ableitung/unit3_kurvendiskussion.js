...
const lessons_abl_u3 = [
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'abl-1-1', concepts: ['vorzeichen-fprime', 'extr-notwendig'] },
        { lessonId: 'abl-1-5', concepts: ['hin-min-max', 'sattel-1-5'] },
        { lessonId: 'abl-1-2', concepts: ['polynom-abl'] },
      ],
      concepts: [
        { id: 'monotonie',     title: 'Monotonie: $f\'>0$ streng wachsend, $f\'<0$ streng fallend',                       dependsOn: [] },
        { id: 'extr-not',      title: 'Notwendig für lokales Extremum: $f\'(x_0)=0$',                                       dependsOn: [] },
        { id: 'extr-hin-f2',   title: 'Hinreichend via $f\'\'$: $f\'\'>0\\Rightarrow$ Min, $f\'\'<0\\Rightarrow$ Max',       dependsOn: ['extr-not'] },
        { id: 'extr-hin-vzw',  title: 'Hinreichend via VZW von $f\'$: $+\\to-$ Max, $-\\to+$ Min',                          dependsOn: ['monotonie', 'extr-not'] },
        { id: 'sattel-3-1',    title: 'Kein VZW von $f\'$ bei $f\'(x_0)=0$ → Sattelpunkt (z.B. $x^3$ bei 0)',               dependsOn: ['extr-hin-vzw'] },
      ],
      subGoalConcepts: {
        0: ['monotonie'],
        1: ['extr-not'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['monotonie'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['monotonie'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['monotonie'],                       qty: 1, note: 'Monotoniebereich angeben' },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['monotonie'],                       qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['monotonie'],                       qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['extr-not'],                        qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['extr-not'],                        qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['extr-not'],                        qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['extr-not'],                        qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['extr-not'],                        qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['extr-hin-f2'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['extr-hin-f2'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['extr-hin-f2', 'extr-not'],         qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['extr-hin-f2'],                     qty: 1, note: 'Vorzeichen Min/Max getauscht' },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['extr-hin-f2'],                     qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['extr-hin-vzw'],                    qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['extr-hin-vzw'],                    qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['extr-hin-vzw'],                    qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['extr-hin-vzw'],                    qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'sorting',         uses: ['extr-hin-vzw'],                    qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['sattel-3-1'],                      qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sattel-3-1'],                      qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['sattel-3-1'],                      qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sattel-3-1'],                      qty: 1, note: 'Sattel als Extremum' },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['sattel-3-1', 'extr-hin-vzw'],      qty: 1 },
      ],
    },
    steps: [
      {
...
- Kein Vorzeichenwechsel → **Sattelpunkt** (z.B. bei $f(x) = x^3$, Stelle $x = 0$)`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'abl-1-5', concepts: ['f2prime', 'wendepunkt'] },
        { lessonId: 'abl-3-1', concepts: ['extr-not'] },
      ],
      concepts: [
        { id: 'kruemmung',     title: 'Krümmung via $f\'\'$: $f\'\'>0$ linksgekrümmt $\\cup$, $f\'\'<0$ rechtsgekrümmt $\\cap$', dependsOn: [] },
        { id: 'wp-not',        title: 'Notwendig für Wendepunkt: $f\'\'(x_0)=0$',                                                 dependsOn: [] },
        { id: 'wp-hin',        title: 'Hinreichend: $f\'\'\'(x_0)\\neq 0$ ODER $f\'\'$ wechselt VZ',                              dependsOn: ['wp-not'] },
        { id: 'sattel-wp',     title: 'Sattelpunkt = Wendepunkt mit $f\'(x_0)=0$',                                                dependsOn: ['wp-not'] },
        { id: 'wp-koords',     title: 'Wendepunkt-Koordinaten: $(x_0,f(x_0))$ — y-Wert nicht vergessen!',                          dependsOn: ['wp-hin'] },
      ],
      subGoalConcepts: {
        0: ['kruemmung'],
        1: ['wp-not'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['kruemmung'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kruemmung'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['kruemmung'],                       qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kruemmung'],                       qty: 1, note: 'links/rechts vertauscht' },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['kruemmung'],                       qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['wp-not'],                          qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wp-not'],                          qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['wp-not'],                          qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wp-not'],                          qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['wp-not'],                          qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['wp-hin'],                          qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wp-hin'],                          qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['wp-hin', 'wp-not'],                qty: 1, note: '$x^4$ bei 0 — kein WP' },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wp-hin'],                          qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'sorting',         uses: ['wp-hin', 'wp-not'],                qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['sattel-wp'],                       qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sattel-wp'],                       qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['sattel-wp'],                       qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sattel-wp'],                       qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['sattel-wp', 'wp-hin'],             qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['wp-koords'],                       qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wp-koords'],                       qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['wp-koords'],                       qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wp-koords'],                       qty: 1, note: 'y-Wert vergessen' },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['wp-koords'],                       qty: 1 },
      ],
    },
    steps: [
      {
...
→ Wendepunkt UND waagerechte Tangente = **Sattelpunkt**.`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'abl-3-1', concepts: ['monotonie', 'extr-not', 'extr-hin-f2'] },
        { lessonId: 'abl-3-2', concepts: ['kruemmung', 'wp-not', 'wp-hin'] },
        { lessonId: 'abl-1-2', concepts: ['polynom-abl'] },
      ],
      concepts: [
        { id: 'kd-rezept',     title: 'Reihenfolge: $D_f$ → Symmetrie → Nullstellen → $f\',f\'\'$ → Extrema → WP → $x\\to\\pm\\infty$ → Graph', dependsOn: [] },
        { id: 'symmetrie',     title: 'Symmetrie: $f(-x)=f(x)$ gerade (y-Achse); $f(-x)=-f(x)$ ungerade (Ursprung)',                          dependsOn: [] },
        { id: 'verhalten-inf', title: 'Verhalten im Unendlichen: Polynom führender Term; Bruch Grad-Vergleich',                                  dependsOn: [] },
        { id: 'polstelle',     title: 'Polstellen & Asymptoten bei gebrochen-rationalen Funktionen separat',                                     dependsOn: ['verhalten-inf'] },
        { id: 'graph-skizze',  title: 'Skizze: Extrema, WP, Achsenschnittpunkte mit Koordinaten beschriften',                                    dependsOn: ['kd-rezept'] },
      ],
      subGoalConcepts: {
        0: ['kd-rezept'],
        1: ['symmetrie'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['kd-rezept'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kd-rezept'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'sorting',         uses: ['kd-rezept'],                       qty: 1, note: 'Schritte sortieren' },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kd-rezept'],                       qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['kd-rezept'],                       qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['symmetrie'],                       qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['symmetrie'],                       qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['symmetrie'],                       qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['symmetrie'],                       qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['symmetrie'],                       qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['verhalten-inf'],                   qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['verhalten-inf'],                   qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['verhalten-inf'],                   qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['verhalten-inf'],                   qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['verhalten-inf'],                   qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['polstelle'],                       qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['polstelle'],                       qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['polstelle'],                       qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['polstelle'],                       qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['polstelle', 'verhalten-inf'],      qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['graph-skizze'],                    qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['graph-skizze'],                    qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['graph-skizze'],                    qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['graph-skizze'],                    qty: 1, note: 'Koordinaten unbeschriftet' },
        { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['graph-skizze', 'kd-rezept'],       qty: 1 },
      ],
    },
    steps: [
      {
...
**7. Verhalten:** $x \\to +\\infty: f \\to +\\infty$; $x \\to -\\infty: f \\to -\\infty$`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'abl-3-3', concepts: ['kd-rezept', 'symmetrie', 'verhalten-inf', 'polstelle', 'graph-skizze'] },
        { lessonId: 'abl-3-1', concepts: ['extr-not', 'extr-hin-f2'] },
        { lessonId: 'abl-3-2', concepts: ['wp-not', 'wp-hin'] },
        { lessonId: 'abl-2-3', concepts: ['kr-formel-fest'] },
      ],
      concepts: [
        { id: 'klausur-typen',  title: 'Typische Klausurfunktionen: Polynom, $p(x)/q(x)$, $x\\cdot e^{-x}$, $e^{-x^2}$',         dependsOn: [] },
        { id: 'plausi-grad',    title: 'Polynom Grad $n$ → höchstens $n-1$ Extrema',                                              dependsOn: [] },
        { id: 'global-intervall', title: 'Globale Extrema auf $[a,b]$: innere Kandidaten + Randwerte $f(a),f(b)$',                  dependsOn: [] },
        { id: 'optimierung',    title: 'Optimierung: Zielfunktion + Nebenbedingung → eine Variable → ableiten',                   dependsOn: [] },
        { id: 'taylor-2',       title: 'Taylorpolynom $T_n(x)$ als schnelle lokale Kurvendiskussion 2. Ordnung',                  dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['klausur-typen'],
        1: ['plausi-grad'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['klausur-typen'],                   qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['klausur-typen'],                   qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['klausur-typen'],                   qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['klausur-typen'],                   qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['klausur-typen'],                   qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['plausi-grad'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['plausi-grad'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['plausi-grad'],                     qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['plausi-grad'],                     qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['plausi-grad'],                     qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['global-intervall'],                qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['global-intervall'],                qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['global-intervall'],                qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['global-intervall'],                qty: 1, note: 'Rand vergessen' },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['global-intervall'],                qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['optimierung'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['optimierung'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['optimierung'],                     qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['optimierung'],                     qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'sorting',         uses: ['optimierung'],                     qty: 1, note: 'Lösungsweg ordnen' },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['taylor-2'],                        qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['taylor-2'],                        qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['taylor-2'],                        qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['taylor-2'],                        qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['taylor-2'],                        qty: 1 },
      ],
    },
    steps: [
      {
