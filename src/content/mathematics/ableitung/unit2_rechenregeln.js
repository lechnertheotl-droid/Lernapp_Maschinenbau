...
const lessons_abl_u2 = [
  {
    ...
    subGoals: [
      { label: 'Formel: $(f \\cdot g)\' = f\' g + f g\'$ (zwei Summanden, kreuzweise)', examRelevance: 'hoch' },
      { label: 'Klassischer Fehler: $(fg)\' \\neq f\' g\'$ (nicht faktorweise ableiten!)', examRelevance: 'hoch' },
      { label: 'Geometrische Motivation: Flächenänderung eines Rechtecks mit variablen Seiten', examRelevance: 'niedrig' },
      { label: 'Dreifaches Produkt: $(fgh)\' = f\'gh + fg\'h + fgh\'$ (analog, drei Summanden)', examRelevance: 'mittel' },
      { label: 'Nach dem Ableiten ausklammern und vereinfachen — Prüfer erwartet gekürzte Form', examRelevance: 'mittel' },
    ],
    prerequisites: [],
    ...
    blueprint: {
      ...
      concepts: [
        { id: 'pr-formel',     title: 'Produktregel $(f\\cdot g)\'=f\'g+fg\'$ — zwei Summanden, kreuzweise',                  dependsOn: [] },
        { id: 'pr-falle',      title: 'Klassischer Fehler: $(fg)\'\\neq f\'g\'$ — nicht faktorweise ableiten!',                dependsOn: ['pr-formel'] },
        { id: 'pr-geometrie',  title: 'Rechteck-Bild: Flächenänderung mit zwei variablen Seiten',                              dependsOn: [] },
        { id: 'pr-dreifach',   title: 'Dreifach: $(fgh)\'=f\'gh+fg\'h+fgh\'$',                                                  dependsOn: ['pr-formel'] },
        { id: 'pr-vereinfachen', title: 'Nach dem Ableiten ausklammern und vereinfachen',                                       dependsOn: ['pr-formel'] },
      ],
      subGoalConcepts: {
        0: ['pr-formel'],
        1: ['pr-falle'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['pr-formel'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-formel'],                       qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['pr-formel'],                       qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-formel'],                       qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['pr-formel'],                       qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['pr-falle'],                        qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-falle', 'pr-formel'],           qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['pr-falle'],                        qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-falle'],                        qty: 1, note: 'Faktor-für-Faktor abgeleitet' },
        { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['pr-falle', 'pr-formel'],           qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['pr-geometrie'],                    qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-geometrie'],                    qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['pr-geometrie'],                    qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-geometrie'],                    qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['pr-geometrie', 'pr-formel'],       qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['pr-dreifach'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-dreifach'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['pr-dreifach'],                     qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-dreifach'],                     qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['pr-dreifach', 'pr-formel'],        qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['pr-vereinfachen'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-vereinfachen', 'pr-formel'],    qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['pr-vereinfachen'],                 qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-vereinfachen'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['pr-vereinfachen', 'pr-formel'],    qty: 1, note: 'Schritte ordnen' },
      ],
    },
    steps: [
      {
...
**Tipp — Klausur-Form:** Nach der Produktregel immer (1) gemeinsamen Faktor ausklammern, (2) Brüche kürzen ($x^n \\cdot \\tfrac{1}{x} = x^{n-1}$), (3) im Inneren zusammenfassen. Die rohe Summe $f'g + fg'$ verliert oft Punkte.`,
  ...
  },
  {
    ...
    subGoals: [
      { label: 'Formel: $(f/g)\' = (f\' g - f g\')/g^2$ — Minuszeichen, Reihenfolge $f\' g$ zuerst', examRelevance: 'hoch' },
      { label: 'NAZ-Eselsbrücke: "**N**enner·**A**bl. **Z**ähler minus **Z**ähler·**A**bl. **N**enner, durch $N^2$"', examRelevance: 'mittel' },
      { label: 'Nenner niemals ableiten ohne Vorzeichen: $f\' g - f g\'$ (NICHT $f g\' - f\' g$)', examRelevance: 'hoch' },
      { label: 'Alternative: $f/g = f \\cdot g^{-1}$ mit Produkt- und Kettenregel ableiten', examRelevance: 'mittel' },
      { label: 'Definitionsbereich: $g(x) \\neq 0$ (Polstellen gesondert betrachten)', examRelevance: 'mittel' },
    ],
    prerequisites: [],
    nextLessonId: 'abl-2-3',
    blueprint: {
      prerequisites: [
        { lessonId: 'abl-2-1', concepts: ['pr-formel'] },
        { lessonId: 'abl-1-3', concepts: ['abl-sin', 'abl-cos', 'abl-exp', 'abl-ln'] },
      ],
      concepts: [
        { id: 'qr-formel',     title: 'Quotientenregel $(f/g)\'=(f\'g-fg\')/g^2$',                                            dependsOn: [] },
        { id: 'qr-naz',        title: 'NAZ-Eselsbrücke: Nenner·Abl.Zähler − Zähler·Abl.Nenner, durch $N^2$',                  dependsOn: ['qr-formel'] },
        { id: 'qr-vorzeichen', title: 'Reihenfolge im Zähler: $f\'g$ ZUERST, dann minus $fg\'$',                               dependsOn: ['qr-formel'] },
        { id: 'qr-via-pr',     title: 'Alternative: $f/g=f\\cdot g^{-1}$ mit Produkt+Kettenregel ableiten',                   dependsOn: ['qr-formel'] },
        { id: 'qr-defbereich', title: 'Definitionsbereich $g(x)\\neq 0$ — Polstellen separat',                                dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['qr-formel'],
        1: ['qr-naz'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['qr-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['qr-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['qr-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['qr-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['qr-formel'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['qr-naz'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['qr-naz'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['qr-naz'],                     qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['qr-naz'],                     qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['qr-naz', 'qr-formel'],        qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['qr-vorzeichen'],              qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['qr-vorzeichen'],              qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['qr-vorzeichen', 'qr-formel'], qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['qr-vorzeichen'],              qty: 1, note: 'Reihenfolge $fg\'-f\'g$' },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['qr-vorzeichen'],              qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['qr-via-pr'],                  qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['qr-via-pr'],                  qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['qr-via-pr'],                  qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['qr-via-pr'],                  qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'sorting',         uses: ['qr-via-pr', 'qr-formel'],     qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['qr-defbereich'],              qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['qr-defbereich'],              qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['qr-defbereich'],              qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['qr-defbereich'],              qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['qr-defbereich', 'qr-formel'], qty: 1 },
      ],
    },
    steps: [
      {
...
**Tipp:** Nach der Quotientenregel im Zähler ausmultiplizieren, gemeinsame Faktoren kürzen — Prüfer erwarten die einfachste Form.`,
  ...
  },
  {
    ...
    subGoals: [
      { label: 'Formel: $[f(g(x))]\' = f\'(g(x)) \\cdot g\'(x)$ — äußere mal innere Ableitung', examRelevance: 'hoch' },
      { label: 'Innere Funktion in äußerer Ableitung unverändert eingesetzt lassen', examRelevance: 'hoch' },
      { label: 'Mehrfachverkettung: Ableitungen von außen nach innen multiplizieren', examRelevance: 'hoch' },
      { label: 'Häufigste Anwendung: $(ax+b)^n$, $e^{ax}$, $\\sin(ax)$ — innere Ableitung $= a$', examRelevance: 'hoch' },
      { label: 'Häufiger Fehler: innere Ableitung vergessen (z.B. $(\\sin 2x)\' = 2\\cos 2x$, nicht $\\cos 2x$)', examRelevance: 'hoch' },
    ],
    prerequisites: [],
    nextLessonId: 'abl-2-4',
    blueprint: {
      prerequisites: [
        { lessonId: 'abl-1-4', concepts: ['kettenregel', 'aussere-finden', 'std-exp-u', 'std-sin-u', 'std-ln-u', 'mehrfach-kette'] },
        { lessonId: 'abl-1-3', concepts: ['abl-sin', 'abl-cos', 'abl-exp', 'abl-ln'] },
      ],
      concepts: [
        { id: 'kr-formel-fest',  title: 'Kettenregel-Formel: $[f(g(x))]\'=f\'(g(x))\\cdot g\'(x)$ — äußere mal innere Abl.',     dependsOn: [] },
        { id: 'kr-eingesetzt',   title: 'Innere bleibt in äußerer Ableitung eingesetzt — nicht selbst ableiten',                 dependsOn: ['kr-formel-fest'] },
        { id: 'kr-mehrfach',     title: 'Mehrfachverkettung: von außen nach innen multiplizieren',                                dependsOn: ['kr-formel-fest'] },
        { id: 'kr-linear-innen', title: 'Standard $(ax+b)^n,\\;e^{ax},\\;\\sin(ax)$: innere Ableitung $=a$',                       dependsOn: ['kr-formel-fest'] },
        { id: 'kr-falle-innen',  title: 'Häufiger Fehler: innere Ableitung vergessen ($(\\sin 2x)\'=2\\cos 2x$, nicht $\\cos 2x$)', dependsOn: ['kr-formel-fest'] },
      ],
      subGoalConcepts: {
        0: ['kr-formel-fest'],
        1: ['kr-eingesetzt'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['kr-formel-fest'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kr-formel-fest'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['kr-formel-fest'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kr-formel-fest'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['kr-formel-fest'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['kr-eingesetzt'],                   qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kr-eingesetzt'],                   qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['kr-eingesetzt'],                   qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kr-eingesetzt'],                   qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['kr-eingesetzt'],                   qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['kr-mehrfach'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kr-mehrfach'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['kr-mehrfach'],                     qty: 1, note: 'Doppelkette' },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kr-mehrfach'],                     qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'sorting',         uses: ['kr-mehrfach'],                     qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['kr-linear-innen'],                 qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kr-linear-innen'],                 qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['kr-linear-innen'],                 qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kr-linear-innen'],                 qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['kr-linear-innen'],                 qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['kr-falle-innen'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kr-falle-innen'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['kr-falle-innen'],                  qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kr-falle-innen'],                  qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['kr-falle-innen'],                  qty: 1 },
      ],
    },
    steps: [
      {
...
**Beispiel 3 (drei Schichten):** $h(x) = e^{\\sin(2x)}$ — Äußerste $(e^{u})' = e^{u}$, Mittlere $(\\sin v)' = \\cos v$, Innerste $(2x)' = 2$. $h'(x) = e^{\\sin(2x)} \\cdot \\cos(2x) \\cdot 2 = 2\\cos(2x)\\,e^{\\sin(2x)}$.`,
  ...
  },
  {
    ...
    subGoals: [
      { label: 'Äußerste Struktur identifizieren: Produkt, Quotient oder Verkettung?', examRelevance: 'hoch' },
      { label: 'Hierarchisch ableiten: erst äußerste Regel, dann innere Teile mit passender Regel', examRelevance: 'hoch' },
      { label: 'Logarithmisches Ableiten bei $f(x)^{g(x)}$: $\\ln y = g \\ln f$, dann implizit differenzieren', examRelevance: 'mittel' },
      { label: 'Umformen vor dem Ableiten: $\\sqrt[n]{x}$ → $x^{1/n}$, $1/x^n$ → $x^{-n}$', examRelevance: 'hoch' },
      { label: 'Ergebnisse faktorisieren — Prüfer erwarten vereinfachte Antwort', examRelevance: 'mittel' },
    ],
    prerequisites: [],
    nextLessonId: null,
    blueprint: {
      prerequisites: [
        { lessonId: 'abl-1-2', concepts: ['pot-regel', 'pot-negativ', 'pot-gebrochen'] },
        { lessonId: 'abl-2-1', concepts: ['pr-formel', 'pr-vereinfachen'] },
        { lessonId: 'abl-2-2', concepts: ['qr-formel'] },
        { lessonId: 'abl-2-3', concepts: ['kr-formel-fest', 'kr-mehrfach'] },
      ],
      concepts: [
        { id: 'gemischt-strukt',   title: 'Äußerste Struktur identifizieren: Produkt, Quotient oder Verkettung?',                  dependsOn: [] },
        { id: 'gemischt-hierar',   title: 'Hierarchisch: erst äußerste Regel, dann innere Teile mit passender Regel',             dependsOn: ['gemischt-strukt'] },
        { id: 'log-ableiten',      title: 'Logarithmisches Ableiten bei $f^g$: $\\ln y=g\\ln f$, dann implizit',                   dependsOn: [] },
        { id: 'umformen-erst',     title: 'Vor dem Ableiten umformen: $\\sqrt[n]{x}\\to x^{1/n}$, $1/x^n\\to x^{-n}$',            dependsOn: [] },
        { id: 'gemischt-vereinf',  title: 'Ergebnis faktorisieren und vereinfachen — Klausurpunkte',                                dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['gemischt-strukt'],
        1: ['gemischt-hierar'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['gemischt-strukt'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gemischt-strukt'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['gemischt-strukt'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gemischt-strukt'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['gemischt-strukt'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['gemischt-hierar'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gemischt-hierar'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['gemischt-hierar'],                  qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gemischt-hierar'],                  qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'sorting',         uses: ['gemischt-hierar', 'gemischt-strukt'], qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['log-ableiten'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['log-ableiten'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['log-ableiten'],                     qty: 1, note: '$x^x$' },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['log-ableiten'],                     qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'sorting',         uses: ['log-ableiten'],                     qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['umformen-erst'],                    qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['umformen-erst'],                    qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['umformen-erst'],                    qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['umformen-erst'],                    qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['umformen-erst'],                    qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['gemischt-vereinf'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gemischt-vereinf'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['gemischt-vereinf'],                 qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gemischt-vereinf'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['gemischt-vereinf'],                 qty: 1 },
      ],
    },
    steps: [
      {
