...
**Typischer Fehler:** $0°$ wählen — dort ist $\\cos(0°) = 1$, nicht $0$.`,
  ...
  'ex-trig-3-5-a': {
    ...
    correctIndex: 0,
    explanation: `**Ansatz:** Im **allgemeinen Dreieck** (nicht nur rechtwinklig) gilt: Das Verhältnis Seite zu Sinus des gegenüberliegenden Winkels ist konstant. Wann anwenden? Wenn du **zwei Winkel und eine Seite** kennst (WWS/SWW), oder **zwei Seiten und einen nicht-eingeschlossenen Winkel** (SSW).

**Rechnung:** Der Sinussatz lautet $\\dfrac{a}{\\sin\\alpha} = \\dfrac{b}{\\sin\\beta} = \\dfrac{c}{\\sin\\gamma} = 2R$ (wobei $R$ der Umkreisradius ist). Option A setzt genau dieses Seite-durch-Sinus-Verhältnis korrekt um.
