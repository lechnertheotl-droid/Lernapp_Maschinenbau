...
Die Koordinaten von P sind dann genau **(cos(α), sin(α))** — das ist die allgemeine Definition.`,
      },
      {
        ...
        params: { showSine: true, showCosine: true, interactive: true, showLabels: true, initialAngle: 45 },
      },
...
Diese Definition gilt für **alle reellen Winkel** — nicht nur 0°–90°.`,
      },
      {
        ...
        visualizationId: 'unit-circle',
        params: { showSine: true, showCosine: true, interactive: true, showCoordinates: true, initialAngle: 60 },
      },
...
**Vorgehen:** 1. Quadrant bestimmen 2. Referenzwinkel = Abstand zur nächsten Achse 3. Vorzeichen aus Tabelle`,
      },
      {
        ...
        visualizationId: 'unit-circle',
        params: { showSine: true, showCosine: true, interactive: true, showQuadrants: true, showLabels: true, initialAngle: 210 },
      },
