...
const lessons_vek_u3 = [
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'vek-1-2', concepts: ['sp-komp', 'sp-skalar', 'sp-orthogonal', 'sp-winkel-formel', 'sp-arbeit', 'sp-regeln'] },
        { lessonId: 'vek-1-3', concepts: ['kp-vektor', 'kp-komp', 'kp-betrag', 'kp-antikomm', 'kp-parallel', 'kp-vs-sp'] },
      ],
      concepts: [
        { id: 'p-werkzeugwahl', title: 'Werkzeugwahl: Winkel/Senkrecht/Arbeit → Skalarprodukt; Fläche/Drehmoment/Normale → Kreuzprodukt', dependsOn: [] },
        { id: 'p-winkel-rueck', title: 'Winkel rückwärts: $\\varphi=\\arccos((\\vec a\\cdot\\vec b)/(|\\vec a||\\vec b|))$',                  dependsOn: [] },
        { id: 'p-orth-test',    title: 'Orthogonal: $\\vec a\\cdot\\vec b=0$; Parallel: $\\vec a\\times\\vec b=\\vec 0$',                  dependsOn: [] },
        { id: 'p-sp-kommut',    title: 'Skalarprodukt kommutativ',                                                                            dependsOn: [] },
        { id: 'p-kp-antikomm',  title: 'Kreuzprodukt antikommutativ ($\\vec a\\times\\vec b=-(\\vec b\\times\\vec a)$)',                       dependsOn: [] },
        { id: 'p-arbeit',       title: 'Arbeit $W=\\vec F\\cdot\\vec s$ — Skalar',                                                            dependsOn: [] },
        { id: 'p-drehmoment',   title: 'Drehmoment $\\vec M=\\vec r\\times\\vec F$ — Vektor',                                                  dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['p-werkzeugwahl'],
        1: ['p-winkel-rueck'],
        ...
        3: ['p-sp-kommut'],
        4: ['p-kp-antikomm'],
        5: ['p-arbeit', 'p-drehmoment'],
      },
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['p-werkzeugwahl'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-werkzeugwahl'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['p-werkzeugwahl'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-werkzeugwahl'],                  qty: 1, note: 'Zahl ↔ Vektor verwechselt' },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['p-werkzeugwahl'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['p-winkel-rueck'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-winkel-rueck'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['p-winkel-rueck'],                  qty: 1, note: 'Winkel in Grad' },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-winkel-rueck'],                  qty: 1, note: 'Vorzeichen → stumpfer Winkel' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['p-winkel-rueck'],                  qty: 1, note: '[PRÜFUNG] 3D' },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['p-orth-test'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-orth-test'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['p-orth-test'],                     qty: 1, note: 'Parameter so wählen, dass orthogonal' },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-orth-test'],                     qty: 1, note: 'Orthogonal- mit Parallelitätstest verwechselt' },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['p-orth-test'],                     qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['p-sp-kommut'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-sp-kommut'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['p-sp-kommut'],                     qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-sp-kommut'],                     qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['p-sp-kommut', 'p-kp-antikomm'],    qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['p-kp-antikomm'],                   qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-kp-antikomm'],                   qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['p-kp-antikomm'],                   qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-kp-antikomm'],                   qty: 1, note: '$\\vec a\\times\\vec a=\\vec 0$ vergessen' },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['p-kp-antikomm', 'p-sp-kommut'],    qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['p-arbeit', 'p-drehmoment'],        qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-arbeit', 'p-drehmoment'],        qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['p-arbeit'],                        qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-arbeit', 'p-drehmoment'],        qty: 1, note: 'Skalar/Vektor verwechselt' },
        { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['p-drehmoment'],                    qty: 1, note: '[PRÜFUNG]' },
      ],
    },
    steps: [
      {
...
3. Orthogonalitätstest: $(\\vec{a} \\times \\vec{b}) \\cdot \\vec{a} = 0$?`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'vek-1-2', concepts: ['sp-komp'] },
        { lessonId: 'vek-1-3', concepts: ['kp-komp', 'kp-betrag'] },
      ],
      concepts: [
        { id: 'flaeche-parallelogramm', title: 'Parallelogrammfläche $A=|\\vec a\\times\\vec b|$',                   dependsOn: [] },
        { id: 'flaeche-dreieck',        title: 'Dreiecksfläche $A=\\tfrac12|\\vec a\\times\\vec b|$',                  dependsOn: ['flaeche-parallelogramm'] },
        { id: 'spatprodukt',            title: 'Spatprodukt $[\\vec a,\\vec b,\\vec c]=\\vec a\\cdot(\\vec b\\times\\vec c)$', dependsOn: [] },
        { id: 'volumen-spat',           title: 'Spatvolumen $V=|\\vec a\\cdot(\\vec b\\times\\vec c)|$',                 dependsOn: ['spatprodukt'] },
        { id: 'volumen-tetraeder',      title: 'Tetraedervolumen $V=\\tfrac16|\\vec a\\cdot(\\vec b\\times\\vec c)|$',     dependsOn: ['volumen-spat'] },
        { id: 'komplanar',              title: 'Spatprodukt $=0\\iff$ Vektoren komplanar (kein Volumen)',                  dependsOn: ['spatprodukt'] },
        { id: 'rechts-links-system',    title: 'Vorzeichen Spatprodukt: $>0$ Rechtssystem, $<0$ Linkssystem',              dependsOn: ['spatprodukt'] },
      ],
      subGoalConcepts: {
        0: ['flaeche-parallelogramm'],
        1: ['flaeche-dreieck'],
        2: ['spatprodukt', 'volumen-spat'],
        3: ['volumen-tetraeder'],
        4: ['komplanar'],
        5: ['rechts-links-system'],
      },
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-parallelogramm'],          qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-parallelogramm'],          qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['flaeche-parallelogramm'],          qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-parallelogramm'],          qty: 1, note: 'sin/cos Verwechslung' },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-parallelogramm'],          qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-dreieck'],                 qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-dreieck'],                 qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['flaeche-dreieck'],                 qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-dreieck'],                 qty: 1, note: 'Faktor $\\tfrac12$ vergessen' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-dreieck'],                 qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['spatprodukt', 'volumen-spat'],     qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['volumen-spat'],                    qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['volumen-spat'],                    qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['volumen-spat'],                    qty: 1, note: 'Betrag vergessen' },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['volumen-spat'],                    qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['volumen-tetraeder'],               qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['volumen-tetraeder'],               qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['volumen-tetraeder'],               qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['volumen-tetraeder'],               qty: 1, note: 'Faktor $\\tfrac16$ vergessen' },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['volumen-tetraeder'],               qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['komplanar'],                       qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['komplanar'],                       qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['komplanar', 'spatprodukt'],        qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['komplanar'],                       qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['komplanar', 'spatprodukt'],        qty: 1, note: 'Parameter so wählen, dass komplanar' },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['rechts-links-system'],             qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rechts-links-system'],             qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['rechts-links-system'],             qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rechts-links-system'],             qty: 1, note: 'Betragszeichen verfälscht Vorzeicheninfo' },
        { subGoal: 5, stage: 'transfer',          type: 'matching',        uses: ['rechts-links-system', 'spatprodukt'], qty: 1 },
      ],
    },
    steps: [
      {
...
**Prüfungs-Check:** Einheiten stimmen (Fläche $\\to$ $\\text{m}^{2}$, Volumen $\\to$ $\\text{m}^{3}$)? Betrag genommen (positiv)?`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'vek-1-3', concepts: ['kp-komp', 'kp-betrag', 'kp-rh-regel'] },
        { lessonId: 'vek-1-4', concepts: ['kraft-zerlegung', 'gleichgewicht', 'resultierende'] },
      ],
      concepts: [
        { id: 'schiefe-zerleg', title: 'Schiefe Ebene: $F_H=G\\sin\\alpha$, $F_N=G\\cos\\alpha$',                                  dependsOn: [] },
        { id: 'm-formel',       title: 'Drehmoment $\\vec M=\\vec r\\times\\vec F$',                                                dependsOn: [] },
        { id: 'm-betrag',       title: 'Betrag $|\\vec M|=rF\\sin\\alpha$, max. bei $\\alpha=90°$',                                  dependsOn: ['m-formel'] },
        { id: 'm-richtung',     title: 'Richtung von $\\vec M$ via Rechte-Hand-Regel',                                              dependsOn: ['m-formel'] },
        { id: 'einheiten',      title: 'Einheiten: Kraft N, Hebel m, Moment Nm, Arbeit J=Nm',                                       dependsOn: [] },
        { id: 'gg-vollstaendig', title: 'Vollständiges Gleichgewicht: $\\sum\\vec F=\\vec 0$ UND $\\sum\\vec M=\\vec 0$',           dependsOn: ['m-formel'] },
      ],
      subGoalConcepts: {
        0: ['schiefe-zerleg'],
        1: ['m-formel', 'm-betrag'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['schiefe-zerleg'],          qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['schiefe-zerleg'],          qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['schiefe-zerleg'],          qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['schiefe-zerleg'],          qty: 1, note: 'sin/cos Verwechslung Hangabtrieb/Normal' },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['schiefe-zerleg'],          qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['m-formel', 'm-betrag'],    qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['m-formel'],                qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['m-betrag'],                qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['m-betrag'],                qty: 1, note: 'cos statt sin → bei α=90° null statt max' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['m-formel', 'm-betrag'],    qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['m-richtung'],              qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['m-richtung'],              qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['m-richtung'],              qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['m-richtung'],              qty: 1, note: 'Linke statt Rechte Hand benutzt' },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['m-richtung', 'm-formel'],  qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['einheiten'],               qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['einheiten'],               qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['einheiten'],               qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['einheiten'],               qty: 1, note: 'kg vs. N (Masse vs. Gewicht)' },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['einheiten'],               qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['gg-vollstaendig'],         qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gg-vollstaendig'],         qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['gg-vollstaendig', 'm-betrag'], qty: 1, note: 'Hebelgesetz' },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gg-vollstaendig'],         qty: 1, note: 'Nur Kräfte, Momente vergessen' },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['gg-vollstaendig', 'm-betrag'], qty: 1, note: '[PRÜFUNG]' },
      ],
    },
    steps: [
      {
