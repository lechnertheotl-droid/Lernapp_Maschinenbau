  ...
  lessons: [
    makeLesson({
      ...
      blueprint: {
        prerequisites: [],
        concepts: [
          { id: 'folge-grenzwert',  title: 'Grenzwert $\\lim_{n\\to\\infty} a_n$ — schließlich in jedem $\\varepsilon$-Schlauch',  dependsOn: [] },
          { id: 'rationale-folgen', title: 'Rationale Folgen: Grad-Vergleich (Zähler/Nenner) bestimmt Grenzwert',                  dependsOn: ['folge-grenzwert'] },
          { id: 'gw-saetze',        title: 'Grenzwertsätze: Summe, Produkt, Quotient (Nenner $\\neq 0$)',                           dependsOn: ['folge-grenzwert'] },
          { id: 'monoton-besch',    title: 'Monoton + beschränkt $\\Rightarrow$ konvergent',                                        dependsOn: ['folge-grenzwert'] },
          { id: 'nullfolgen',       title: 'Bausteine: $1/n,\\,1/n^k,\\,q^n$ mit $|q|<1$ als Nullfolgen',                            dependsOn: ['folge-grenzwert'] },
        ],
        subGoalConcepts: {
          0: ['folge-grenzwert'],
          1: ['rationale-folgen'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['folge-grenzwert'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['folge-grenzwert'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['folge-grenzwert'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['folge-grenzwert'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['folge-grenzwert'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['rationale-folgen'],         qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rationale-folgen'],         qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['rationale-folgen'],         qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rationale-folgen'],         qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['rationale-folgen'],         qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['gw-saetze'],                qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gw-saetze'],                qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['gw-saetze'],                qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gw-saetze'],                qty: 1, note: 'Quotient mit Nenner-Grenzwert 0' },
          { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['gw-saetze'],                qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['monoton-besch'],            qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['monoton-besch'],            qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['monoton-besch'],            qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['monoton-besch'],            qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['monoton-besch'],            qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['nullfolgen'],               qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['nullfolgen'],               qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['nullfolgen'],               qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['nullfolgen'],               qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'matching',        uses: ['nullfolgen'],               qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'rf-1-1', concepts: ['folge-grenzwert', 'gw-saetze'] },
        ],
        concepts: [
          { id: 'taylor-formel-rf', title: 'Taylor: $T_n(x)=\\sum_{k=0}^n f^{(k)}(x_0)/k!\\cdot(x-x_0)^k$',                       dependsOn: [] },
          { id: 'maclaurin-std',    title: 'Maclaurin auswendig: $e^x,\\sin,\\cos,\\ln(1+x),1/(1-x)$',                              dependsOn: ['taylor-formel-rf'] },
          { id: 'lagrange-rest',    title: 'Lagrange-Restglied $R_n=f^{(n+1)}(\\xi)/(n+1)!\\cdot(x-x_0)^{n+1}$',                    dependsOn: ['taylor-formel-rf'] },
          { id: 'paritaet-pot',     title: 'Cos: nur gerade Potenzen; Sin: nur ungerade',                                          dependsOn: ['maclaurin-std'] },
        ],
        subGoalConcepts: {
          0: ['taylor-formel-rf'],
          1: ['maclaurin-std'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['taylor-formel-rf'],         qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['taylor-formel-rf'],         qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['taylor-formel-rf'],         qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['taylor-formel-rf'],         qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['taylor-formel-rf'],         qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['maclaurin-std'],            qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['maclaurin-std'],            qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['maclaurin-std'],            qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['maclaurin-std'],            qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['maclaurin-std'],            qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['lagrange-rest'],            qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lagrange-rest'],            qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['lagrange-rest'],            qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lagrange-rest'],            qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['lagrange-rest'],            qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['paritaet-pot'],             qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['paritaet-pot'],             qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['paritaet-pot'],             qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['paritaet-pot'],             qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['paritaet-pot'],             qty: 1 },
        ],
      },
    }),
  ],
...
const unit2 = makeUnit({
  ...
  lessons: [
    makeLesson({
      ...
      subGoals: [
        { label: 'Taylor: $f(x) = \\sum f^{(n)}(x_0)(x-x_0)^n/n!$', examRelevance: 'hoch' },
        { label: 'Standardreihen: $e^x, \\sin x, \\cos x, \\ln(1+x), 1/(1-x)$ auswendig', examRelevance: 'hoch' },
        { label: 'Geometrische Reihe: $\\sum q^n = 1/(1-q)$ für $|q| < 1$', examRelevance: 'hoch' },
        { label: 'Restglied Lagrange: $R_n = f^{(n+1)}(\\xi)(x-x_0)^{n+1}/(n+1)!$', examRelevance: 'hoch' },
        { label: 'Konvergenzradius $R$: via Quotienten- oder Wurzelkriterium bestimmen', examRelevance: 'hoch' },
        { label: 'Anwendung: Approximation, Grenzwerte mit Taylor (Alternative zu L\'Hôpital)', examRelevance: 'mittel' },
      ],
      createdAt: '2026-04-14',
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'rf-1-2', concepts: ['taylor-formel-rf', 'maclaurin-std', 'lagrange-rest'] },
        ],
        concepts: [
          { id: 'taylor-pr',     title: 'Taylor: $f(x)=\\sum f^{(n)}(x_0)(x-x_0)^n/n!$',                                          dependsOn: [] },
          { id: 'standard-reihen', title: 'Standardreihen: $e^x,\\sin x,\\cos x,\\ln(1+x),1/(1-x)$',                                dependsOn: [] },
          { id: 'geom-reihe',    title: 'Geometrische Reihe: $\\sum q^n=1/(1-q)$ für $|q|<1$',                                    dependsOn: [] },
          { id: 'rest-pr',       title: 'Restglied Lagrange (Klausurformel)',                                                       dependsOn: ['taylor-pr'] },
          { id: 'konv-radius-pr', title: 'Konvergenzradius via Quotienten- oder Wurzelkriterium',                                    dependsOn: [] },
          { id: 'taylor-anwend', title: 'Anwendung: Approximation, Grenzwerte mit Taylor (Alternative zu L\'Hôpital)',                 dependsOn: ['taylor-pr'] },
        ],
        subGoalConcepts: {
          0: ['taylor-pr'],
          1: ['standard-reihen'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['taylor-pr'],                qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['taylor-pr'],                qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['taylor-pr'],                qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['taylor-pr'],                qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['taylor-pr'],                qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['standard-reihen'],          qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['standard-reihen'],          qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['standard-reihen'],          qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['standard-reihen'],          qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['standard-reihen'],          qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['geom-reihe'],               qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['geom-reihe'],               qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['geom-reihe'],               qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['geom-reihe'],               qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['geom-reihe'],               qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['rest-pr'],                  qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rest-pr'],                  qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['rest-pr'],                  qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rest-pr'],                  qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['rest-pr'],                  qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['konv-radius-pr'],           qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['konv-radius-pr'],           qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['konv-radius-pr'],           qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['konv-radius-pr'],           qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['konv-radius-pr'],           qty: 1 },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['taylor-anwend'],            qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['taylor-anwend'],            qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['taylor-anwend', 'taylor-pr'], qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['taylor-anwend'],            qty: 1 },
          { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['taylor-anwend'],            qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      subGoals: [
        { label: 'Quotientenkriterium: $L = \\lim |a_{n+1}/a_n|$ — $L < 1$ konv., $L > 1$ div., $L = 1$ unentsch.', examRelevance: 'hoch' },
        { label: 'Wurzelkriterium: $L = \\lim \\sqrt[n]{|a_n|}$ — gleiche Regel', examRelevance: 'hoch' },
        { label: 'Majorantenkriterium: $|a_n| \\leq b_n$, $\\sum b_n$ konv. → $\\sum a_n$ abs. konv.', examRelevance: 'hoch' },
        { label: 'Konvergenzradius: $R = 1/\\limsup \\sqrt[n]{|a_n|}$ (Cauchy-Hadamard)', examRelevance: 'hoch' },
        { label: 'Leibniz-Kriterium für alternierende Reihe: $a_n \\searrow 0 \\Rightarrow$ konv.', examRelevance: 'hoch' },
        { label: 'Absolut vs. bedingt konvergent: $\\sum |a_n|$ konv. (absolut) stärker als $\\sum a_n$ konv.', examRelevance: 'mittel' },
      ],
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'rf-1-1', concepts: ['folge-grenzwert'] },
          { lessonId: 'rf-pruefung-1', concepts: ['standard-reihen', 'konv-radius-pr'] },
        ],
        concepts: [
          { id: 'quotientenkrit',  title: 'Quotientenkriterium $L=\\lim|a_{n+1}/a_n|$ — $L<1$ konv., $L>1$ div., $L=1$ unentschieden', dependsOn: [] },
          { id: 'wurzelkrit',      title: 'Wurzelkriterium $L=\\lim\\sqrt[n]{|a_n|}$',                                                  dependsOn: [] },
          { id: 'majorante-rf',    title: 'Majorantenkriterium: $|a_n|\\le b_n$, $\\sum b_n$ konv. → $\\sum a_n$ abs. konv.',           dependsOn: [] },
          { id: 'cauchy-hadamard', title: 'Konvergenzradius $R=1/\\limsup\\sqrt[n]{|a_n|}$',                                            dependsOn: ['wurzelkrit'] },
          { id: 'leibniz-krit',    title: 'Leibniz: alternierend mit $a_n\\searrow 0\\Rightarrow$ konv.',                                dependsOn: [] },
          { id: 'absolut-bedingt', title: 'Absolut konv. ($\\sum|a_n|$) stärker als bedingt konv. ($\\sum a_n$)',                       dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['quotientenkrit'],
          1: ['wurzelkrit'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['quotientenkrit'],           qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['quotientenkrit'],           qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['quotientenkrit'],           qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['quotientenkrit'],           qty: 1, note: '$L=1$ als konvergent interpretiert' },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['quotientenkrit'],           qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['wurzelkrit'],               qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wurzelkrit'],               qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['wurzelkrit'],               qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wurzelkrit'],               qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['wurzelkrit'],               qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['majorante-rf'],             qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['majorante-rf'],             qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['majorante-rf'],             qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['majorante-rf'],             qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['majorante-rf'],             qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['cauchy-hadamard'],          qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['cauchy-hadamard'],          qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['cauchy-hadamard'],          qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['cauchy-hadamard'],          qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['cauchy-hadamard'],          qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['leibniz-krit'],             qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['leibniz-krit'],             qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['leibniz-krit'],             qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['leibniz-krit'],             qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['leibniz-krit'],             qty: 1 },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['absolut-bedingt'],          qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['absolut-bedingt'],          qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['absolut-bedingt'],          qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['absolut-bedingt'],          qty: 1 },
          { subGoal: 5, stage: 'transfer',          type: 'matching',        uses: ['absolut-bedingt', 'leibniz-krit'], qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      subGoals: [
        { label: 'Lagrange-Restglied: $|R_n(x)| \\leq M \\cdot |x-x_0|^{n+1}/(n+1)!$ mit $M = \\max |f^{(n+1)}|$', examRelevance: 'hoch' },
        { label: 'Taylor-Fehler sinkt mit $1/(n+1)!$ — exponentiell bessere Näherung', examRelevance: 'hoch' },
        { label: 'Linearisierung (n=1): $f(x) \\approx f(x_0) + f\'(x_0)(x-x_0)$', examRelevance: 'hoch' },
        { label: 'Fehlerschätzung Sinus/Cosinus: nächster Term liefert obere Schranke', examRelevance: 'hoch' },
        { label: 'Taylor-Polynom-Grad via geforderter Genauigkeit $|R_n| < \\epsilon$ bestimmen', examRelevance: 'mittel' },
      ],
      createdAt: '2026-04-16',
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'rf-1-2', concepts: ['taylor-formel-rf', 'lagrange-rest', 'maclaurin-std'] },
          { lessonId: 'rf-pruefung-1', concepts: ['taylor-pr', 'standard-reihen'] },
        ],
        concepts: [
          { id: 'lagrange-bound', title: 'Lagrange-Schranke: $|R_n(x)|\\le M\\cdot|x-x_0|^{n+1}/(n+1)!$ mit $M=\\max|f^{(n+1)}|$', dependsOn: [] },
          { id: 'fehler-fakult',  title: 'Taylor-Fehler sinkt mit $1/(n+1)!$ — exponentielle Verbesserung',                       dependsOn: ['lagrange-bound'] },
          { id: 'linearisierung', title: 'Linearisierung ($n=1$): $f(x)\\approx f(x_0)+f\'(x_0)(x-x_0)$',                          dependsOn: [] },
          { id: 'fehler-trig',    title: 'Sin/Cos-Fehlerschätzung: nächster Term liefert obere Schranke',                          dependsOn: ['lagrange-bound'] },
          { id: 'grad-genauigkeit', title: 'Polynom-Grad via geforderter Genauigkeit $|R_n|<\\varepsilon$',                         dependsOn: ['lagrange-bound'] },
        ],
        subGoalConcepts: {
          0: ['lagrange-bound'],
          1: ['fehler-fakult'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['lagrange-bound'],           qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lagrange-bound'],           qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['lagrange-bound'],           qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lagrange-bound'],           qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['lagrange-bound'],           qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['fehler-fakult'],            qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fehler-fakult'],            qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['fehler-fakult'],            qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fehler-fakult'],            qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['fehler-fakult'],            qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['linearisierung'],           qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['linearisierung'],           qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['linearisierung'],           qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['linearisierung'],           qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['linearisierung'],           qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['fehler-trig'],              qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fehler-trig'],              qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['fehler-trig'],              qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fehler-trig'],              qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['fehler-trig'],              qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['grad-genauigkeit'],         qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['grad-genauigkeit'],         qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['grad-genauigkeit'],         qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['grad-genauigkeit'],         qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['grad-genauigkeit'],         qty: 1 },
        ],
      },
    }),
  ],
