  ...
  lessons: [
    makeLesson({
      ...
      blueprint: {
        prerequisites: [],
        concepts: [
          { id: 'newton-iter-num', title: '$x_{n+1}=x_n-f(x_n)/f\'(x_n)$',                                                        dependsOn: [] },
          { id: 'abbruch',         title: 'Abbruch: $|x_{n+1}-x_n|<\\varepsilon$ oder $|f(x_n)|<\\delta$',                          dependsOn: ['newton-iter-num'] },
          { id: 'quad-konv',       title: 'Quadratische Konvergenz: korrekte Stellen verdoppeln sich',                              dependsOn: ['newton-iter-num'] },
          { id: 'newton-fallen',   title: 'Stolperfallen: $f\'(x_n)=0$, schlechter Startwert → Divergenz',                          dependsOn: ['newton-iter-num'] },
        ],
        subGoalConcepts: {
          0: ['newton-iter-num'],
          1: ['abbruch'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['newton-iter-num'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['newton-iter-num'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['newton-iter-num'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['newton-iter-num'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['newton-iter-num'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['abbruch'],                  qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['abbruch'],                  qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['abbruch'],                  qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['abbruch'],                  qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['abbruch'],                  qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['quad-konv'],                qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['quad-konv'],                qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['quad-konv'],                qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['quad-konv'],                qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['quad-konv'],                qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['newton-fallen'],            qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['newton-fallen'],            qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['newton-fallen'],            qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['newton-fallen'],            qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['newton-fallen'],            qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'num-1-1', concepts: ['newton-iter-num', 'abbruch'] },
        ],
        concepts: [
          { id: 'bisektion',    title: 'Bisektion benötigt Vorzeichenwechsel: $f(a)\\cdot f(b)<0$',                              dependsOn: [] },
          { id: 'bisek-fehler', title: 'Fehler nach $n$ Schritten: $(b-a)/2^n$',                                                  dependsOn: ['bisektion'] },
          { id: 'trapez-num',   title: 'Trapezregel $\\tfrac{h}{2}(f_0+2f_1+\\ldots+f_n)$, Fehler $O(h^2)$',                       dependsOn: [] },
          { id: 'simpson-num',  title: 'Simpson: nur bei gerader Teilintervallanzahl, Fehler $O(h^4)$',                            dependsOn: [] },
          { id: 'simpson-exakt', title: 'Simpson exakt für Polynome bis Grad 3',                                                   dependsOn: ['simpson-num'] },
        ],
        subGoalConcepts: {
          0: ['bisektion'],
          1: ['bisek-fehler'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['bisektion'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['bisektion'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['bisektion'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['bisektion'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['bisektion'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['bisek-fehler'],       qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['bisek-fehler'],       qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['bisek-fehler'],       qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['bisek-fehler'],       qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['bisek-fehler'],       qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['trapez-num'],         qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['trapez-num'],         qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['trapez-num'],         qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['trapez-num'],         qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['trapez-num'],         qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['simpson-num'],        qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['simpson-num'],        qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['simpson-num'],        qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['simpson-num'],        qty: 1, note: '$n$ ungerade' },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['simpson-num'],        qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['simpson-exakt'],      qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['simpson-exakt'],      qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['simpson-exakt'],      qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['simpson-exakt'],      qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['simpson-exakt'],      qty: 1 },
        ],
      },
    }),
  ],
  ...
  lessons: [
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'num-1-1', concepts: ['newton-iter-num', 'abbruch'] },
          { lessonId: 'num-1-2', concepts: ['bisektion', 'trapez-num', 'simpson-num'] },
        ],
        concepts: [
          { id: 'bisek-eigen',  title: 'Bisektion: linear, halbiert Intervall, garantiert konvergent bei Vorzeichenwechsel',     dependsOn: [] },
          { id: 'newton-eigen', title: 'Newton: quadratisch konvergent',                                                            dependsOn: [] },
          { id: 'fehler-ord',   title: 'Trapez $O(h^2)$, Simpson $O(h^4)$',                                                          dependsOn: [] },
          { id: 'kondition',    title: 'Konditionszahl $\\kappa(A)=\\|A\\|\\|A^{-1}\\|$ — Stabilitätsindikator',                     dependsOn: [] },
          { id: 'maschinen-eps', title: 'Maschinengenauigkeit $\\varepsilon\\approx 2{,}22\\cdot 10^{-16}$ (double)',               dependsOn: [] },
          { id: 'abbruch-pr',   title: 'Abbruchkriterium $|x_{n+1}-x_n|<\\varepsilon$ oder max. Iterationen',                       dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['bisek-eigen'],
          1: ['newton-eigen'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['bisek-eigen'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['bisek-eigen'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['bisek-eigen'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['bisek-eigen'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['bisek-eigen'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['newton-eigen'],         qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['newton-eigen'],         qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['newton-eigen'],         qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['newton-eigen'],         qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['newton-eigen'],         qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['fehler-ord'],           qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fehler-ord'],           qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['fehler-ord'],           qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fehler-ord'],           qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['fehler-ord'],           qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['kondition'],            qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kondition'],            qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['kondition'],            qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kondition'],            qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['kondition'],            qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['maschinen-eps'],        qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['maschinen-eps'],        qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['maschinen-eps'],        qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['maschinen-eps'],        qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['maschinen-eps'],        qty: 1 },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['abbruch-pr'],           qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['abbruch-pr'],           qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['abbruch-pr'],           qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['abbruch-pr'],           qty: 1 },
          { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['abbruch-pr'],           qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'num-1-2', concepts: ['trapez-num', 'simpson-num', 'simpson-exakt'] },
          { lessonId: 'num-pruefung-1', concepts: ['fehler-ord'] },
        ],
        concepts: [
          { id: 'trapez-formel-pr', title: 'Trapez $T(h)=h[(f_0+f_n)/2+\\sum_{i=1}^{n-1}f_i]$',                                  dependsOn: [] },
          { id: 'simpson-formel-pr', title: 'Simpson $S(h)=(h/3)[f_0+4\\sum_{\\text{ung.}}+2\\sum_{\\text{ger.}}+f_n]$, $n$ gerade', dependsOn: [] },
          { id: 'fehler-trapez',    title: 'Fehler Trapez $|E|\\le(b-a)h^2\\max|f\'\'|/12$',                                       dependsOn: [] },
          { id: 'fehler-simpson',   title: 'Fehler Simpson $|E|\\le(b-a)h^4\\max|f^{(4)}|/180$',                                   dependsOn: [] },
          { id: 'n-toleranz',       title: 'Anzahl $n$ für Toleranz: Fehlerformel nach $h$/$n$ auflösen',                          dependsOn: ['fehler-trapez', 'fehler-simpson'] },
          { id: 'simpson-grad3',    title: 'Simpson exakt für Polynome bis Grad 3 (trotz Ordnung 4)',                              dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['trapez-formel-pr'],
          1: ['simpson-formel-pr'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['trapez-formel-pr'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['trapez-formel-pr'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['trapez-formel-pr'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['trapez-formel-pr'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['trapez-formel-pr'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['simpson-formel-pr'],         qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['simpson-formel-pr'],         qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['simpson-formel-pr'],         qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['simpson-formel-pr'],         qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['simpson-formel-pr'],         qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['fehler-trapez'],             qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fehler-trapez'],             qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['fehler-trapez'],             qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fehler-trapez'],             qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['fehler-trapez'],             qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['fehler-simpson'],            qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fehler-simpson'],            qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['fehler-simpson'],            qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fehler-simpson'],            qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['fehler-simpson'],            qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['n-toleranz'],                qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['n-toleranz'],                qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['n-toleranz'],                qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['n-toleranz'],                qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['n-toleranz'],                qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['simpson-grad3'],             qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['simpson-grad3'],             qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['simpson-grad3'],             qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['simpson-grad3'],             qty: 1 },
          { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['simpson-grad3'],             qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'num-1-1', concepts: ['newton-iter-num', 'newton-fallen'] },
          { lessonId: 'num-1-2', concepts: ['bisektion', 'simpson-num'] },
          { lessonId: 'num-pruefung-1', concepts: ['kondition', 'abbruch-pr'] },
        ],
        concepts: [
          { id: 'method-matrix', title: 'Methodenwahl: Nullstelle → Newton/Bisektion; Integral → Simpson; LGS → Gauß/LU',         dependsOn: [] },
          { id: 'newton-fallback', title: 'Newton schlägt fehl bei $f\'\\approx 0$ → Bisektion als Fallback',                       dependsOn: [] },
          { id: 'abbruch-abs-rel', title: 'Abbruch absolut $|x_{n+1}-x_n|<\\varepsilon_{\\text{abs}}$ oder relativ',               dependsOn: [] },
          { id: 'euler-impl-expl', title: 'Euler explizit instabil bei steifen Systemen; implizit stabil',                          dependsOn: [] },
          { id: 'rk4',           title: 'Runge-Kutta 4: Fehler $O(h^4)$, Standard für DGL-AWP',                                     dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['method-matrix'],
          1: ['newton-fallback'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['method-matrix'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['method-matrix'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'matching',        uses: ['method-matrix'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['method-matrix'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['method-matrix'],          qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['newton-fallback'],        qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['newton-fallback'],        qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['newton-fallback'],        qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['newton-fallback'],        qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['newton-fallback'],        qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['abbruch-abs-rel'],        qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['abbruch-abs-rel'],        qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['abbruch-abs-rel'],        qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['abbruch-abs-rel'],        qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['abbruch-abs-rel'],        qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['euler-impl-expl'],        qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['euler-impl-expl'],        qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['euler-impl-expl'],        qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['euler-impl-expl'],        qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['euler-impl-expl'],        qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['rk4'],                    qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rk4'],                    qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['rk4'],                    qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rk4'],                    qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['rk4'],                    qty: 1 },
        ],
      },
    }),
  ],
