  ...
  lessons: [
    makeLesson({
      ...
      blueprint: {
        prerequisites: [],
        concepts: [
          { id: 'erwart-disk',   title: 'Erwartungswert $E(X)=\\sum_i x_i p_i$ (diskret)',                                          dependsOn: [] },
          { id: 'verschiebung',  title: 'Verschiebungssatz $\\operatorname{Var}(X)=E(X^2)-E(X)^2$',                                  dependsOn: ['erwart-disk'] },
          { id: 'einheiten-stat', title: '$E(X)$ wie $X$, $\\operatorname{Var}$ wie $X^2$, $\\sigma$ wie $X$',                       dependsOn: ['erwart-disk'] },
          { id: 'linear-stat',   title: 'Linearität $E(aX+b)=aE(X)+b$, $\\operatorname{Var}(aX+b)=a^2\\operatorname{Var}(X)$',       dependsOn: ['erwart-disk', 'verschiebung'] },
        ],
        subGoalConcepts: {
          0: ['erwart-disk'],
          1: ['verschiebung'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['erwart-disk'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['erwart-disk'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['erwart-disk'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['erwart-disk'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['erwart-disk'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['verschiebung'],         qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['verschiebung'],         qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['verschiebung'],         qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['verschiebung'],         qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['verschiebung'],         qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['einheiten-stat'],       qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['einheiten-stat'],       qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['einheiten-stat'],       qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['einheiten-stat'],       qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['einheiten-stat'],       qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['linear-stat'],          qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['linear-stat'],          qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['linear-stat'],          qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['linear-stat'],          qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['linear-stat'],          qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'stat-1-1', concepts: ['erwart-disk', 'verschiebung'] },
        ],
        concepts: [
          { id: 'mu-sigma',     title: 'Parameter $\\mu$ verschiebt, $\\sigma$ streckt die Glockenkurve',                            dependsOn: [] },
          { id: 'z-trans',      title: 'z-Transformation $Z=(X-\\mu)/\\sigma$ → $N(0,1)$',                                            dependsOn: ['mu-sigma'] },
          { id: 'sigma-regel',  title: '68/95/99,7-Regel: $\\pm1\\sigma,\\pm2\\sigma,\\pm3\\sigma$',                                  dependsOn: ['mu-sigma'] },
          { id: 'phi-symm',     title: '$\\Phi(z)$ Tabelle nur für $z\\ge 0$, sonst $\\Phi(-z)=1-\\Phi(z)$',                         dependsOn: ['z-trans'] },
          { id: 'p-intervall',  title: '$P(a\\le X\\le b)=\\Phi((b-\\mu)/\\sigma)-\\Phi((a-\\mu)/\\sigma)$',                          dependsOn: ['z-trans', 'phi-symm'] },
        ],
        subGoalConcepts: {
          0: ['mu-sigma'],
          1: ['z-trans'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['mu-sigma'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mu-sigma'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['mu-sigma'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mu-sigma'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['mu-sigma'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['z-trans'],           qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['z-trans'],           qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['z-trans'],           qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['z-trans'],           qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['z-trans'],           qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['sigma-regel'],       qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-regel'],       qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-regel'],       qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-regel'],       qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['sigma-regel'],       qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['phi-symm'],          qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['phi-symm'],          qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['phi-symm'],          qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['phi-symm'],          qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['phi-symm'],          qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['p-intervall'],       qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-intervall'],       qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['p-intervall'],       qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-intervall'],       qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['p-intervall'],       qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      subGoals: [
        { label: 'p-Wert < $\\alpha$ → $H_0$ verwerfen (signifikantes Ergebnis)', examRelevance: 'hoch' },
        { label: '95%-Konfidenzintervall Mittelwert: $\\bar x \\pm 1{,}96 \\cdot \\sigma/\\sqrt n$ (normalverteilt)', examRelevance: 'hoch' },
        { label: 'Fehler 1. Art ($\\alpha$): $H_0$ verworfen obwohl wahr; 2. Art ($\\beta$): $H_0$ behalten obwohl falsch', examRelevance: 'hoch' },
        { label: 't-Test bei unbekannter Varianz: $t = (\\bar x - \\mu_0)/(s/\\sqrt n)$', examRelevance: 'mittel' },
        { label: 'Einseitig vs. zweiseitig: einseitiger Test nutzt $z_\\alpha$, zweiseitig $z_{\\alpha/2}$', examRelevance: 'mittel' },
      ],
      createdAt: '2026-04-15',
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'stat-1-1', concepts: ['erwart-disk', 'verschiebung'] },
          { lessonId: 'stat-1-2', concepts: ['mu-sigma', 'z-trans', 'phi-symm'] },
        ],
        concepts: [
          { id: 'p-wert',       title: 'p-Wert $<\\alpha\\Rightarrow H_0$ verwerfen',                                                dependsOn: [] },
          { id: 'ki-mw',        title: '95%-KI Mittelwert: $\\bar x\\pm 1{,}96\\cdot\\sigma/\\sqrt n$',                              dependsOn: [] },
          { id: 'fehler-art',   title: 'Fehler 1. Art ($\\alpha$) / 2. Art ($\\beta$)',                                              dependsOn: ['p-wert'] },
          { id: 't-test',       title: 't-Test bei unbekannter Varianz: $t=(\\bar x-\\mu_0)/(s/\\sqrt n)$',                          dependsOn: [] },
          { id: 'ein-zwei-seitig', title: 'Einseitig $z_\\alpha$ vs. zweiseitig $z_{\\alpha/2}$',                                     dependsOn: ['p-wert'] },
        ],
        subGoalConcepts: {
          0: ['p-wert'],
          1: ['ki-mw'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['p-wert'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-wert'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['p-wert'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-wert'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['p-wert'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['ki-mw'],           qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['ki-mw'],           qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['ki-mw'],           qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['ki-mw'],           qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['ki-mw'],           qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['fehler-art'],      qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fehler-art'],      qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['fehler-art'],      qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fehler-art'],      qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['fehler-art'],      qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['t-test'],          qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['t-test'],          qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['t-test'],          qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['t-test'],          qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['t-test'],          qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['ein-zwei-seitig'], qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['ein-zwei-seitig'], qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['ein-zwei-seitig'], qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['ein-zwei-seitig'], qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['ein-zwei-seitig'], qty: 1 },
        ],
      },
    }),
  ],
...
const unit2 = makeUnit({
  ...
  lessons: [
    makeLesson({
      ...
      subGoals: [
        { label: 't-Test: Mittelwertvergleich, Verteilung bei unbekannter Varianz', examRelevance: 'hoch' },
        { label: '$\\chi^2$-Test: Anpassung an Verteilung oder Unabhängigkeitsprüfung', examRelevance: 'hoch' },
        { label: 'Testentscheidung: Prüfgröße mit Quantil vergleichen oder p-Wert mit $\\alpha$', examRelevance: 'hoch' },
        { label: 'Freiheitsgrade bei t-Test $df = n - 1$, bei $\\chi^2$-Anpassung $df = k - 1 - r$', examRelevance: 'mittel' },
        { label: 'Konfidenzintervall-Breite $\\propto 1/\\sqrt n$ — Halbierung braucht 4× Stichprobe', examRelevance: 'mittel' },
      ],
      createdAt: '2026-04-14',
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'stat-1-3', concepts: ['p-wert', 'ki-mw', 't-test'] },
        ],
        concepts: [
          { id: 't-test-pr',     title: 't-Test: Mittelwertvergleich bei unbekannter Varianz',                                       dependsOn: [] },
          { id: 'chi-quadrat',   title: '$\\chi^2$-Test: Anpassung an Verteilung oder Unabhängigkeitsprüfung',                       dependsOn: [] },
          { id: 'test-entscheid', title: 'Testentscheidung: Prüfgröße mit Quantil oder p-Wert mit $\\alpha$',                         dependsOn: [] },
          { id: 'freiheitsgrade', title: 'Freiheitsgrade: t-Test $df=n-1$, $\\chi^2$-Anpassung $df=k-1-r$',                          dependsOn: [] },
          { id: 'ki-breite',     title: 'KI-Breite $\\propto 1/\\sqrt n$ — Halbierung braucht 4× Stichprobe',                       dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['t-test-pr'],
          1: ['chi-quadrat'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['t-test-pr'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['t-test-pr'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['t-test-pr'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['t-test-pr'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['t-test-pr'],          qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['chi-quadrat'],        qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['chi-quadrat'],        qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['chi-quadrat'],        qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['chi-quadrat'],        qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['chi-quadrat'],        qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['test-entscheid'],     qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['test-entscheid'],     qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['test-entscheid'],     qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['test-entscheid'],     qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['test-entscheid'],     qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['freiheitsgrade'],     qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['freiheitsgrade'],     qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['freiheitsgrade'],     qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['freiheitsgrade'],     qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['freiheitsgrade'],     qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['ki-breite'],          qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['ki-breite'],          qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['ki-breite'],          qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['ki-breite'],          qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['ki-breite'],          qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      subGoals: [
        { label: 'Standardisierung: $Z = (X - \\mu)/\\sigma \\sim N(0,1)$', examRelevance: 'hoch' },
        { label: '$\\Phi(-z) = 1 - \\Phi(z)$ (Symmetrie)', examRelevance: 'hoch' },
        { label: '68-95-99,7-Regel: $\\pm 1\\sigma \\to 68\\%$, $\\pm 2\\sigma \\to 95\\%$, $\\pm 3\\sigma \\to 99{,}7\\%$', examRelevance: 'hoch' },
        { label: 'Zentrale Quantile: $z_{0{,}025} = 1{,}96$, $z_{0{,}05} = 1{,}645$, $z_{0{,}01} = 2{,}576$', examRelevance: 'hoch' },
        { label: 'Rechts-, links-, beidseitiger Bereich: $P(X > a), P(X < a), P(a < X < b)$', examRelevance: 'hoch' },
      ],
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'stat-1-2', concepts: ['mu-sigma', 'z-trans', 'sigma-regel', 'phi-symm'] },
        ],
        concepts: [
          { id: 'standardisierung', title: 'Standardisierung $Z=(X-\\mu)/\\sigma\\sim N(0,1)$',                                      dependsOn: [] },
          { id: 'phi-symmetrie',    title: '$\\Phi(-z)=1-\\Phi(z)$ (Symmetrie)',                                                     dependsOn: [] },
          { id: 'sigma-pr',         title: '68-95-99,7-Regel auswendig',                                                              dependsOn: [] },
          { id: 'zentrale-quant',   title: 'Quantile: $z_{0{,}025}=1{,}96$, $z_{0{,}05}=1{,}645$, $z_{0{,}01}=2{,}576$',             dependsOn: [] },
          { id: 'p-bereich',        title: 'Rechts-/links-/beidseitig: $P(X>a),P(X<a),P(a<X<b)$',                                     dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['standardisierung'],
          1: ['phi-symmetrie'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['standardisierung'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['standardisierung'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['standardisierung'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['standardisierung'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['standardisierung'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['phi-symmetrie'],             qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['phi-symmetrie'],             qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['phi-symmetrie'],             qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['phi-symmetrie'],             qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['phi-symmetrie'],             qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['sigma-pr'],                  qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sigma-pr'],                  qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['sigma-pr'],                  qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sigma-pr'],                  qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['sigma-pr'],                  qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['zentrale-quant'],            qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['zentrale-quant'],            qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['zentrale-quant'],            qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['zentrale-quant'],            qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['zentrale-quant'],            qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['p-bereich'],                 qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-bereich'],                 qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['p-bereich'],                 qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-bereich'],                 qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['p-bereich'],                 qty: 1, note: '[PRÜFUNG]' },
        ],
      },
    }),
    makeLesson({
      ...
      subGoals: [
        { label: 'Stichprobenmittel $\\bar x = (1/n) \\sum x_i$, Stichproben-SD $s = \\sqrt{\\sum(x_i - \\bar x)^2 /(n-1)}$', examRelevance: 'hoch' },
        { label: '95%-KI: $\\bar x \\pm z_{0{,}025} \\cdot \\sigma/\\sqrt n$ (Normalverteilung, $\\sigma$ bekannt)', examRelevance: 'hoch' },
        { label: 't-KI bei $\\sigma$ unbekannt: $\\bar x \\pm t_{n-1; 0{,}025} \\cdot s/\\sqrt n$', examRelevance: 'hoch' },
        { label: 'Stichprobenumfang: $n \\geq (z_{\\alpha/2} \\sigma/\\Delta)^2$ für Halbbreite $\\Delta$', examRelevance: 'hoch' },
        { label: 'Teiler $n-1$ bei Stichproben-Varianz (Bessel-Korrektur, erwartungstreu)', examRelevance: 'mittel' },
      ],
      createdAt: '2026-04-16',
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'stat-1-1', concepts: ['erwart-disk', 'verschiebung'] },
          { lessonId: 'stat-1-3', concepts: ['ki-mw'] },
          { lessonId: 'stat-pruefung-2', concepts: ['zentrale-quant'] },
        ],
        concepts: [
          { id: 'stich-mw',     title: 'Stichprobenmittel $\\bar x=(1/n)\\sum x_i$, SD $s=\\sqrt{\\sum(x_i-\\bar x)^2/(n-1)}$',     dependsOn: [] },
          { id: 'ki-95',        title: '95%-KI: $\\bar x\\pm z_{0{,}025}\\cdot\\sigma/\\sqrt n$ ($\\sigma$ bekannt)',                dependsOn: [] },
          { id: 't-ki',         title: 't-KI bei $\\sigma$ unbekannt: $\\bar x\\pm t_{n-1;0{,}025}\\cdot s/\\sqrt n$',               dependsOn: ['stich-mw'] },
          { id: 'stich-umfang', title: 'Stichprobenumfang $n\\ge(z_{\\alpha/2}\\sigma/\\Delta)^2$',                                   dependsOn: ['ki-95'] },
          { id: 'bessel-korr',  title: 'Bessel-Korrektur (Teiler $n-1$) — erwartungstreue Varianz',                                    dependsOn: ['stich-mw'] },
        ],
        subGoalConcepts: {
          0: ['stich-mw'],
          1: ['ki-95'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['stich-mw'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['stich-mw'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['stich-mw'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['stich-mw'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['stich-mw'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['ki-95'],             qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['ki-95'],             qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['ki-95'],             qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['ki-95'],             qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['ki-95'],             qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['t-ki'],              qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['t-ki'],              qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['t-ki'],              qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['t-ki'],              qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['t-ki'],              qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['stich-umfang'],      qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['stich-umfang'],      qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['stich-umfang'],      qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['stich-umfang'],      qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['stich-umfang'],      qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['bessel-korr'],       qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['bessel-korr'],       qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['bessel-korr'],       qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['bessel-korr'],       qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['bessel-korr'],       qty: 1 },
        ],
      },
    }),
  ],
