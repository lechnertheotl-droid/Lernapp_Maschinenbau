...
const unit1Lessons = [
  makeLesson({
    ...
    blueprint: {
      prerequisites: [],
      concepts: [
        { id: 'i-def',         title: '$i^2=-1$ — definierende Eigenschaft, kein Variable',                       dependsOn: [] },
        { id: 'z-form',        title: 'Komplexe Zahl $z=a+bi$ mit $a,b\\in\\mathbb R$',                             dependsOn: ['i-def'] },
        { id: 're-im',         title: '$\\operatorname{Re}(z)=a$, $\\operatorname{Im}(z)=b$ (beide reell, ohne $i$)', dependsOn: ['z-form'] },
        { id: 'gauss-ebene',   title: 'Gaußsche Zahlenebene: $z$ als Punkt $(a,b)$',                                dependsOn: ['z-form'] },
        { id: 'konjugiert',    title: 'Konjugierte $\\bar z=a-bi$ — Spiegelung an reeller Achse',                   dependsOn: ['z-form'] },
        { id: 'reell-imag-rein', title: 'Reell $\\iff\\operatorname{Im}=0$; rein imaginär $\\iff\\operatorname{Re}=0$', dependsOn: ['re-im'] },
      ],
      subGoalConcepts: {
        0: ['i-def'],
        1: ['re-im', 'z-form', 'gauss-ebene'],
        2: ['konjugiert'],
        3: ['reell-imag-rein'],
      },
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['i-def'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['i-def'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['i-def'],                  qty: 1, note: '$i^3, i^4$' },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['i-def'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['i-def'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['re-im'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['re-im', 'z-form'],        qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['re-im'],                  qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['re-im'],                  qty: 1, note: '$\\operatorname{Im}(z)=bi$ statt $b$' },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['gauss-ebene'],            qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['konjugiert'],             qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['konjugiert'],             qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['konjugiert'],             qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['konjugiert'],             qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['konjugiert'],             qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['reell-imag-rein'],        qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['reell-imag-rein'],        qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['reell-imag-rein'],        qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['reell-imag-rein'],        qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['reell-imag-rein', 're-im'], qty: 1 },
      ],
    },
  }),
  ...
  makeLesson({
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-1-1', concepts: ['i-def', 'z-form', 're-im', 'konjugiert'] },
      ],
      concepts: [
        { id: 'add-sub-c',     title: 'Addition/Subtraktion komponentenweise — wie Vektoren',                                        dependsOn: [] },
        { id: 'mult-c',        title: 'Multiplikation: $(a+bi)(c+di)$ ausmultiplizieren, $i^2=-1$',                                   dependsOn: [] },
        { id: 'div-c',         title: 'Division: mit $\\bar{c+di}=c-di$ erweitern → reeller Nenner $c^2+d^2$',                       dependsOn: ['mult-c'] },
        { id: 'z-zbar',        title: '$z\\cdot\\bar z=|z|^2=a^2+b^2$ — immer reell und nicht-negativ',                                dependsOn: ['mult-c'] },
      ],
      subGoalConcepts: {
        0: ['add-sub-c'],
        1: ['mult-c'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['add-sub-c'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['add-sub-c'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['add-sub-c'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['add-sub-c'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['add-sub-c'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['mult-c'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mult-c'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['mult-c'],                     qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mult-c'],                     qty: 1, note: '$i^2=+1$ Falle' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['mult-c'],                     qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['div-c'],                      qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['div-c'],                      qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['div-c'],                      qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['div-c'],                      qty: 1, note: 'Konjugiert nicht verwendet' },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['div-c'],                      qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['z-zbar'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['z-zbar'],                     qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['z-zbar'],                     qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['z-zbar'],                     qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['z-zbar', 'div-c'],            qty: 1 },
      ],
    },
  }),
]
...
const unit2Lessons = [
  makeLesson({
    ...
    subGoals: [
      { label: 'Betrag: $|z| = \\sqrt{a^2 + b^2}$ (Pythagoras)', examRelevance: 'hoch' },
      { label: 'Argument: $\\varphi = \\arg(z)$ mit $\\text{atan2}(b,a)$ (Quadrant beachten!)', examRelevance: 'hoch' },
      { label: 'Polarform: $z = |z|(\\cos\\varphi + i\\sin\\varphi) = |z| e^{i\\varphi}$', examRelevance: 'hoch' },
      { label: 'Rücktransformation: $a = |z|\\cos\\varphi$, $b = |z|\\sin\\varphi$', examRelevance: 'hoch' },
      { label: 'Hauptwert des Arguments: $\\varphi \\in (-\\pi, \\pi]$ (Konvention)', examRelevance: 'mittel' },
      { label: 'Typische Falle: einfacher $\\arctan(b/a)$ gibt falschen Quadranten', examRelevance: 'hoch' },
    ],
    createdAt: '2026-04-14',
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-1-1', concepts: ['z-form', 're-im', 'konjugiert', 'gauss-ebene'] },
        { lessonId: 'komz-1-2', concepts: ['z-zbar'] },
      ],
      concepts: [
        { id: 'betrag-c',     title: 'Betrag $|z|=\\sqrt{a^2+b^2}$ (Pythagoras)',                                            dependsOn: [] },
        { id: 'argument',     title: 'Argument $\\varphi=\\arg(z)$ via $\\text{atan2}(b,a)$ (Quadrant!)',                      dependsOn: [] },
        { id: 'polarform',    title: 'Polarform $z=|z|(\\cos\\varphi+i\\sin\\varphi)=|z|e^{i\\varphi}$',                       dependsOn: ['betrag-c', 'argument'] },
        { id: 'rueck-trans',  title: 'Rücktransformation: $a=|z|\\cos\\varphi$, $b=|z|\\sin\\varphi$',                         dependsOn: ['polarform'] },
        { id: 'arg-haupt',    title: 'Hauptwert $\\varphi\\in(-\\pi,\\pi]$',                                                   dependsOn: ['argument'] },
        { id: 'atan-falle',   title: 'Falle: einfacher $\\arctan(b/a)$ gibt falschen Quadranten',                              dependsOn: ['argument'] },
      ],
      subGoalConcepts: {
        0: ['betrag-c'],
        1: ['argument'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['betrag-c'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['betrag-c'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['betrag-c'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['betrag-c'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['betrag-c'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['argument'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['argument'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['argument'],                  qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['argument'],                  qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['argument'],                  qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['polarform'],                 qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['polarform'],                 qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['polarform', 'betrag-c', 'argument'], qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['polarform'],                 qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['polarform'],                 qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['rueck-trans'],               qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rueck-trans'],               qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['rueck-trans'],               qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rueck-trans'],               qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['rueck-trans'],               qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['arg-haupt'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['arg-haupt'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['arg-haupt'],                 qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['arg-haupt'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['arg-haupt'],                 qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['atan-falle'],                qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['atan-falle'],                qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['atan-falle'],                qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['atan-falle'],                qty: 1, note: 'Falscher Quadrant trotz korrekter Formel' },
        { subGoal: 5, stage: 'transfer',          type: 'matching',        uses: ['atan-falle', 'argument'],    qty: 1 },
      ],
    },
  }),
  ...
  makeLesson({
    ...
    subGoals: [
      { label: 'Euler-Formel: $e^{i\\varphi} = \\cos\\varphi + i\\sin\\varphi$', examRelevance: 'hoch' },
      { label: 'Euler\'sche Identität: $e^{i\\pi} + 1 = 0$ (fünf Konstanten in einer Gleichung)', examRelevance: 'mittel' },
      { label: 'Multiplikation: $z_1 z_2 = r_1 r_2 e^{i(\\varphi_1 + \\varphi_2)}$ (Beträge mal, Argumente plus)', examRelevance: 'hoch' },
      { label: 'Division: $z_1/z_2 = (r_1/r_2) e^{i(\\varphi_1 - \\varphi_2)}$', examRelevance: 'hoch' },
      { label: 'Konjugiert-komplex in Polarform: $\\bar z = r e^{-i\\varphi}$', examRelevance: 'hoch' },
      { label: 'Sinus/Cosinus aus Euler: $\\cos\\varphi = (e^{i\\varphi} + e^{-i\\varphi})/2$, $\\sin\\varphi = (e^{i\\varphi} - e^{-i\\varphi})/(2i)$', examRelevance: 'mittel' },
    ],
    createdAt: '2026-04-14',
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-2-1', concepts: ['polarform', 'argument', 'betrag-c'] },
      ],
      concepts: [
        { id: 'euler-formel',   title: 'Euler-Formel: $e^{i\\varphi}=\\cos\\varphi+i\\sin\\varphi$',                                  dependsOn: [] },
        { id: 'euler-identitaet', title: 'Euler-Identität: $e^{i\\pi}+1=0$',                                                            dependsOn: ['euler-formel'] },
        { id: 'mult-polar',     title: 'Mult.: $z_1z_2=r_1r_2 e^{i(\\varphi_1+\\varphi_2)}$ (Beträge mal, Winkel plus)',              dependsOn: ['euler-formel'] },
        { id: 'div-polar',      title: 'Div.: $z_1/z_2=(r_1/r_2)e^{i(\\varphi_1-\\varphi_2)}$',                                          dependsOn: ['euler-formel'] },
        { id: 'konj-polar',     title: 'Konjugiert in Polarform: $\\bar z=re^{-i\\varphi}$',                                            dependsOn: ['euler-formel'] },
        { id: 'cos-sin-euler',  title: '$\\cos\\varphi=(e^{i\\varphi}+e^{-i\\varphi})/2$, $\\sin\\varphi=(e^{i\\varphi}-e^{-i\\varphi})/(2i)$', dependsOn: ['euler-formel', 'konj-polar'] },
      ],
      subGoalConcepts: {
        0: ['euler-formel'],
        1: ['euler-identitaet'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['euler-formel'],                qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['euler-formel'],                qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['euler-formel'],                qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['euler-formel'],                qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['euler-formel'],                qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['euler-identitaet'],            qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['euler-identitaet'],            qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['euler-identitaet'],            qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['euler-identitaet'],            qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['euler-identitaet'],            qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['mult-polar'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mult-polar'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['mult-polar'],                  qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mult-polar'],                  qty: 1, note: 'Beträge addiert statt multipliziert' },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['mult-polar'],                  qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['div-polar'],                   qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['div-polar'],                   qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['div-polar'],                   qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['div-polar'],                   qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['div-polar', 'mult-polar'],     qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['konj-polar'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['konj-polar'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['konj-polar'],                  qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['konj-polar'],                  qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'matching',        uses: ['konj-polar'],                  qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['cos-sin-euler'],               qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['cos-sin-euler'],               qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['cos-sin-euler'],               qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['cos-sin-euler'],               qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['cos-sin-euler'],               qty: 1 },
      ],
    },
  }),
]
...
const unit3Lessons = [
  makeLesson({
    ...
    subGoals: [
      { label: 'Moivre: $z^n = |z|^n e^{in\\varphi} = |z|^n (\\cos n\\varphi + i \\sin n\\varphi)$', examRelevance: 'hoch' },
      { label: 'Betrag hoch $n$, Argument mal $n$', examRelevance: 'hoch' },
      { label: 'Anwendung: Mehrfach-Winkel-Formeln ($\\cos 2\\varphi, \\sin 3\\varphi, \\ldots$) herleitbar', examRelevance: 'mittel' },
      { label: 'Geometrisch: Streckung + Drehung — wiederholte Rotation um $\\varphi$', examRelevance: 'hoch' },
      { label: 'Negative Potenzen: $z^{-1} = (1/|z|) e^{-i\\varphi}$', examRelevance: 'mittel' },
    ],
    createdAt: '2026-04-14',
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-2-1', concepts: ['polarform', 'betrag-c', 'argument'] },
        { lessonId: 'komz-2-2', concepts: ['euler-formel', 'mult-polar'] },
      ],
      concepts: [
        { id: 'moivre',         title: 'Moivre: $z^n=|z|^n e^{in\\varphi}=|z|^n(\\cos n\\varphi+i\\sin n\\varphi)$',          dependsOn: [] },
        { id: 'moivre-betrag',  title: 'Betrag hoch $n$, Argument mal $n$',                                                    dependsOn: ['moivre'] },
        { id: 'mehrfach-winkel', title: 'Mehrfach-Winkel-Formeln aus Moivre herleitbar',                                        dependsOn: ['moivre'] },
        { id: 'streck-rotation', title: 'Geometrisch: Streckung + Drehung um $\\varphi$ wiederholt',                            dependsOn: ['moivre'] },
        { id: 'neg-pot',        title: 'Negative Potenzen: $z^{-1}=(1/|z|)e^{-i\\varphi}$',                                     dependsOn: ['moivre'] },
      ],
      subGoalConcepts: {
        0: ['moivre'],
        1: ['moivre-betrag'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['moivre'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['moivre'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['moivre'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['moivre'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['moivre'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['moivre-betrag'],           qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['moivre-betrag'],           qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['moivre-betrag'],           qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['moivre-betrag'],           qty: 1, note: 'Argument hoch $n$ statt mal $n$' },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['moivre-betrag'],           qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['mehrfach-winkel'],         qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mehrfach-winkel'],         qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['mehrfach-winkel'],         qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mehrfach-winkel'],         qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['mehrfach-winkel'],         qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['streck-rotation'],         qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['streck-rotation'],         qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['streck-rotation'],         qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['streck-rotation'],         qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['streck-rotation'],         qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['neg-pot'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['neg-pot'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['neg-pot'],                 qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['neg-pot'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['neg-pot'],                 qty: 1 },
      ],
    },
  }),
  ...
  makeLesson({
    ...
    subGoals: [
      { label: 'Wurzelformel: $z_k = |w|^{1/n} e^{i(\\varphi + 2\\pi k)/n}$ für $k = 0, 1, \\ldots, n-1$', examRelevance: 'hoch' },
      { label: 'Anzahl: genau $n$ verschiedene $n$-te Wurzeln (Fundamentalsatz der Algebra)', examRelevance: 'hoch' },
      { label: 'Geometrisch: regelmäßiges $n$-Eck auf Kreis mit Radius $|w|^{1/n}$', examRelevance: 'hoch' },
      { label: 'Winkelabstand zwischen Wurzeln: $2\\pi/n$', examRelevance: 'hoch' },
      { label: 'Einheitswurzeln ($w=1$): $z_k = e^{i 2\\pi k/n}$ — Ecken eines regelmäßigen $n$-Ecks', examRelevance: 'hoch' },
      { label: 'Hauptwurzel $k=0$: die mit kleinstem positivem Argument', examRelevance: 'mittel' },
    ],
    createdAt: '2026-04-14',
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-2-1', concepts: ['polarform', 'argument'] },
        { lessonId: 'komz-2-2', concepts: ['euler-formel'] },
        { lessonId: 'komz-3-1', concepts: ['moivre'] },
      ],
      concepts: [
        { id: 'wurzel-formel', title: 'Wurzelformel: $z_k=|w|^{1/n}e^{i(\\varphi+2\\pi k)/n}$ für $k=0,1,\\dots,n-1$',                   dependsOn: [] },
        { id: 'wurzel-anzahl', title: '$n$ verschiedene $n$-te Wurzeln (Fundamentalsatz)',                                                dependsOn: ['wurzel-formel'] },
        { id: 'wurzel-neck',   title: 'Geometrisch: regelmäßiges $n$-Eck auf Kreis Radius $|w|^{1/n}$',                                  dependsOn: ['wurzel-formel'] },
        { id: 'wurzel-abstand', title: 'Winkelabstand benachbarter Wurzeln: $2\\pi/n$',                                                    dependsOn: ['wurzel-neck'] },
        { id: 'einheits-wz',   title: 'Einheitswurzeln: $z_k=e^{i 2\\pi k/n}$ — Ecken regelmäßiges $n$-Eck',                              dependsOn: ['wurzel-formel'] },
        { id: 'haupt-wz',      title: 'Hauptwurzel $k=0$: kleinstes positives Argument',                                                  dependsOn: ['wurzel-formel'] },
      ],
      subGoalConcepts: {
        0: ['wurzel-formel'],
        1: ['wurzel-anzahl'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['wurzel-formel'],                qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wurzel-formel'],                qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['wurzel-formel'],                qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wurzel-formel'],                qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['wurzel-formel'],                qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['wurzel-anzahl'],                qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wurzel-anzahl'],                qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['wurzel-anzahl'],                qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wurzel-anzahl'],                qty: 1, note: 'Nur eine Wurzel angegeben' },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['wurzel-anzahl'],                qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['wurzel-neck'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wurzel-neck'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['wurzel-neck'],                  qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wurzel-neck'],                  qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['wurzel-neck'],                  qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['wurzel-abstand'],               qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wurzel-abstand'],               qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['wurzel-abstand'],               qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wurzel-abstand'],               qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['wurzel-abstand'],               qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['einheits-wz'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['einheits-wz'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['einheits-wz'],                  qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['einheits-wz'],                  qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['einheits-wz'],                  qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['haupt-wz'],                     qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['haupt-wz'],                     qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['haupt-wz'],                     qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['haupt-wz'],                     qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['haupt-wz', 'wurzel-formel'],    qty: 1 },
      ],
    },
  }),
]
...
const unit4Lessons = [
  makeLesson({
    ...
    subGoals: [
      { label: 'Formwahl: $+/-$ → kartesisch, $\\cdot/\\div$ und Potenzen/Wurzeln → polar/exponential', examRelevance: 'hoch' },
      { label: 'Impedanz ET: $Z_R = R$, $Z_L = i\\omega L$, $Z_C = 1/(i\\omega C)$', examRelevance: 'hoch' },
      { label: 'Komplexer Zeiger für Schwingung $x(t) = \\text{Re}(A e^{i\\omega t})$', examRelevance: 'hoch' },
      { label: 'Quadratische Gleichung in $\\mathbb{C}$: Diskriminante $<0$ liefert komplexes konj. Paar', examRelevance: 'hoch' },
      { label: '$z \\cdot \\bar z = |z|^2$ (Betrag-Quadrat aus Multiplikation mit Konjugiertem)', examRelevance: 'hoch' },
      { label: 'Argumente beim Dividieren: $\\arg(z_1/z_2) = \\arg(z_1) - \\arg(z_2)$', examRelevance: 'mittel' },
    ],
    createdAt: '2026-04-14',
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-1-2', concepts: ['mult-c', 'div-c', 'z-zbar'] },
        { lessonId: 'komz-2-1', concepts: ['betrag-c', 'argument', 'polarform'] },
        { lessonId: 'komz-2-2', concepts: ['euler-formel', 'mult-polar', 'div-polar'] },
        { lessonId: 'komz-3-2', concepts: ['wurzel-formel'] },
      ],
      concepts: [
        { id: 'formwahl',     title: 'Formwahl: $+/-$ → kartesisch, $\\cdot/\\div$/Pot/Wurzel → polar/exp.',                  dependsOn: [] },
        { id: 'impedanz-et',  title: 'Impedanz ET: $Z_R=R$, $Z_L=i\\omega L$, $Z_C=1/(i\\omega C)$',                            dependsOn: [] },
        { id: 'zeiger',       title: 'Komplexer Zeiger: $x(t)=\\operatorname{Re}(A e^{i\\omega t})$',                            dependsOn: [] },
        { id: 'quadr-c',      title: 'Quadratische Gleichung in $\\mathbb C$: Diskriminante $<0$ → konjugiertes Paar',           dependsOn: [] },
        { id: 'z-zbar-anwend', title: '$z\\cdot\\bar z=|z|^2$ — Anwendung in Beweisen',                                          dependsOn: [] },
        { id: 'arg-div',      title: '$\\arg(z_1/z_2)=\\arg z_1-\\arg z_2$ (mod $2\\pi$)',                                       dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['formwahl'],
        1: ['impedanz-et'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['formwahl'],                qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['formwahl'],                qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['formwahl'],                qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['formwahl'],                qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['formwahl'],                qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['impedanz-et'],             qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['impedanz-et'],             qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['impedanz-et'],             qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['impedanz-et'],             qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['impedanz-et'],             qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['zeiger'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['zeiger'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['zeiger'],                  qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['zeiger'],                  qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['zeiger'],                  qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['quadr-c'],                 qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['quadr-c'],                 qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['quadr-c'],                 qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['quadr-c'],                 qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['quadr-c'],                 qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['z-zbar-anwend'],           qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['z-zbar-anwend'],           qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['z-zbar-anwend'],           qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['z-zbar-anwend'],           qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['z-zbar-anwend'],           qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['arg-div'],                 qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['arg-div'],                 qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['arg-div'],                 qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['arg-div'],                 qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['arg-div'],                 qty: 1 },
      ],
    },
  }),
  ...
  makeLesson({
    ...
    subGoals: [
      { label: 'Kartesisch → Polar: $r = \\sqrt{a^2+b^2}$, $\\varphi = \\text{atan2}(b,a) \\in (-\\pi, \\pi]$', examRelevance: 'hoch' },
      { label: 'Multiplikation: Beträge mal, Argumente plus (mod $2\\pi$)', examRelevance: 'hoch' },
      { label: 'Division: Beträge durch, Argumente minus', examRelevance: 'hoch' },
      { label: 'Quadrantenmerker: $-i$ hat $\\varphi = -\\pi/2$, $-1$ hat $\\varphi = \\pi$', examRelevance: 'hoch' },
      { label: 'Argument-Hauptwert wählen (sonst Punkte-Abzug bei nicht-eindeutiger Antwort)', examRelevance: 'mittel' },
    ],
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-2-1', concepts: ['betrag-c', 'argument', 'polarform', 'arg-haupt'] },
        { lessonId: 'komz-2-2', concepts: ['mult-polar', 'div-polar'] },
      ],
      concepts: [
        { id: 'kart-zu-polar', title: 'Kartesisch → Polar: $r=\\sqrt{a^2+b^2}$, $\\varphi=\\text{atan2}(b,a)\\in(-\\pi,\\pi]$',     dependsOn: [] },
        { id: 'mult-polar-pr', title: 'Mult.: Beträge mal, Argumente plus (mod $2\\pi$)',                                          dependsOn: [] },
        { id: 'div-polar-pr',  title: 'Div.: Beträge durch, Argumente minus',                                                       dependsOn: [] },
        { id: 'quadr-merker',  title: 'Quadrantenmerker: $-i\\to\\varphi=-\\pi/2$, $-1\\to\\varphi=\\pi$',                            dependsOn: [] },
        { id: 'arg-haupt-wahl', title: 'Hauptwert wählen — sonst Punkte-Abzug',                                                      dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['kart-zu-polar'],
        1: ['mult-polar-pr'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['kart-zu-polar'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kart-zu-polar'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['kart-zu-polar'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kart-zu-polar'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['kart-zu-polar'],                  qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['mult-polar-pr'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mult-polar-pr'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['mult-polar-pr'],                  qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mult-polar-pr'],                  qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['mult-polar-pr'],                  qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['div-polar-pr'],                   qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['div-polar-pr'],                   qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['div-polar-pr'],                   qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['div-polar-pr'],                   qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['div-polar-pr'],                   qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['quadr-merker'],                   qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['quadr-merker'],                   qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['quadr-merker'],                   qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['quadr-merker'],                   qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'matching',        uses: ['quadr-merker'],                   qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['arg-haupt-wahl'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['arg-haupt-wahl'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['arg-haupt-wahl'],                 qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['arg-haupt-wahl'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['arg-haupt-wahl'],                 qty: 1 },
      ],
    },
  }),
  ...
  makeLesson({
    ...
    subGoals: [
      { label: 'Gleichung $z^n = w$: **alle $n$** Wurzeln angeben (Fundamentalsatz)', examRelevance: 'hoch' },
      { label: 'Wurzelformel in Polarform $w = r e^{i\\varphi}$: $z_k = r^{1/n} e^{i(\\varphi + 2\\pi k)/n}$', examRelevance: 'hoch' },
      { label: 'Impedanz-Gesamt bei Reihe: $Z = R + i\\omega L - i/(\\omega C)$', examRelevance: 'hoch' },
      { label: 'Scheinwiderstand $|Z| = \\sqrt{R^2 + X^2}$ mit Reaktanz $X = \\omega L - 1/(\\omega C)$', examRelevance: 'hoch' },
      { label: 'Resonanz: $\\omega_0 = 1/\\sqrt{LC}$ (Imaginärteil der Impedanz = 0)', examRelevance: 'hoch' },
      { label: 'Phasenwinkel $\\arg(Z) = \\arctan(X/R)$: Spannungs- vs. Stromphasenlage', examRelevance: 'mittel' },
    ],
    createdAt: '2026-04-16',
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'komz-2-1', concepts: ['polarform', 'argument', 'betrag-c'] },
        { lessonId: 'komz-3-2', concepts: ['wurzel-formel', 'wurzel-anzahl'] },
        { lessonId: 'komz-pruefung-1', concepts: ['impedanz-et'] },
      ],
      concepts: [
        { id: 'gl-zn-w',       title: 'Gleichung $z^n=w$: alle $n$ Wurzeln angeben',                                              dependsOn: [] },
        { id: 'wurzel-polar',  title: 'Wurzelformel in Polarform $w=r e^{i\\varphi}$: $z_k=r^{1/n}e^{i(\\varphi+2\\pi k)/n}$',     dependsOn: ['gl-zn-w'] },
        { id: 'imp-reihe',     title: 'Impedanz Reihe: $Z=R+i\\omega L-i/(\\omega C)$',                                              dependsOn: [] },
        { id: 'scheinwid',     title: 'Scheinwiderstand $|Z|=\\sqrt{R^2+X^2}$ mit $X=\\omega L-1/(\\omega C)$',                     dependsOn: ['imp-reihe'] },
        { id: 'resonanz',      title: 'Resonanz: $\\omega_0=1/\\sqrt{LC}$ ($\\operatorname{Im} Z=0$)',                               dependsOn: ['imp-reihe'] },
        { id: 'phasenwinkel',  title: 'Phase $\\arg Z=\\arctan(X/R)$',                                                              dependsOn: ['imp-reihe'] },
      ],
      subGoalConcepts: {
        0: ['gl-zn-w'],
        1: ['wurzel-polar'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['gl-zn-w'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gl-zn-w'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['gl-zn-w'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gl-zn-w'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['gl-zn-w'],                  qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['wurzel-polar'],             qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wurzel-polar'],             qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['wurzel-polar'],             qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wurzel-polar'],             qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['wurzel-polar'],             qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['imp-reihe'],                qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['imp-reihe'],                qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['imp-reihe'],                qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['imp-reihe'],                qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['imp-reihe'],                qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['scheinwid'],                qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['scheinwid'],                qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['scheinwid'],                qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['scheinwid'],                qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['scheinwid'],                qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['resonanz'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['resonanz'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['resonanz'],                 qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['resonanz'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['resonanz'],                 qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['phasenwinkel'],             qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['phasenwinkel'],             qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['phasenwinkel'],             qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['phasenwinkel'],             qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['phasenwinkel'],             qty: 1 },
      ],
    },
  }),
]
