  ...
  lessons: [
    makeLesson({
      ...
      blueprint: {
        prerequisites: [],
        concepts: [
          { id: 'part-abl',     title: 'Partielle Ableitung: nach einer Variable, andere als Konstanten',                    dependsOn: [] },
          { id: 'part-schreib', title: 'Schreibweisen $f_x$, $\\partial f/\\partial x$, $D_x f$ gleichwertig',                  dependsOn: ['part-abl'] },
          { id: 'gradient',     title: 'Gradient $\\nabla f=(f_x,f_y)^T$ — Richtung steilsten Anstiegs',                       dependsOn: ['part-abl'] },
          { id: 'grad-niveau',  title: 'Gradient $\\perp$ Höhenlinie — Normale an Niveaumengen',                                dependsOn: ['gradient'] },
          { id: 'schwarz',      title: 'Satz von Schwarz: $f_{xy}=f_{yx}$ (bei stetigen 2. Ableitungen)',                        dependsOn: ['part-abl'] },
        ],
        subGoalConcepts: {
          0: ['part-abl'],
          1: ['part-schreib'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['part-abl'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['part-abl'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['part-abl'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['part-abl'],          qty: 1, note: 'Andere Variable mit abgeleitet' },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['part-abl'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['part-schreib'],      qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['part-schreib'],      qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['part-schreib'],      qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['part-schreib'],      qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['part-schreib'],      qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['gradient'],          qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gradient'],          qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['gradient'],          qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gradient'],          qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['gradient'],          qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['grad-niveau'],       qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['grad-niveau'],       qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['grad-niveau'],       qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['grad-niveau'],       qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['grad-niveau'],       qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['schwarz'],           qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['schwarz'],           qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['schwarz'],           qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['schwarz'],           qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['schwarz'],           qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'mdim-1-1', concepts: ['part-abl', 'gradient', 'schwarz'] },
        ],
        concepts: [
          { id: 'krit-punkt',     title: 'Notwendige Bedingung Extremum: $\\nabla f=0$ (kritischer Punkt)',                          dependsOn: [] },
          { id: 'hesse',          title: 'Hesse-Matrix $H$ — symmetrisch (Schwarz)',                                                  dependsOn: ['krit-punkt'] },
          { id: 'hesse-test',     title: '$\\det H>0,f_{xx}>0$ Min; $\\det H>0,f_{xx}<0$ Max; $\\det H<0$ Sattel',                    dependsOn: ['hesse'] },
          { id: 'lagrange',       title: 'Lagrange: $\\nabla f=\\lambda\\nabla g$ bei Nebenbedingung $g=0$',                          dependsOn: [] },
          { id: 'lagrange-sys',   title: 'Lagrange-System: $\\nabla f-\\lambda\\nabla g=0$ UND $g=0$ gemeinsam lösen',                dependsOn: ['lagrange'] },
        ],
        subGoalConcepts: {
          0: ['krit-punkt'],
          1: ['hesse'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['krit-punkt'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['krit-punkt'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['krit-punkt'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['krit-punkt'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['krit-punkt'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['hesse'],               qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['hesse'],               qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['hesse'],               qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['hesse'],               qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['hesse'],               qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['hesse-test'],          qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['hesse-test'],          qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['hesse-test'],          qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['hesse-test'],          qty: 1, note: 'Definitheit verkehrt interpretiert' },
          { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['hesse-test'],          qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['lagrange'],            qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lagrange'],            qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['lagrange'],            qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lagrange'],            qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['lagrange'],            qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['lagrange-sys'],        qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lagrange-sys'],        qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['lagrange-sys'],        qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lagrange-sys'],        qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['lagrange-sys'],        qty: 1 },
        ],
      },
    }),
  ],
...
const unit2 = makeUnit({
  ...
  lessons: [
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'mdim-1-1', concepts: ['part-abl', 'gradient'] },
          { lessonId: 'mdim-1-2', concepts: ['krit-punkt', 'hesse-test', 'lagrange'] },
        ],
        concepts: [
          { id: 'krit-pr',     title: 'Kritische Stellen $\\nabla f=\\vec 0$',                                                       dependsOn: [] },
          { id: 'hesse-pr',    title: 'Hesse $\\det H>0,f_{xx}>0$ Min, $\\det H>0,f_{xx}<0$ Max',                                     dependsOn: [] },
          { id: 'sattel',      title: 'Sattelpunkt $\\det H<0$ — indefinit',                                                          dependsOn: ['hesse-pr'] },
          { id: 'fehler-lin',  title: 'Fehlerfortpflanzung linear: $\\Delta f\\approx\\sum|f_{x_i}|\\Delta x_i$',                      dependsOn: [] },
          { id: 'gauss-fehler', title: 'Gaußsche Fehlerfortpflanzung: $\\sigma_f^2=\\sum f_{x_i}^2\\sigma_i^2$',                       dependsOn: [] },
          { id: 'lagrange-pr', title: 'Lagrange $\\nabla f=\\lambda\\nabla g$ bei NB',                                                 dependsOn: [] },
        ],
        subGoalConcepts: {
          0: ['krit-pr'],
          1: ['hesse-pr'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['krit-pr'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['krit-pr'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['krit-pr'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['krit-pr'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['krit-pr'],          qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['hesse-pr'],         qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['hesse-pr'],         qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['hesse-pr'],         qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['hesse-pr'],         qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['hesse-pr'],         qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['sattel'],           qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sattel'],           qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['sattel'],           qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sattel'],           qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['sattel'],           qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['fehler-lin'],       qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fehler-lin'],       qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['fehler-lin'],       qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fehler-lin'],       qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['fehler-lin'],       qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['gauss-fehler'],     qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gauss-fehler'],     qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['gauss-fehler'],     qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gauss-fehler'],     qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['gauss-fehler'],     qty: 1 },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['lagrange-pr'],      qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lagrange-pr'],      qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['lagrange-pr'],      qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lagrange-pr'],      qty: 1 },
          { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['lagrange-pr'],      qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'mdim-1-1', concepts: ['part-abl', 'gradient'] },
          { lessonId: 'mdim-pruefung-1', concepts: ['fehler-lin', 'gauss-fehler'] },
        ],
        concepts: [
          { id: 'totales-diff', title: 'Totales Differential $df=f_x dx+f_y dy+\\ldots$',                                       dependsOn: [] },
          { id: 'max-fehler',   title: 'Maximaler Fehler (linear): $|\\Delta f|\\le\\sum|f_{x_i}||\\Delta x_i|$',                dependsOn: ['totales-diff'] },
          { id: 'gauss-stat',   title: 'Gaußsche statistische: $\\sigma_f=\\sqrt{\\sum f_{x_i}^2\\sigma_{x_i}^2}$',              dependsOn: ['totales-diff'] },
          { id: 'rel-fehler',   title: 'Relativer Fehler bei Produkten: $|\\Delta f/f|\\le\\sum|\\Delta x_i/x_i|$',              dependsOn: ['max-fehler'] },
          { id: 'dom-fehler',   title: 'Dominante Fehlerquelle: größter $f_{x_i}\\Delta x_i$ → dort zuerst verbessern',         dependsOn: ['max-fehler'] },
        ],
        subGoalConcepts: {
          0: ['totales-diff'],
          1: ['max-fehler'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['totales-diff'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['totales-diff'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['totales-diff'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['totales-diff'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['totales-diff'],          qty: 1 },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['max-fehler'],            qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['max-fehler'],            qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['max-fehler'],            qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['max-fehler'],            qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['max-fehler'],            qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['gauss-stat'],            qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gauss-stat'],            qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['gauss-stat'],            qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gauss-stat'],            qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['gauss-stat'],            qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['rel-fehler'],            qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rel-fehler'],            qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['rel-fehler'],            qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rel-fehler'],            qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['rel-fehler'],            qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['dom-fehler'],            qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['dom-fehler'],            qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['dom-fehler'],            qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['dom-fehler'],            qty: 1 },
          { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['dom-fehler'],            qty: 1 },
        ],
      },
    }),
    makeLesson({
      ...
      blueprint: {
        prerequisites: [
          { lessonId: 'mdim-1-1', concepts: ['gradient'] },
          { lessonId: 'mdim-1-2', concepts: ['hesse-test', 'lagrange-sys'] },
        ],
        concepts: [
          { id: 'lag-lgs',     title: 'Lagrange-LGS: $f_x=\\lambda g_x$, $f_y=\\lambda g_y$, $g=0$ (3 Gl.)',                       dependsOn: [] },
          { id: 'hesse-d',     title: 'Hesse-Diskriminante $D=f_{xx}f_{yy}-f_{xy}^2$',                                              dependsOn: [] },
          { id: 'd-null',      title: 'Bei $D=0$ keine Entscheidung via Hesse — höhere Ordnungen',                                 dependsOn: ['hesse-d'] },
          { id: 'mehrere-nb',  title: 'Mehrere Nebenbedingungen: $\\nabla f=\\sum\\lambda_i\\nabla g_i$',                            dependsOn: [] },
          { id: 'richt-abl',   title: 'Richtungsableitung $D_{\\vec u}f=\\nabla f\\cdot\\vec u/|\\vec u|$',                          dependsOn: [] },
          { id: 'grad-betrag', title: 'Gradient zeigt steilsten Anstieg, Betrag = max. Steigung',                                   dependsOn: ['richt-abl'] },
        ],
        subGoalConcepts: {
          0: ['lag-lgs'],
          1: ['hesse-d'],
        ...
        taskPlan: [
          { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['lag-lgs'],          qty: 1 },
          { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lag-lgs'],          qty: 1 },
          { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['lag-lgs'],          qty: 1 },
          { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lag-lgs'],          qty: 1 },
          { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['lag-lgs'],          qty: 1, note: '[PRÜFUNG]' },
          { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['hesse-d'],          qty: 1 },
          { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['hesse-d'],          qty: 1 },
          { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['hesse-d'],          qty: 1 },
          { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['hesse-d'],          qty: 1 },
          { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['hesse-d'],          qty: 1 },
          { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['d-null'],           qty: 1 },
          { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['d-null'],           qty: 1 },
          { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['d-null'],           qty: 1 },
          { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['d-null'],           qty: 1 },
          { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['d-null'],           qty: 1 },
          { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['mehrere-nb'],       qty: 1 },
          { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mehrere-nb'],       qty: 1 },
          { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['mehrere-nb'],       qty: 1 },
          { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mehrere-nb'],       qty: 1 },
          { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['mehrere-nb'],       qty: 1 },
          { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['richt-abl'],        qty: 1 },
          { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['richt-abl'],        qty: 1 },
          { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['richt-abl'],        qty: 1 },
          { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['richt-abl'],        qty: 1, note: 'Richtungsvektor nicht normiert' },
          { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['richt-abl'],        qty: 1 },
          { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['grad-betrag'],      qty: 1 },
          { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['grad-betrag'],      qty: 1 },
          { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['grad-betrag'],      qty: 1 },
          { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['grad-betrag'],      qty: 1 },
          { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['grad-betrag'],      qty: 1 },
        ],
      },
    }),
  ],
