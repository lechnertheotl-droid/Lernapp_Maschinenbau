...
const lessons_la_u2 = [
  // ── Lesson 1: LGS in Matrixform ────────────────────────────────────────────
  {
    ...
    blueprint: {
      ...
      concepts: [
        { id: 'matrixform-lgs', title: 'Matrixform $A\\vec x=\\vec b$',                                                            dependsOn: [] },
        { id: 'erweiterte-mat', title: 'Erweiterte Koeffizientenmatrix $[A|\\vec b]$ mit Trennstrich',                              dependsOn: ['matrixform-lgs'] },
        { id: 'lgs-reihenfolge', title: 'Variablen in jeder Gleichung gleiche Reihenfolge — sonst Koeffizienten falsch',           dependsOn: ['matrixform-lgs'] },
        { id: 'lgs-dimensionen', title: '$A\\in\\mathbb R^{m\\times n}$, $\\vec x\\in\\mathbb R^n$, $\\vec b\\in\\mathbb R^m$',     dependsOn: ['matrixform-lgs'] },
        { id: 'homogen-lgs',    title: 'Homogenes LGS $\\vec b=\\vec 0$ — triviale Lösung $\\vec x=\\vec 0$ existiert immer',       dependsOn: ['matrixform-lgs'] },
      ],
      subGoalConcepts: {
        0: ['matrixform-lgs'],
        1: ['erweiterte-mat'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['matrixform-lgs'],          qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['matrixform-lgs'],          qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['matrixform-lgs'],          qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['matrixform-lgs'],          qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['matrixform-lgs'],          qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['erweiterte-mat'],          qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['erweiterte-mat'],          qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['erweiterte-mat'],          qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['erweiterte-mat'],          qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['erweiterte-mat'],          qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['lgs-reihenfolge'],         qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lgs-reihenfolge'],         qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['lgs-reihenfolge'],         qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lgs-reihenfolge'],         qty: 1, note: 'Variablen in falscher Reihenfolge' },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['lgs-reihenfolge'],         qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['lgs-dimensionen'],         qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['lgs-dimensionen'],         qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['lgs-dimensionen'],         qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['lgs-dimensionen'],         qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['lgs-dimensionen'],         qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['homogen-lgs'],             qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['homogen-lgs'],             qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['homogen-lgs'],             qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['homogen-lgs'],             qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['homogen-lgs'],             qty: 1 },
      ],
    },
    steps: [
      {
...
**Tipp:** Achte darauf, dass die Variablen in jeder Gleichung in der gleichen Reihenfolge stehen, bevor du die Matrix aufstellst!`,
  ...
  // ── Lesson 2: Gauss-Algorithmus ─────────────────────────────────────────────
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'la-1-3', concepts: ['inv-existenz', 'inv-eigenschaft'] },
        { lessonId: 'la-2-1', concepts: ['matrixform-lgs', 'erweiterte-mat'] },
      ],
      concepts: [
        { id: 'zeilen-umform',  title: 'Zeilenumformungen: Vertauschen, Skalieren ($\\neq 0$), Addieren eines Vielfachen',         dependsOn: [] },
        { id: 'stufenform',     title: 'Ziel: obere Dreiecks-/Stufenform — alle Einträge unter Pivot $=0$',                          dependsOn: ['zeilen-umform'] },
        { id: 'rueckwaerts',    title: 'Rücksubstitution: von unten nach oben Variable für Variable',                                dependsOn: ['stufenform'] },
        { id: 'pivotierung',    title: 'Pivotierung: bei $a_{ii}=0$ Zeile tauschen — sonst Division durch 0',                        dependsOn: ['zeilen-umform'] },
        { id: 'gauss-jordan',   title: 'Gauss-Jordan: zusätzlich über Pivots nullen → reduzierte Stufenform',                        dependsOn: ['stufenform'] },
        { id: 'inverse-gauss',  title: 'Matrix-Inversion: $[A|I]\\to[I|A^{-1}]$',                                                     dependsOn: ['gauss-jordan'] },
      ],
      subGoalConcepts: {
        0: ['zeilen-umform'],
        1: ['stufenform'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['zeilen-umform'],     qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['zeilen-umform'],     qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['zeilen-umform'],     qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['zeilen-umform'],     qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['zeilen-umform'],     qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['stufenform'],        qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['stufenform'],        qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['stufenform', 'zeilen-umform'], qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['stufenform'],        qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'sorting',         uses: ['stufenform'],        qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['rueckwaerts'],       qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rueckwaerts'],       qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['rueckwaerts'],       qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rueckwaerts'],       qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['rueckwaerts'],       qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['pivotierung'],       qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pivotierung'],       qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['pivotierung'],       qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pivotierung'],       qty: 1, note: 'Pivot 0 vergessen' },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['pivotierung'],       qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['gauss-jordan'],      qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['gauss-jordan'],      qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['gauss-jordan'],      qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['gauss-jordan'],      qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['gauss-jordan'],      qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['inverse-gauss'],     qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['inverse-gauss'],     qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['inverse-gauss'],     qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['inverse-gauss'],     qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['inverse-gauss'],     qty: 1 },
      ],
    },
    steps: [
      {
...
**Für größere Systeme** (3x3, 4x4, ...): Das gleiche Prinzip! Erst Spalte 1 "sauber machen" (überall 0 unter dem Pivot), dann Spalte 2, usw.`,
  ...
  // ── Lesson 3: Lösbarkeit ───────────────────────────────────────────────────
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'la-2-1', concepts: ['matrixform-lgs', 'erweiterte-mat'] },
        { lessonId: 'la-2-2', concepts: ['stufenform'] },
      ],
      concepts: [
        { id: 'drei-faelle',    title: 'Drei Fälle: eindeutig / unendlich / keine Lösung (Widerspruch)',                          dependsOn: [] },
        { id: 'rang',           title: 'Rang = Anzahl Pivots in Stufenform',                                                       dependsOn: [] },
        { id: 'kronecker',      title: 'Kronecker-Capelli: $\\operatorname{rg}(A)\\neq\\operatorname{rg}([A|b])$ → keine Lösung',  dependsOn: ['rang'] },
        { id: 'eindeutig-bed',  title: 'Eindeutig: $\\operatorname{rg}(A)=\\operatorname{rg}([A|b])=n$',                            dependsOn: ['rang', 'kronecker'] },
        { id: 'unendlich-bed',  title: 'Unendlich: $\\operatorname{rg}(A)=\\operatorname{rg}([A|b])<n$, freie Parameter $=n-\\operatorname{rg}(A)$', dependsOn: ['rang'] },
        { id: 'geom-2d',        title: 'Geometrisch (2D): Geraden schneidend / identisch / parallel',                              dependsOn: ['drei-faelle'] },
      ],
      subGoalConcepts: {
        0: ['drei-faelle'],
        1: ['rang'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['drei-faelle'],     qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['drei-faelle'],     qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['drei-faelle'],     qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['drei-faelle'],     qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['drei-faelle'],     qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['rang'],            qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rang'],            qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['rang'],            qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rang'],            qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['rang'],            qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['kronecker'],       qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kronecker'],       qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['kronecker'],       qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kronecker'],       qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['kronecker'],       qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['eindeutig-bed'],   qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['eindeutig-bed'],   qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['eindeutig-bed'],   qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['eindeutig-bed'],   qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['eindeutig-bed'],   qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['unendlich-bed'],   qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['unendlich-bed'],   qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['unendlich-bed'],   qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['unendlich-bed'],   qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['unendlich-bed'],   qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['geom-2d'],         qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['geom-2d'],         qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['geom-2d'],         qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['geom-2d'],         qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'matching',        uses: ['geom-2d', 'drei-faelle'], qty: 1 },
      ],
    },
    steps: [
      {
...
- Rang < Anzahl Unbekannte: unendlich viele Lösungen`,
  ...
  // ── Lesson 4: Cramersche Regel & Anwendungen ───────────────────────────────
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'la-1-4', concepts: ['det-2x2', 'det-laplace', 'det-singular'] },
        { lessonId: 'la-2-1', concepts: ['matrixform-lgs'] },
        { lessonId: 'la-2-3', concepts: ['eindeutig-bed'] },
      ],
      concepts: [
        { id: 'cramer-formel', title: 'Cramer: $x_i=\\det(A_i)/\\det(A)$, $A_i$ = $A$ mit $i$-ter Spalte durch $\\vec b$ ersetzt',  dependsOn: [] },
        { id: 'cramer-vorauss', title: 'Voraussetzung: $\\det A\\neq 0$',                                                            dependsOn: ['cramer-formel'] },
        { id: 'cramer-quadrat', title: 'Nur quadratisches System mit eindeutiger Lösung',                                            dependsOn: ['cramer-vorauss'] },
        { id: 'cramer-aufwand', title: 'Effizienz: ab $n>4$ Gauss überlegen ($n!$ Determinanten)',                                   dependsOn: ['cramer-formel'] },
        { id: 'cramer-anwend',  title: 'Technik: Kräftegleichgewicht, Knotenspannungsanalyse',                                       dependsOn: ['cramer-formel'] },
      ],
      subGoalConcepts: {
        0: ['cramer-formel'],
        1: ['cramer-vorauss'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['cramer-formel'],     qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['cramer-formel'],     qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['cramer-formel'],     qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['cramer-formel'],     qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['cramer-formel'],     qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['cramer-vorauss'],    qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['cramer-vorauss'],    qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['cramer-vorauss'],    qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['cramer-vorauss'],    qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['cramer-vorauss'],    qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['cramer-quadrat'],    qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['cramer-quadrat'],    qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['cramer-quadrat'],    qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['cramer-quadrat'],    qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['cramer-quadrat'],    qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['cramer-aufwand'],    qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['cramer-aufwand'],    qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['cramer-aufwand'],    qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['cramer-aufwand'],    qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['cramer-aufwand'],    qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['cramer-anwend'],     qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['cramer-anwend'],     qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['cramer-anwend', 'cramer-formel'], qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['cramer-anwend'],     qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['cramer-anwend'],     qty: 1 },
      ],
    },
    steps: [
      {
