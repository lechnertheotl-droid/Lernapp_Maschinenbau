...
const lessons_la_u3 = [
  {
    ...
    subGoals: [
      { label: 'Matrixmultiplikation Zeile × Spalte — $AB \\neq BA$ im Allgemeinen', examRelevance: 'hoch' },
      { label: 'Laplace-Entwicklung: $\\det A = \\sum_j (-1)^{i+j} a_{ij} M_{ij}$ (beliebige Zeile/Spalte)', examRelevance: 'hoch' },
      { label: 'Inverse-Test: $A^{-1}$ existiert $\\iff \\det A \\neq 0 \\iff \\text{rg}(A) = n$', examRelevance: 'hoch' },
      { label: 'Rang via Gauss: Zeilenstufenform → Anzahl Nicht-Null-Zeilen', examRelevance: 'hoch' },
      { label: 'Äquivalenzkette: $A$ invertierbar $\\iff \\det \\neq 0 \\iff \\text{rg} = n \\iff A\\vec x = \\vec b$ eindeutig', examRelevance: 'hoch' },
      { label: 'Parameteraufgabe: $A(\\lambda)$, Werte für $\\lambda$ finden, bei denen $\\det = 0$', examRelevance: 'mittel' },
    ],
    prerequisites: [],
    nextLessonId: 'la-3-2',
    blueprint: {
      prerequisites: [
        { lessonId: 'la-1-2', concepts: ['matrix-mult', 'mult-nicht-komm'] },
        { lessonId: 'la-1-3', concepts: ['inv-existenz'] },
        { lessonId: 'la-1-4', concepts: ['det-2x2', 'det-laplace', 'det-singular'] },
        { lessonId: 'la-2-3', concepts: ['rang', 'eindeutig-bed'] },
      ],
      concepts: [
        { id: 'pr-mult',         title: 'Matrixmultiplikation Zeile × Spalte; $AB\\neq BA$ allgemein',                              dependsOn: [] },
        { id: 'pr-laplace',      title: 'Laplace-Entwicklung mit Vorzeichen-Schachbrett',                                            dependsOn: [] },
        { id: 'pr-inv-test',     title: 'Inverse-Test: $A^{-1}$ existiert $\\iff\\det A\\neq 0\\iff\\operatorname{rg}(A)=n$',         dependsOn: [] },
        { id: 'pr-rang-gauss',   title: 'Rang via Gauss: Anzahl Nicht-Null-Zeilen in Stufenform',                                    dependsOn: [] },
        { id: 'aequivalenz-kette', title: '$A$ invertierbar $\\iff\\det\\neq 0\\iff\\operatorname{rg}=n\\iff A\\vec x=\\vec b$ eindeutig', dependsOn: ['pr-inv-test', 'pr-rang-gauss'] },
        { id: 'param-det',       title: 'Parameteraufgabe: $A(\\lambda)$ — Werte mit $\\det=0$ finden',                               dependsOn: ['pr-laplace'] },
      ],
      subGoalConcepts: {
        0: ['pr-mult'],
        1: ['pr-laplace'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['pr-mult'],          qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-mult'],          qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['pr-mult'],          qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-mult'],          qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['pr-mult'],          qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['pr-laplace'],       qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-laplace'],       qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['pr-laplace'],       qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-laplace'],       qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['pr-laplace'],       qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['pr-inv-test'],      qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-inv-test'],      qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['pr-inv-test'],      qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-inv-test'],      qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['pr-inv-test'],      qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['pr-rang-gauss'],    qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pr-rang-gauss'],    qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['pr-rang-gauss'],    qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pr-rang-gauss'],    qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['pr-rang-gauss'],    qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['aequivalenz-kette'], qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['aequivalenz-kette'], qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'multiple-choice', uses: ['aequivalenz-kette'], qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['aequivalenz-kette'], qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'matching',        uses: ['aequivalenz-kette'], qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['param-det'],         qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['param-det'],         qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['param-det'],         qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['param-det'],         qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['param-det'],         qty: 1, note: '[PRÜFUNG]' },
      ],
    },
    steps: [
      {
...
**Merke:** $A$ invertierbar $\\Leftrightarrow$ $\\det(A) \\neq 0$ $\\Leftrightarrow$ $\\text{rang}(A) = n$ $\\Leftrightarrow$ $A\\vec{x} = \\vec{b}$ hat genau eine Lösung.`,
  ...
  },
  {
    ...
    subGoals: [
      { label: 'Rouché-Capelli-Kriterium: $\\text{rg}(A) = \\text{rg}([A|b])$ für Lösbarkeit', examRelevance: 'hoch' },
      { label: 'Freie Variablen = $n - \\text{rg}(A)$ (Parametrisierung der Lösungsmenge)', examRelevance: 'hoch' },
      { label: 'Eigenwerte via $\\det(A - \\lambda I) = 0$', examRelevance: 'hoch' },
      { label: 'Eigenvektor: Kern von $(A - \\lambda I)$, normieren falls gefordert', examRelevance: 'hoch' },
      { label: 'Spur = $\\sum \\lambda_i$, Determinante = $\\prod \\lambda_i$ (Quercheck!)', examRelevance: 'hoch' },
      { label: 'Defekt: algebraische Vielfachheit > geometrische → nicht diagonalisierbar', examRelevance: 'mittel' },
    ],
    prerequisites: [],
    nextLessonId: 'la-3-3',
    blueprint: {
      prerequisites: [
        { lessonId: 'la-1-5', concepts: ['ew-glg', 'char-poly', 'eigenvektor', 'spur-det-ew'] },
        { lessonId: 'la-2-3', concepts: ['kronecker', 'eindeutig-bed', 'unendlich-bed', 'rang'] },
      ],
      concepts: [
        { id: 'rouche-cap',     title: 'Rouché-Capelli: $\\operatorname{rg}(A)=\\operatorname{rg}([A|b])$ für Lösbarkeit',          dependsOn: [] },
        { id: 'freie-vars',     title: 'Freie Variablen $=n-\\operatorname{rg}(A)$ — Parametrisierung der Lösungsmenge',             dependsOn: [] },
        { id: 'ew-pr',          title: 'Eigenwerte via $\\det(A-\\lambda I)=0$',                                                     dependsOn: [] },
        { id: 'ev-pr',          title: 'Eigenvektor: Kern von $(A-\\lambda I)$, normieren falls gefordert',                         dependsOn: ['ew-pr'] },
        { id: 'spur-det-quer',  title: 'Quercheck: Spur $=\\sum\\lambda_i$, $\\det=\\prod\\lambda_i$',                               dependsOn: ['ew-pr'] },
        { id: 'defekt-vielfh',  title: 'Defekt: algebr. Vielfachheit > geometr. → nicht diagonalisierbar',                          dependsOn: ['ev-pr'] },
      ],
      subGoalConcepts: {
        0: ['rouche-cap'],
        1: ['freie-vars'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['rouche-cap'],          qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rouche-cap'],          qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['rouche-cap'],          qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rouche-cap'],          qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['rouche-cap'],          qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['freie-vars'],          qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['freie-vars'],          qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['freie-vars'],          qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['freie-vars'],          qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['freie-vars'],          qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['ew-pr'],               qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['ew-pr'],               qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['ew-pr'],               qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['ew-pr'],               qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['ew-pr'],               qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['ev-pr'],               qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['ev-pr'],               qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['ev-pr'],               qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['ev-pr'],               qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['ev-pr'],               qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['spur-det-quer'],       qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['spur-det-quer'],       qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['spur-det-quer'],       qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['spur-det-quer'],       qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['spur-det-quer'],       qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['defekt-vielfh'],       qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['defekt-vielfh'],       qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['defekt-vielfh'],       qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['defekt-vielfh'],       qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['defekt-vielfh'],       qty: 1 },
      ],
    },
    steps: [
      {
...
- $\\det(A) = 0 \\Leftrightarrow$ 0 ist ein Eigenwert `,
  ...
  },
  {
    ...
    subGoals: [
      { label: 'Diagonalisierung: $A = PDP^{-1}$ mit $P = $ EV-Matrix, $D = \\text{diag}(\\lambda_i)$', examRelevance: 'hoch' },
      { label: 'Bedingung: $n$ linear unabhängige Eigenvektoren (algebr. = geom. Vielfachheit)', examRelevance: 'hoch' },
      { label: 'Matrixpotenzen via $A^k = P D^k P^{-1}$ (nur Diagonale potenzieren!)', examRelevance: 'hoch' },
      { label: 'Spektralsatz (symm. Matrix): reelle EW, orthogonale EV, $A = Q D Q^T$ mit $Q$ orthogonal', examRelevance: 'hoch' },
      { label: 'Technik: Hauptträgheitsachsen, Hauptspannungen, Eigenfrequenzen, Stabilität ($|\\lambda| < 1$)', examRelevance: 'hoch' },
      { label: 'Defekte Matrix: nicht diagonalisierbar → Jordan-Normalform (Vertiefung)', examRelevance: 'mittel' },
    ],
    prerequisites: [],
    nextLessonId: null,
    blueprint: {
      prerequisites: [
        ...
        { lessonId: 'la-1-5', concepts: ['ew-glg', 'eigenvektor', 'sym-ew'] },
        { lessonId: 'la-3-2', concepts: ['ev-pr', 'defekt-vielfh'] },
      ],
      concepts: [
        { id: 'diagonalis',     title: 'Diagonalisierung $A=PDP^{-1}$ mit $P=$ EV-Matrix, $D=\\operatorname{diag}(\\lambda_i)$',     dependsOn: [] },
        { id: 'diag-bedingung', title: 'Bedingung: $n$ linear unabhängige Eigenvektoren (algebr. = geom. Vielfachheit)',            dependsOn: ['diagonalis'] },
        { id: 'matrix-pot',     title: 'Matrixpotenzen $A^k=PD^k P^{-1}$ (nur Diagonale potenzieren)',                              dependsOn: ['diagonalis'] },
        { id: 'spektral',       title: 'Spektralsatz (symm.): $A=QDQ^T$ mit $Q$ orthogonal',                                         dependsOn: ['diagonalis'] },
        { id: 'tech-anwend-pr', title: 'Anwendungen: Hauptträgheitsachsen, Hauptspannungen, Eigenfrequenzen, Stabilität',           dependsOn: [] },
        { id: 'jordan',         title: 'Defekte Matrix: nicht diagonalisierbar → Jordan-Normalform (Vertiefung)',                    dependsOn: ['diag-bedingung'] },
      ],
      subGoalConcepts: {
        0: ['diagonalis'],
        1: ['diag-bedingung'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['diagonalis'],          qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['diagonalis'],          qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['diagonalis'],          qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['diagonalis'],          qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['diagonalis'],          qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['diag-bedingung'],      qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['diag-bedingung'],      qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['diag-bedingung'],      qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['diag-bedingung'],      qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'multiple-choice', uses: ['diag-bedingung'],      qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['matrix-pot'],          qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['matrix-pot'],          qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['matrix-pot'],          qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['matrix-pot'],          qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['matrix-pot'],          qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['spektral'],            qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['spektral'],            qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['spektral'],            qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['spektral'],            qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['spektral'],            qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['tech-anwend-pr'],      qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['tech-anwend-pr'],      qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['tech-anwend-pr'],      qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['tech-anwend-pr'],      qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['tech-anwend-pr'],      qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['jordan'],              qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['jordan'],              qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['jordan'],              qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['jordan'],              qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['jordan'],              qty: 1 },
      ],
    },
    steps: [
      {
