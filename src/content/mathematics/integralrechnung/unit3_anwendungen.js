...
const lessons_int_u3 = [
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'int-1-4', concepts: ['hauptsatz-12', 'geom-flaeche'] },
        { lessonId: 'int-1-2', concepts: ['int-pot-regel'] },
      ],
      concepts: [
        { id: 'flaeche-pos',     title: 'Fläche unter $f\\geq 0$: $A=\\int_a^b f(x)dx$',                                 dependsOn: [] },
        { id: 'flaeche-neg',     title: 'Bei $f<0$: Integral negativ → Fläche = Betrag',                                  dependsOn: ['flaeche-pos'] },
        { id: 'flaeche-zwischen', title: 'Fläche zwischen Kurven: $\\int_a^b(f_{\\text{oben}}-f_{\\text{unten}})dx$',     dependsOn: [] },
        { id: 'flaeche-grenzen', title: 'Schnittpunkte als Integrationsgrenzen: $f(x)=g(x)$ lösen',                       dependsOn: ['flaeche-zwischen'] },
        { id: 'flaeche-split',   title: 'Bei VZ-Wechsel Nullstellen finden, in Teilintervalle splitten',                   dependsOn: ['flaeche-neg'] },
        { id: 'flaeche-horiz',   title: 'Fläche $y=$ const ↔ Kurve: Horizontalstreifen oder Transformation',              dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['flaeche-pos'],
        1: ['flaeche-neg'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-pos'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-pos'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['flaeche-pos'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-pos'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-pos'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-neg'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-neg'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['flaeche-neg'],                  qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-neg'],                  qty: 1, note: 'Negativen Wert als Fläche akzeptiert' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-neg'],                  qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-zwischen'],             qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-zwischen'],             qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['flaeche-zwischen'],             qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-zwischen'],             qty: 1, note: 'oben/unten verwechselt' },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-zwischen'],             qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-grenzen'],              qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-grenzen'],              qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['flaeche-grenzen', 'flaeche-zwischen'], qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-grenzen'],              qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-grenzen', 'flaeche-zwischen'], qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-split'],                qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-split'],                qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['flaeche-split'],                qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-split'],                qty: 1, note: 'Nullstellen nicht gesucht' },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-split'],                qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['flaeche-horiz'],                qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaeche-horiz'],                qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['flaeche-horiz'],                qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaeche-horiz'],                qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['flaeche-horiz'],                qty: 1 },
      ],
    },
    steps: [
      {
...
$$A = \\int_{0}^{1} (x - x^{2})\\,dx = \\left[\\frac{x^{2}}{2} - \\frac{x^{3}}{3}\\right]_{0}^{1} = \\frac{1}{2} - \\frac{1}{3} = \\frac{1}{6}$$`,
  ...
  },
  {
    ...
    blueprint: {
      ...
      concepts: [
        { id: 'scheiben-x',    title: 'Scheibenmethode ($x$-Achse): $V=\\pi\\int_a^b[f(x)]^2dx$',                          dependsOn: [] },
        { id: 'rotation-y',    title: 'Rotation um $y$-Achse: $V=\\pi\\int_c^d[g(y)]^2dy$ (Umkehrfunktion)',                dependsOn: ['scheiben-x'] },
        { id: 'schalen',       title: 'Schalenmethode: $V=2\\pi\\int_a^b x\\cdot f(x)dx$ (Rotation um $y$-Achse)',          dependsOn: [] },
        { id: 'mantelflaeche', title: 'Mantelfläche: $M=2\\pi\\int_a^b f(x)\\sqrt{1+[f\'(x)]^2}dx$',                        dependsOn: [] },
        { id: 'std-volumina',  title: 'Standardvolumina aus Integralen: Kegel $\\pi r^2 h/3$, Kugel $4\\pi r^3/3$, Zylinder $\\pi r^2 h$', dependsOn: ['scheiben-x'] },
      ],
      subGoalConcepts: {
        0: ['scheiben-x'],
        1: ['rotation-y'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['scheiben-x'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['scheiben-x'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['scheiben-x'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['scheiben-x'],                  qty: 1, note: '$\\pi$ vergessen oder $f$ statt $f^2$' },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['scheiben-x'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['rotation-y'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rotation-y'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['rotation-y'],                  qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rotation-y'],                  qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['rotation-y'],                  qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['schalen'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['schalen'],                     qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['schalen'],                     qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['schalen'],                     qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['schalen', 'rotation-y'],       qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['mantelflaeche'],               qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mantelflaeche'],               qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['mantelflaeche'],               qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mantelflaeche'],               qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['mantelflaeche'],               qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['std-volumina'],                qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['std-volumina'],                qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['std-volumina', 'scheiben-x'],  qty: 1, note: 'Kegel/Kugel-Volumen aus Integral' },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['std-volumina'],                qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'matching',        uses: ['std-volumina'],                qty: 1 },
      ],
    },
    steps: [
      {
...
$$V = \\pi \\int_{0}^{3} x^{2}\\,dx = \\pi \\left[\\frac{x^{3}}{3}\\right]_{0}^{3} = \\pi \\cdot 9 = 9\\pi$$`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'int-1-4', concepts: ['hauptsatz-12'] },
        { lessonId: 'int-3-1', concepts: ['flaeche-pos'] },
      ],
      concepts: [
        { id: 'arbeit-int',     title: 'Arbeit $W=\\int_a^b F(x)dx$ bei ortsabhängiger Kraft',                              dependsOn: [] },
        { id: 'feder-energie',  title: 'Federenergie aus $F=kx$: $W=\\frac{1}{2}ks^2$',                                       dependsOn: ['arbeit-int'] },
        { id: 'schwerpunkt-int', title: 'Schwerpunkt: $\\bar x=(1/A)\\int x f(x)dx$, $\\bar y=(1/(2A))\\int f(x)^2 dx$',     dependsOn: [] },
        { id: 'traegheits-int', title: 'Trägheitsmoment $I=\\int r^2\\,dm$ für kontinuierliche Massenverteilung',             dependsOn: [] },
        { id: 'rms-effektiv',   title: 'Effektivwert $f_{\\text{eff}}=\\sqrt{(1/T)\\int_0^T f(t)^2 dt}$',                     dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['arbeit-int'],
        1: ['feder-energie'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['arbeit-int'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['arbeit-int'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['arbeit-int'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['arbeit-int'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['arbeit-int'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['feder-energie'],               qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['feder-energie'],               qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['feder-energie'],               qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['feder-energie'],               qty: 1, note: 'Faktor $1/2$ vergessen' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['feder-energie', 'arbeit-int'], qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['schwerpunkt-int'],             qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['schwerpunkt-int'],             qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['schwerpunkt-int'],             qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['schwerpunkt-int'],             qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['schwerpunkt-int'],             qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['traegheits-int'],              qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['traegheits-int'],              qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['traegheits-int'],              qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['traegheits-int'],              qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['traegheits-int'],              qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['rms-effektiv'],                qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rms-effektiv'],                qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['rms-effektiv'],                qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rms-effektiv'],                qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['rms-effektiv'],                qty: 1 },
      ],
    },
    steps: [
      {
...
- $\\bar{x} = \\dfrac{1}{2}\\int_{0}^{2} x \\cdot x\\,dx = \\dfrac{1}{2}\\int_{0}^{2} x^{2}\\,dx = \\dfrac{1}{2} \\cdot \\dfrac{8}{3} = \\dfrac{4}{3}$`,
  ...
  },
  {
    ...
    blueprint: {
      ...
      concepts: [
        { id: 'bogenlaenge',     title: 'Bogenlänge $L=\\int_a^b\\sqrt{1+[f\'(x)]^2}dx$ (Pythagoras am Differentialdreieck)', dependsOn: [] },
        { id: 'durchschnitt',    title: 'Durchschnittswert $\\bar f=\\frac{1}{b-a}\\int_a^b f(x)dx$',                          dependsOn: [] },
        { id: 'param-kurve',     title: 'Parametrisierte Kurve: $L=\\int_{t_1}^{t_2}\\sqrt{x\'^2+y\'^2}dt$',                  dependsOn: ['bogenlaenge'] },
        { id: 'mws-int',         title: 'Mittelwertsatz: $\\exists\\xi\\in[a,b]$ mit $f(\\xi)=\\bar f$',                       dependsOn: ['durchschnitt'] },
        { id: 'mb-anwendung',    title: 'Anwendung Maschinenbau: Zahnrad-Evolventen, Rohrleitungen, Seilverläufe',             dependsOn: ['bogenlaenge'] },
      ],
      subGoalConcepts: {
        0: ['bogenlaenge'],
        1: ['durchschnitt'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['bogenlaenge'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['bogenlaenge'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['bogenlaenge'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['bogenlaenge'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['bogenlaenge'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['durchschnitt'],                 qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['durchschnitt'],                 qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['durchschnitt'],                 qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['durchschnitt'],                 qty: 1, note: 'Faktor $1/(b-a)$ vergessen' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['durchschnitt'],                 qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['param-kurve'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['param-kurve'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['param-kurve'],                  qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['param-kurve'],                  qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['param-kurve'],                  qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['mws-int'],                      qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mws-int'],                      qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['mws-int', 'durchschnitt'],      qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mws-int'],                      qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['mws-int'],                      qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['mb-anwendung'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['mb-anwendung'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['mb-anwendung', 'bogenlaenge'],  qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['mb-anwendung'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['mb-anwendung', 'bogenlaenge'],  qty: 1 },
      ],
    },
    steps: [
      {
