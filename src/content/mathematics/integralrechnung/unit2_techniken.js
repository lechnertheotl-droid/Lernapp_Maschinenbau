...
const lessons_int_u2 = [
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'int-1-2', concepts: ['int-pot-regel', 'int-1-x', 'int-exp-trig'] },
        { lessonId: 'int-1-4', concepts: ['hauptsatz-12'] },
      ],
      concepts: [
        { id: 'subst-formel',  title: '$\\int f(g(x))g\'(x)dx=\\int f(u)du$ mit $u=g(x)$ — Kettenregel rückwärts',         dependsOn: [] },
        { id: 'subst-erkennen', title: 'Substitution wählen, wenn $g\'(x)$ als Faktor im Integrand erscheint',                dependsOn: ['subst-formel'] },
        { id: 'subst-grenzen', title: 'Bei bestimmtem Integral: Grenzen mit substituieren ($x=a\\to u=g(a)$)',               dependsOn: ['subst-formel'] },
        { id: 'subst-linear',  title: 'Lineare Substitution $u=ax+b$: $du=a\\,dx$ — sehr häufig',                            dependsOn: ['subst-formel'] },
        { id: 'subst-trig',    title: 'Trig. Substitution: $x=\\sin u$ für $\\sqrt{1-x^2}$, $x=\\tan u$ für $1+x^2$',         dependsOn: ['subst-formel'] },
        { id: 'log-ableitung', title: '$\\int f\'(x)/f(x)dx=\\ln|f(x)|+C$ (logarithmische Ableitung)',                       dependsOn: ['subst-formel'] },
      ],
      subGoalConcepts: {
        0: ['subst-formel'],
        1: ['subst-erkennen'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['subst-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['subst-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['subst-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['subst-formel'],                  qty: 1, note: '$dx$ statt $du$' },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['subst-formel'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['subst-erkennen'],                qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['subst-erkennen'],                qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['subst-erkennen'],                qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['subst-erkennen'],                qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['subst-erkennen', 'subst-formel'], qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['subst-grenzen'],                 qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['subst-grenzen'],                 qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['subst-grenzen'],                 qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['subst-grenzen'],                 qty: 1, note: 'Grenzen nicht umgerechnet' },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['subst-grenzen'],                 qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['subst-linear'],                  qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['subst-linear'],                  qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['subst-linear'],                  qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['subst-linear'],                  qty: 1, note: 'Faktor $1/a$ vergessen' },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['subst-linear'],                  qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['subst-trig'],                    qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['subst-trig'],                    qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['subst-trig'],                    qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['subst-trig'],                    qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'multiple-choice', uses: ['subst-trig'],                    qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['log-ableitung'],                 qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['log-ableitung'],                 qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['log-ableitung'],                 qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['log-ableitung'],                 qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'matching',        uses: ['log-ableitung'],                 qty: 1 },
      ],
    },
    steps: [
      {
...
**Tipp:** Die Substitution funktioniert am besten, wenn die Ableitung des gewählten $u$ bereits als Faktor im Integral vorkommt (eventuell bis auf eine Konstante).`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'int-1-2', concepts: ['int-pot-regel', 'int-1-x', 'int-exp-trig'] },
        { lessonId: 'int-2-1', concepts: ['subst-formel'] },
      ],
      concepts: [
        { id: 'pi-formel',     title: 'Partielle Integration $\\int u\\,v\'\\,dx=uv-\\int u\'\\,v\\,dx$ (aus Produktregel)',     dependsOn: [] },
        { id: 'liate',         title: 'LIATE-Regel: Log → InvTrig → Algebr. → Trig → Exp wird $u$',                                dependsOn: ['pi-formel'] },
        { id: 'pi-ln',         title: 'Spezialtrick $\\int\\ln x\\,dx$: $u=\\ln x,\\,v\'=1$',                                       dependsOn: ['pi-formel'] },
        { id: 'pi-mehrfach',   title: 'Mehrfache Anwendung bei $\\int x^n e^x\\,dx$ (Grad halbiert)',                              dependsOn: ['pi-formel'] },
        { id: 'pi-kreis',      title: 'Kreisintegrale $\\int e^x\\sin x\\,dx$: nach 2 PI nach Original auflösen',                  dependsOn: ['pi-formel'] },
      ],
      subGoalConcepts: {
        0: ['pi-formel'],
        1: ['liate'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['pi-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pi-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['pi-formel'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pi-formel'],                  qty: 1, note: 'Vorzeichen vor zweitem Integral' },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['pi-formel'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['liate'],                      qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['liate'],                      qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['liate'],                      qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['liate'],                      qty: 1, note: 'Falsche Wahl von $u$' },
        { subGoal: 1, stage: 'transfer',          type: 'matching',        uses: ['liate', 'pi-formel'],         qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['pi-ln'],                      qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pi-ln'],                      qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['pi-ln'],                      qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pi-ln'],                      qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['pi-ln'],                      qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['pi-mehrfach'],                qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pi-mehrfach'],                qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['pi-mehrfach'],                qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pi-mehrfach'],                qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'sorting',         uses: ['pi-mehrfach'],                qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['pi-kreis'],                   qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pi-kreis'],                   qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['pi-kreis'],                   qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pi-kreis'],                   qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['pi-kreis'],                   qty: 1 },
      ],
    },
    steps: [
      {
...
- $= x \\cdot \\ln(x) - \\int x \\cdot (1/x)\\,dx = x\\ln(x) - x + C$`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'int-1-2', concepts: ['int-1-x', 'int-pot-regel'] },
        { lessonId: 'int-2-1', concepts: ['log-ableitung'] },
      ],
      concepts: [
        { id: 'pbz-grad',     title: 'Voraussetzung: $\\deg(\\text{Zähler})<\\deg(\\text{Nenner})$ (sonst Polynomdivision)',  dependsOn: [] },
        { id: 'pbz-linear',   title: 'Einfacher Linearfaktor $(x-a)$: Ansatz $A/(x-a)$',                                       dependsOn: [] },
        { id: 'pbz-doppel',   title: 'Doppelter Linearfaktor $(x-a)^2$: $A/(x-a)+B/(x-a)^2$',                                  dependsOn: ['pbz-linear'] },
        { id: 'pbz-quadr',    title: 'Irreduzibler quadr. Faktor: $(Ax+B)/(x^2+px+q)$',                                         dependsOn: [] },
        { id: 'pbz-koeff',    title: 'Koeffizienten via Einsetzmethode oder Koeffizientenvergleich',                            dependsOn: ['pbz-linear', 'pbz-quadr'] },
        { id: 'pbz-int',      title: 'Integration: $\\int dx/(x-a)=\\ln|x-a|$, $\\int dx/(x-a)^n=-1/((n-1)(x-a)^{n-1})$',       dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['pbz-grad'],
        1: ['pbz-linear'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['pbz-grad'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pbz-grad'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['pbz-grad'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pbz-grad'],                  qty: 1, note: 'Polynomdivision vergessen' },
        { subGoal: 0, stage: 'transfer',          type: 'multiple-choice', uses: ['pbz-grad'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['pbz-linear'],                qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pbz-linear'],                qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['pbz-linear'],                qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pbz-linear'],                qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['pbz-linear', 'pbz-int'],     qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['pbz-doppel'],                qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pbz-doppel'],                qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['pbz-doppel'],                qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pbz-doppel'],                qty: 1, note: 'Nur einen Term angesetzt' },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['pbz-doppel', 'pbz-int'],     qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['pbz-quadr'],                 qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pbz-quadr'],                 qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['pbz-quadr'],                 qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pbz-quadr'],                 qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['pbz-quadr'],                 qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['pbz-koeff'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pbz-koeff'],                 qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['pbz-koeff', 'pbz-linear'],   qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pbz-koeff'],                 qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['pbz-koeff'],                 qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['pbz-int'],                   qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['pbz-int'],                   qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'number-input',    uses: ['pbz-int'],                   qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['pbz-int'],                   qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'number-input',    uses: ['pbz-int', 'pbz-linear'],     qty: 1 },
      ],
    },
    steps: [
      {
...
- Irreduzibler quadratischer Faktor $x^{2}+px+q$: $\\dfrac{Ax+B}{x^{2}+px+q}$`,
  ...
  },
  {
    ...
    blueprint: {
      prerequisites: [
        { lessonId: 'int-2-1', concepts: ['subst-formel', 'log-ableitung', 'subst-trig'] },
        { lessonId: 'int-2-2', concepts: ['pi-formel', 'liate'] },
        { lessonId: 'int-2-3', concepts: ['pbz-grad', 'pbz-linear'] },
      ],
      concepts: [
        { id: 'log-direkt',   title: 'Zähler = Ableitung des Nenners → direkt $\\ln|f|$',                               dependsOn: [] },
        { id: 'halbwinkel',   title: 'Halbwinkel: $\\sin^2 x=(1-\\cos 2x)/2$, $\\cos^2 x=(1+\\cos 2x)/2$',              dependsOn: [] },
        { id: 'weierstrass',  title: 'Weierstraß-Substitution $t=\\tan(x/2)$ für rationale trig. Ausdrücke',           dependsOn: [] },
        { id: 'fourier-orth', title: 'Fourier-Orthogonalität: $\\int_0^{2\\pi}\\sin(nx)\\cos(mx)dx=0$',                 dependsOn: [] },
        { id: 'strategie-int', title: 'Integrationsstrategie ZUERST wählen — 10 s nachdenken spart 10 min',              dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['log-direkt'],
        1: ['halbwinkel'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['log-direkt'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['log-direkt'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['log-direkt'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['log-direkt'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['log-direkt'],                  qty: 1 },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['halbwinkel'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['halbwinkel'],                  qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['halbwinkel'],                  qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['halbwinkel'],                  qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['halbwinkel'],                  qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['weierstrass'],                 qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['weierstrass'],                 qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['weierstrass'],                 qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['weierstrass'],                 qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['weierstrass'],                 qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['fourier-orth'],                qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['fourier-orth'],                qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'multiple-choice', uses: ['fourier-orth'],                qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['fourier-orth'],                qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'multiple-choice', uses: ['fourier-orth'],                qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['strategie-int'],               qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['strategie-int'],               qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'matching',        uses: ['strategie-int'],               qty: 1, note: 'Methode ↔ Muster' },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['strategie-int'],               qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['strategie-int'],               qty: 1 },
      ],
    },
    steps: [
      {
