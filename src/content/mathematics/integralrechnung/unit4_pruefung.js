...
const lessons_int_u4 = [
  {
    ...
    subGoals: [
      { label: 'Methodenwahl in Sekundenschnelle: innere Ableitung? → Subst., Produkt? → Part.Int., Bruch? → PBZ', examRelevance: 'hoch' },
      { label: 'Bestimmtes Integral: Grenzen bei Substitution mit umrechnen, nicht rücksubstituieren', examRelevance: 'hoch' },
      { label: 'Symmetrie nutzen: $\\int_{-a}^a f(x) dx = 0$ bei ungerade, $= 2\\int_0^a$ bei gerade', examRelevance: 'mittel' },
      { label: 'Trigonometrische Substitution $x = a \\sin u$ für $\\sqrt{a^2 - x^2}$, $x = a \\tan u$ für $a^2 + x^2$', examRelevance: 'mittel' },
      { label: 'Zweifache partielle Integration + Rückführung auf Ausgangsintegral (Kreistrick)', examRelevance: 'mittel' },
    ],
    prerequisites: ['int-2-4'],
    nextLessonId: 'int-4-2',
    blueprint: {
      prerequisites: [
        { lessonId: 'int-2-1', concepts: ['subst-formel', 'subst-grenzen', 'subst-trig'] },
        { lessonId: 'int-2-2', concepts: ['pi-formel', 'liate', 'pi-kreis'] },
        { lessonId: 'int-2-3', concepts: ['pbz-grad', 'pbz-linear'] },
        { lessonId: 'int-2-4', concepts: ['strategie-int'] },
      ],
      concepts: [
        { id: 'method-wahl',     title: 'Methodenwahl Sekunden: innere Abl.? → Subst., Produkt? → PI, Bruch? → PBZ',         dependsOn: [] },
        { id: 'best-int-grenzen', title: 'Bestimmtes Integral: Grenzen bei Substitution mitumrechnen, NICHT zurück',          dependsOn: [] },
        { id: 'symmetrie-int',   title: 'Symmetrie nutzen: $\\int_{-a}^a f=0$ bei ungerade, $=2\\int_0^a$ bei gerade',         dependsOn: [] },
        { id: 'trig-subst-pruef', title: 'Trig. Subst. $x=a\\sin u$ für $\\sqrt{a^2-x^2}$, $x=a\\tan u$ für $a^2+x^2$',         dependsOn: [] },
        { id: 'kreis-trick',     title: 'Zweifache PI + Rückführung auf Ausgangsintegral (Kreistrick)',                       dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['method-wahl'],
        1: ['best-int-grenzen'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['method-wahl'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['method-wahl'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'multiple-choice', uses: ['method-wahl'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['method-wahl'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'matching',        uses: ['method-wahl'],                  qty: 1, note: 'Methode ↔ Aufgabentyp' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['best-int-grenzen'],             qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['best-int-grenzen'],             qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['best-int-grenzen'],             qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['best-int-grenzen'],             qty: 1, note: 'Grenzen nicht umgerechnet' },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['best-int-grenzen'],             qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['symmetrie-int'],                qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['symmetrie-int'],                qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['symmetrie-int'],                qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['symmetrie-int'],                qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'multiple-choice', uses: ['symmetrie-int'],                qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['trig-subst-pruef'],             qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['trig-subst-pruef'],             qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['trig-subst-pruef'],             qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['trig-subst-pruef'],             qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['trig-subst-pruef'],             qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['kreis-trick'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['kreis-trick'],                  qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['kreis-trick'],                  qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['kreis-trick'],                  qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'sorting',         uses: ['kreis-trick'],                  qty: 1, note: 'Schritte ordnen' },
      ],
    },
    steps: [
      {
...
**Wichtig bei bestimmten Integralen:** Bei Substitution auch die Grenzen umrechnen!`,
  ...
  },
  {
    ...
    subGoals: [
      { label: 'Flächenträgheitsmoment Rechteck: $I_x = bh^3/12$ um Schwerachse, $= bh^3/3$ um Rand', examRelevance: 'hoch' },
      { label: 'Steiner\'scher Satz: $I_a = I_s + A \\cdot d^2$ (Abstand $d$ zwischen Achsen)', examRelevance: 'hoch' },
      { label: 'Schwerpunkt zusammengesetzter Flächen: $\\bar{x} = \\sum A_i \\bar{x}_i / \\sum A_i$', examRelevance: 'hoch' },
      { label: 'Rotationsvolumen mit Subtraktion: $V = \\pi \\int (f^2 - g^2) dx$ (Hohlkörper)', examRelevance: 'hoch' },
      { label: 'Wurfparabel / Strom-Zeit-Integrale als technische Flächenrechnung', examRelevance: 'mittel' },
    ],
    prerequisites: ['int-3-3', 'int-4-1'],
    nextLessonId: 'int-4-3',
    blueprint: {
      prerequisites: [
        { lessonId: 'int-3-1', concepts: ['flaeche-zwischen', 'flaeche-grenzen'] },
        { lessonId: 'int-3-2', concepts: ['scheiben-x', 'rotation-y'] },
        { lessonId: 'int-3-3', concepts: ['schwerpunkt-int', 'traegheits-int'] },
        { lessonId: 'int-4-1', concepts: ['method-wahl'] },
      ],
      concepts: [
        { id: 'flaechen-traeg', title: 'Flächenträgheitsmoment Rechteck: $I_x=bh^3/12$ (Schwerachse), $=bh^3/3$ (Rand)',     dependsOn: [] },
        { id: 'steiner',        title: 'Steiner: $I_a=I_s+A\\cdot d^2$ (Achsenabstand $d$)',                                 dependsOn: ['flaechen-traeg'] },
        { id: 'sp-zusammen',    title: 'Schwerpunkt zusammengesetzter Flächen: $\\bar x=\\sum A_i\\bar x_i/\\sum A_i$',      dependsOn: [] },
        { id: 'rotation-hohl',  title: 'Rotationsvolumen mit Subtraktion: $V=\\pi\\int(f^2-g^2)dx$ (Hohlkörper)',             dependsOn: [] },
        { id: 'wurf-strom',     title: 'Wurfparabel / Strom-Zeit-Integrale als technische Flächenrechnung',                  dependsOn: [] },
      ],
      subGoalConcepts: {
        0: ['flaechen-traeg'],
        1: ['steiner'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['flaechen-traeg'],               qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['flaechen-traeg'],               qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['flaechen-traeg'],               qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['flaechen-traeg'],               qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['flaechen-traeg'],               qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['steiner'],                      qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['steiner'],                      qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'number-input',    uses: ['steiner', 'flaechen-traeg'],    qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['steiner'],                      qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['steiner'],                      qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['sp-zusammen'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['sp-zusammen'],                  qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'number-input',    uses: ['sp-zusammen'],                  qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['sp-zusammen'],                  qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'number-input',    uses: ['sp-zusammen'],                  qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['rotation-hohl'],                qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['rotation-hohl'],                qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['rotation-hohl'],                qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['rotation-hohl'],                qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['rotation-hohl'],                qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['wurf-strom'],                   qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['wurf-strom'],                   qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['wurf-strom'],                   qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['wurf-strom'],                   qty: 1 },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['wurf-strom'],                   qty: 1 },
      ],
    },
    steps: [
      {
...
$$L = \\int_a^b \\sqrt{1 + [f'(x)]^2}\\,dx$$`,
  ...
  },
  {
    ...
    subGoals: [
      { label: 'Uneigentliches Integral: $\\int_a^\\infty f dx = \\lim_{b\\to\\infty} \\int_a^b f dx$', examRelevance: 'hoch' },
      { label: 'p-Integral $\\int_1^\\infty x^{-p} dx$: konvergent für $p > 1$, divergent sonst', examRelevance: 'hoch' },
      { label: 'p-Integral $\\int_0^1 x^{-p} dx$: konvergent für $p < 1$, divergent sonst', examRelevance: 'hoch' },
      { label: 'Trapezregel: $T = h[(f_0+f_n)/2 + \\sum f_i]$, Fehler $O(h^2)$', examRelevance: 'hoch' },
      { label: 'Simpson-Regel: $S = (h/3)[f_0 + 4 \\sum_{\\text{ung.}} + 2 \\sum_{\\text{ger.}} + f_n]$, Fehler $O(h^4)$, $n$ gerade!', examRelevance: 'hoch' },
      { label: 'Vergleichs-/Majorantenkriterium: $0 \\leq f \\leq g$, $\\int g$ konv. $\\Rightarrow \\int f$ konv.', examRelevance: 'mittel' },
    ],
    ...
    blueprint: {
      prerequisites: [
        ...
        { lessonId: 'int-1-2', concepts: ['int-pot-regel', 'int-1-x'] },
      ],
      concepts: [
        { id: 'uneigentlich',   title: 'Uneigentliches Integral $\\int_a^\\infty f\\,dx=\\lim_{b\\to\\infty}\\int_a^b f\\,dx$', dependsOn: [] },
        { id: 'p-int-inf',      title: '$\\int_1^\\infty x^{-p}dx$: konvergent für $p>1$, divergent sonst',                    dependsOn: ['uneigentlich'] },
        { id: 'p-int-0',        title: '$\\int_0^1 x^{-p}dx$: konvergent für $p<1$, divergent sonst',                            dependsOn: ['uneigentlich'] },
        { id: 'trapez',         title: 'Trapezregel: $T=h[(f_0+f_n)/2+\\sum f_i]$, Fehler $O(h^2)$',                              dependsOn: [] },
        { id: 'simpson',        title: 'Simpson: $S=(h/3)[f_0+4\\sum_{\\text{ung.}}+2\\sum_{\\text{ger.}}+f_n]$, $O(h^4)$, $n$ gerade', dependsOn: ['trapez'] },
        { id: 'majorante',      title: 'Vergleichskriterium: $0\\le f\\le g$, $\\int g$ konv. $\\Rightarrow\\int f$ konv.',     dependsOn: ['uneigentlich'] },
      ],
      subGoalConcepts: {
        0: ['uneigentlich'],
        1: ['p-int-inf'],
      ...
      taskPlan: [
        { subGoal: 0, stage: 'recognize',         type: 'true-false',      uses: ['uneigentlich'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-guided',      type: 'multiple-choice', uses: ['uneigentlich'],                  qty: 1 },
        { subGoal: 0, stage: 'apply-independent', type: 'number-input',    uses: ['uneigentlich'],                  qty: 1 },
        { subGoal: 0, stage: 'error-analysis',    type: 'multiple-choice', uses: ['uneigentlich'],                  qty: 1 },
        { subGoal: 0, stage: 'transfer',          type: 'number-input',    uses: ['uneigentlich'],                  qty: 1, note: '[PRÜFUNG]' },
        { subGoal: 1, stage: 'recognize',         type: 'true-false',      uses: ['p-int-inf'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-int-inf'],                     qty: 1 },
        { subGoal: 1, stage: 'apply-independent', type: 'multiple-choice', uses: ['p-int-inf'],                     qty: 1 },
        { subGoal: 1, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-int-inf'],                     qty: 1 },
        { subGoal: 1, stage: 'transfer',          type: 'number-input',    uses: ['p-int-inf'],                     qty: 1 },
        { subGoal: 2, stage: 'recognize',         type: 'true-false',      uses: ['p-int-0'],                       qty: 1 },
        { subGoal: 2, stage: 'apply-guided',      type: 'multiple-choice', uses: ['p-int-0'],                       qty: 1 },
        { subGoal: 2, stage: 'apply-independent', type: 'multiple-choice', uses: ['p-int-0'],                       qty: 1 },
        { subGoal: 2, stage: 'error-analysis',    type: 'multiple-choice', uses: ['p-int-0'],                       qty: 1 },
        { subGoal: 2, stage: 'transfer',          type: 'matching',        uses: ['p-int-0', 'p-int-inf'],          qty: 1 },
        { subGoal: 3, stage: 'recognize',         type: 'true-false',      uses: ['trapez'],                        qty: 1 },
        { subGoal: 3, stage: 'apply-guided',      type: 'multiple-choice', uses: ['trapez'],                        qty: 1 },
        { subGoal: 3, stage: 'apply-independent', type: 'number-input',    uses: ['trapez'],                        qty: 1 },
        { subGoal: 3, stage: 'error-analysis',    type: 'multiple-choice', uses: ['trapez'],                        qty: 1 },
        { subGoal: 3, stage: 'transfer',          type: 'number-input',    uses: ['trapez'],                        qty: 1 },
        { subGoal: 4, stage: 'recognize',         type: 'true-false',      uses: ['simpson'],                       qty: 1 },
        { subGoal: 4, stage: 'apply-guided',      type: 'multiple-choice', uses: ['simpson'],                       qty: 1 },
        { subGoal: 4, stage: 'apply-independent', type: 'number-input',    uses: ['simpson'],                       qty: 1 },
        { subGoal: 4, stage: 'error-analysis',    type: 'multiple-choice', uses: ['simpson'],                       qty: 1, note: '$n$ ungerade verwendet' },
        { subGoal: 4, stage: 'transfer',          type: 'number-input',    uses: ['simpson', 'trapez'],             qty: 1 },
        { subGoal: 5, stage: 'recognize',         type: 'true-false',      uses: ['majorante'],                     qty: 1 },
        { subGoal: 5, stage: 'apply-guided',      type: 'multiple-choice', uses: ['majorante'],                     qty: 1 },
        { subGoal: 5, stage: 'apply-independent', type: 'multiple-choice', uses: ['majorante'],                     qty: 1 },
        { subGoal: 5, stage: 'error-analysis',    type: 'multiple-choice', uses: ['majorante'],                     qty: 1 },
        { subGoal: 5, stage: 'transfer',          type: 'multiple-choice', uses: ['majorante', 'p-int-inf'],        qty: 1 },
      ],
    },
    steps: [
      {
